...
$AncStyle1RootBoxPosn = 32;		// -- Position of the leftmost Person Box (style 1)
$AncStyle1ColumnWidth = 16;		// -- Spacing between adjacent columns (style 1)
$AncStyle2aRootBoxPosn = 29;	// -- Position of the leftmost Person Box (style 2 - parents)
$AncStyle2aColumnWidth = 42;	// -- Spacing between adjacent columns (style 2 - parents)
$AncStyle2bRootBoxPosn = 29;	// -- Position of the leftmost Person Box (style 2 - children)
$AncStyle2bColumnWidth = 48;	// -- Spacing between adjacent columns (style 2 - children)

// -- global variables for positioning the popup menus on the Descendancy chart
//    kinda kludgy -- JavaScript doesn't cut it here
$DesStyle1RootBoxPosn = 30;		// -- Position of the leftmost Person Box (style 1)
$DesStyle1ColumnWidth = 15;		// -- Spacing between adjacent columns (style 1)
$DesStyle2aRootBoxPosn = 64;	// -- Position of the leftmost Person Box (style 2 - parents)
$DesStyle2aColumnWidth = 77;	// -- Spacing between adjacent columns (style 2 - parents)
$DesStyle2bRootBoxPosn = 64;	// -- Position of the leftmost Person Box (style 2 - children)
$DesStyle2bColumnWidth = 48;	// -- Spacing between adjacent columns (style 2 - children)

// -- global variables for positioning the popup menus on the Family Book chart
//    kinda kludgy -- JavaScript doesn't cut it here
$FamARootBoxPosn = 7;			// -- Position of the leftmost Person Box (descendant side)
...
$HouALastBoxAdj  = 2;			// -- Correction to last box position (the actual Root person box)
