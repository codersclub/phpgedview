...
$pgv_lang["piwik_analytics_help"] = "~#pgv_lang[piwik_analytics]#~<br /><br />#pgv_lang[piwik_analytics]#開源條目被描述為<a href='http://piwik.org/' target='_blank' title='Piwik官方網站'>這裡</a>。<br /><br />Piwik是#pgv_lang[google_analytics]#的替代品，它消除了許多隱私問題。您可以自己安裝Piwik應用程序網絡服務器或您自己的域，從而確保您可以完全控制已收集的活動數據。";
$pgv_lang["USE_PIWIK_ANALYTICS_help"] = "~#pgv_lang[USE_PIWIK_ANALYTICS]#~<br /><br />選擇<b>#pgv_lang[yes]#</b>以啟用#pgv_lang[piwik_analytics]#服务對您網站上的活動進行跟踪。 PhpGedView站點必須在Piwik服務器上註冊。";
$pgv_lang["PGV_PIWIK_URL_help"] = "~#pgv_lang[PGV_PIWIK_URL]#~<br /><br />輸入註冊網站的Piwik服務器的URL。";
...
$pgv_lang["PGV_MEMORY_LIMIT_help"] = "~#pgv_lang[PGV_MEMORY_LIMIT]#~<br /><br />PhpGedView腳本可以消耗的最大內存量。默認值為32 Mb。許多主機在PHP配置中禁用此選項;更改此值可能實際上並沒有影響當前的最大內存設置。";
