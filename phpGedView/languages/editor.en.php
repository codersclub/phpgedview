...
$pgv_lang["main_media_ok2"]				= "Main media file <b>#GLOBALS[oldMediaName]#</b> moved from <b>#GLOBALS[oldMediaFolder]#</b> to <b>#GLOBALS[newMediaFolder]#</b>.";
$pgv_lang["main_media_ok3"]				= "Main media file moved and renamed from <b>#GLOBALS[oldMediaFolder]##GLOBALS[oldMediaName]#</b> to <b>#GLOBALS[newMediaFolder]##GLOBALS[newMediaName]#</b>.";
...
$pgv_lang["thumb_create_fail1"]			= "This feature is disabled in the GEDCOM configuration.";
$pgv_lang["thumb_create_fail2"]			= "The destination directory is not writable.";
$pgv_lang["thumb_create_fail3"]			= "This feature does not support the <span style=\"font-size:larger\">#GLOBALS[imageType]#</span> image type.";
...
$pgv_lang["repo_not_exist"]			= "The Repository %s does not exist";
$pgv_lang["shared_note_assisted"]	= "Shared Note using Assistant";
$pgv_lang["create_shared_note"]		= "Create a new Shared Note";
$pgv_lang["note_not_exist"]			= "The Shared Note %s does not exist";
...
$pgv_lang["sour_not_exist"]			= "The Source %s does not exist";
$pgv_lang["media_not_exist"]		= "The Media item %s does not exist";
$pgv_lang["current_person"]         = "Same as current";
$pgv_lang["date"]					= "Date";
$pgv_lang["deathdate_search"]		= "Death date: ";
$pgv_lang["deathplace_search"]		= "Death Place: ";
$pgv_lang["delete_dir_success"]		= "Media and thumbnail directories <b>#GLOBALS[whichDir]#</b> removed.";
$pgv_lang["delete_file"]			= "Delete file";
$pgv_lang["delete_repo"]			= "Delete Repository";
$pgv_lang["directory_not_empty"]	= "Directory <span style=\"font-size:larger\">#GLOBALS[whichDir]#</span> not empty.";
$pgv_lang["directory_not_mt"]		= "Directory #GLOBALS[whichDir]# not empty.";
...
$pgv_lang["file_success"]			= "File uploaded";
...
$pgv_lang["gedrec_deleted"] 		= "GEDCOM record deleted.";
...
$pgv_lang["link_success"]			= "Link added";
...
$pgv_lang["media_deleted"]			= "Directory <b>#GLOBALS[whichDir]#</b> removed.";
$pgv_lang["media_not_deleted"]		= "Directory <span style=\"font-size:larger\">#GLOBALS[whichDir]#</span> not removed.";
$pgv_lang["media_cant_delete"]		= "Directory #GLOBALS[whichDir]# not removed.";
$pgv_lang["media_exists"]			= "Media file <span style=\"font-size:larger\">#GLOBALS[whichFile]#</span> already exists.";
$pgv_lang["media_file"] 			= "Media file to upload";
$pgv_lang["media_file_deleted"]		= "Media file <b>#GLOBALS[whichFile]#</b> deleted.";
$pgv_lang["media_file_not_deleted"]	= "Media file <span style=\"font-size:larger\">#GLOBALS[whichFile]#</span> could not be deleted.";
$pgv_lang["media_file_cant_delete"]	= "Media file #GLOBALS[whichFile]# could not be deleted.";
...
$pgv_lang["media_thumb_exists"]		= "Thumbnail <span style=\"font-size:larger\">#GLOBALS[whichFile]#</span> already exists.";
$pgv_lang["media_thumb_deleted"]	= "Thumbnail <b>#GLOBALS[whichFile]#</b> deleted.";
$pgv_lang["media_thumb_not_deleted"]	= "Thumbnail <span style=\"font-size:larger\">#GLOBALS[whichFile]#</span> could not be deleted.";
$pgv_lang["media_thumb_cant_delete"]	= "Thumbnail #GLOBALS[whichFile]# could not be deleted.";
...
$pgv_lang["new_shared_note_created"] 	= "New Shared Note created.";
$pgv_lang["shared_note_updated"] 	= "Shared Note updated.";
$pgv_lang["new_source_created"] 	= "New source created.";
$pgv_lang["no_changes"] 			= "There are currently no changes to be reviewed.";
$pgv_lang["no_known_servers"]		= "No known Servers. No results will be found";
...
$pgv_lang["update_failed"]			= "Update failed";
