...
$pgv_lang["error_header"] 		= "家谱文件,[#GEDCOM#], 不存在在被指定的地点。";
...
$pgv_lang["can_admin"]			= "允许用户管理";
$pgv_lang["can_edit"]			= "能编辑";
$pgv_lang["cleanup_places"] 			= "清理地方";
$pgv_lang["cleanup_users"]				= "清理用户";
$pgv_lang["click_here_to_continue"]		= "继续";
$pgv_lang["click_here_to_go_to_pedigree_tree"]	= "点击这裡去家谱结构树。";
...
$pgv_lang["duplicate_username"]		= "复制用户名。  一名用户与那用户名已经存在。  请回去和选择其它用户名。";
...
$pgv_lang["please_be_patient"]		= "请是耐心";
...
$pgv_lang["user_create_error"]		= "无法增加用户。  请回去和再尝试。";
$pgv_lang["user_created"]		= "用户成功地被创造。";
...
$pgv_lang["label_timedban_servers"] = "通过IP拒绝定时访问";
$pgv_lang["enter_banexpiry"] = "输入拒绝访问的到期日期和时间：<br /> 2012.12.31@23:59";
...
$pgv_lang["link_deleted"] = "链接到#GLOBALS[remLinkId]#deleted";
$pgv_lang["link_added"] = "链接到#GLOBALS[addLinkId]#add added";
...
$pgv_lang["label_banned_servers"] = "通过IP拒绝访问";
$pgv_lang["label_manual_search_engines"] = "通过IP手动标记搜索引擎";
...
$pgv_lang["admin_OK_message"] = "PhpGedView网站#SERVER_NAME#的管理员已经批淮了您的帐户申请。\ r\ n\ r\ n您现在可以通过访问以下链接登录：#SERVER_NAME#";
...
$pgv_lang["gedcheck_sync"] = "对数据库所做的编辑不会同步到文件#GLOBALS[ged]#。文件内容可能已过时。您现在可以通过执行<b> <a\"#GLOBALS将其与数据库同步[ged_link]#\">出口</A> </b>。";
$pgv_lang["gedcheck_nothing"] = "在这个级别没有发现任何错误。";
...
$pgv_lang["tag"] = "标签";
$pgv_lang["spacing"] = "间距";
$pgv_lang["ADVANCED_NAME_FACTS"] = "高级名称事实";
$pgv_lang["ADVANCED_PLAC_FACTS"] = "高级地名事实";
$pgv_lang["tradition_spanish"] = "西班牙";
$pgv_lang["tradition_portuguese"] = "葡萄牙语";
$pgv_lang["tradition_icelandic"] = "冰岛的";
