...
$faqlist["FAQ_010_body"] = "#GLOBALS家庭成员[GEDCOM_TITLE]#想借此机会欢迎我们家谱中的所有'表兄弟'，并鼓励他们抓住研究他们祖先的错误。这很容易成为爱的劳动 - 而且讨厌 - 因为它消耗了过多的时间，但奖励非常好。我们为您提供了通过使用<a href=\"#PGV_PHPGEDVIEW_URL#\" target=\"_blank\">#PGV_PHPGEDVIEW#</a>，由John Finlay及其PGV团队的才华编程技巧创建 - 一个精彩的开源家谱计划。来享受家谱的机会。";
...
$faqlist["FAQ_030_PLACES"] = "<strong>地点</strong>：我们尝试，无论何处知道，包括完整的地方描述：城市和/或乡镇（Twp）以及县，州，我们通常添加美国（首选 - 不是美国，国家背后的美国或美国。对于外国，我们使用GEDCOM批淮的3个字母标淮缩写而不是国名：英格兰[ENG]，苏格兰[SCT]，爱尔兰[IRE]，法国[FRA]我们喜欢的格式是：<i>Indianapolis, Center Twp, Marion Co, Indiana, USA</i>各州不应缩写为两个字母;我们通常不使用句号（.）在名称或位置，如<i>Shelbyville, Addison Twp, Shelby Co, Indiana, USA</i>而不是<i>Shelbyville, Addison Twp., Shelby Co., IN</i>或<i><i>Shelbyville, Addison Township, Shelby County, Indiana, U.S.A.</i>";
$faqlist["FAQ_030_PLACES2"] = "<strong>地点</strong>：我们尝试，无论在哪里知道，为美国地方包括完整的地方描述：城市或乡镇（Twp）以及两个字母州，我们添加美国（首选 - 不是美国，国家背后的美国或美国。对于其他国家，我们使用城市和/或乡镇和国家名称。我们喜欢的格式是：<i>Indianapolis, IN, USA</i>和<i>Vilnius, Lithuania</i>。";
...
$faqlist["FAQ_030_PLACES5"] = "\"Place\"数据下的字段\"希伯来语\"旨在让您输入希伯来语的地名以及拉丁字母中的名称。";
...
$faqlist["FAQ_030_GIVN1"] = "当出生后名称发生变化时，这些附加名称可以在人员被记录到数据库后单独输入。也可以输入为AKA（也称为）名称。<br /><br />我们通常期望人们可以通过他们给出的第一个名字来调用。如果不是这样的话，你应该通过在它后面放一个星号来指明哪个给定的名字是首选名称。例如，<i>John James Mitchell* Jones</i>表示此人被称为\"Mitchell\"。在这种情况下，\"Mitchell\"不是昵称，尽管\"Mitch\"可能是。";
...
$faqlist["FAQ_030_HEBNAME"] = "<u>HEBREW NAME</u>是拉丁字母中人名的希伯来语翻译。没有人可以拥有多个希伯来名字.PhpGedView希望你用斜线括起姓氏。名称&#1497;&#1506;&#1511;&#1489; &#1500;&#1493;&#1497;将输入&#1497;&#1506;&#1511;&#1489;/&#1500;&#1493 ;&#1497;/。";
...
$faqlist["FAQ_030_MARRNAME"] = "<u>MARRIED NAMES</u>是假設配偶姓氏時該人的新名字。當您在\"已婚姓名\"字段中輸入新姓時，該程序會自動創建。即<i>Mary Jane Smith</i>当她结婚<i>John Jones</i>並成為<i>Mary Jane Jones</i>當你在已婚姓氏字段中輸入<i>Jones</i>。已婚姓名不是針對性別的;你是可為任何性別的人輸入已婚姓名。";$faqlist["FAQ_030_MARRNAME2"] = "希伯来语MARRIED名字取自希伯来名字给定名字的名字。";
