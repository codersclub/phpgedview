...
$pgv_lang["help_not_exist"] = "帮助文本, 为这个页或项目, 不是可利用的";
$pgv_lang["header"] = "标头";
...
$pgv_lang["unable_to_find_indi"]	= "无法找到单个";
$pgv_lang["unable_to_find_record"]	= "无法查找记录";
$pgv_lang["unable_to_find_source"]	= "无法查找来源";
$pgv_lang["unable_to_find_repo"]	= "无法查找程式库";
$pgv_lang["repo_name"]			= "程式库名字:";
$pgv_lang["address"]			= "地址:";
$pgv_lang["phone"]			= "电话:";
...
$pgv_lang["unrecognized_code"]		= "未被认出的GEDCOM 编码";
...
$pgv_lang["still_living_error"]		= "这个人员居住或仍然不安排诞生或去世日期被记录。  生存人员所有详细资料被隐藏从公共视图。<br />为更多资讯联络";
$pgv_lang["privacy_error"]		= "详细资料在这个人员专用。<br />";
...
$pgv_lang["parents_and_child"]		= "添加父项和儿童记录以这个家庭记录。";
...
$pgv_lang["person_living"]		= "这个人员是生存。  私有详细资料不会是包括的。";
...
$pgv_lang["explain_options"]		= "如果您选择投下表所有资料用这GEDCOM 将替换。<br />如果您选择导入和工作以多GEDCOMs, PhpGedView 将清除被导入使用一GEDCOM 以同样文件名的任一个资料。  这个选项允许您对存储多个GEDCOM 资料在同样表中和容易地切换在他们之间。";
...
$pgv_lang["htmlplus_block_adoption"]= "收养";
...
$pgv_lang["stat_longest_life"]		= "最长寿命";
...
$pgv_lang["confirm_password"]		= "您必须证实密码。";
$pgv_lang["save"]			= "保存";
$pgv_lang["saveandgo"]		= "保存并到添加下一个新纪录";
$pgv_lang["delete"]			= "删除";
$pgv_lang["edit"]			= "编辑";
$pgv_lang["no_login"]			= "无法确认用户。";
$pgv_lang["basic_realm"]			= "进入家谱系统";
$pgv_lang["basic_auth_failure"]		= "你必须输入有效的用户名和密码才可以查看";
...
$pgv_lang["changes_exist"]		= "已对此GEDCOM进行了更改";
...
$pgv_lang["now_import"]			= "现在您应该导入GEDCOM 记录入PhpGedView 由点击在导入链接如下。";
$pgv_lang["add"]			= "添加";
...
$pgv_lang["year_anniversary"]		= "#year_var# 年週年纪念";
$pgv_lang["today"]					= "今天";
$pgv_lang["day"]			= "日:";
...
$pgv_lang["pls_note05"]			= "待完成此页面上的表格并验证您的答案后，您将收到一封确认电子邮件，其中包含您在此页面上指定的电子邮件地址。 使用确认电子邮件，您将激活您的帐户; 如果您未能在七天内激活您的帐户，它将被清除（您可以在此时再次注册该帐户）。 要使用此站点，您需要知道您的登录名和密码。 您必须在此页面上指定现有的有效电子邮件地址才能收到帐户确认电子邮件。<br /> <br />如果您在本网站注册帐户时遇到问题，请向网站管理员提交支持请求。";
$pgv_lang["mail01_line01"]		= "你好#user_fullname# ...";
$pgv_lang["mail01_line02"]		= "在（#SERVER_NAME#）上发出了使用您的电子邮件地址（#user_email#）登录的请求。";
...
$pgv_lang["mail01_subject"]		= "你在#SERVER_NAME#注册";
...
$pgv_lang["pls_note06"]			= "现在，您将收到一封确认电子邮件地址（#user_email#）。 使用确认电子邮件，您将激活您的帐户; 如果您未能在七天内激活您的帐户，它将被清除（您可以在此时再次注册该帐户）。 要登录此站点，您需要知道您的登录名和密码。";
...
$pgv_lang["pwreqinfo"]			= "<br />邮件被发送到电子邮件地址(#user[email]#)，包括新密码。<br /> <br />请检查您的邮件帐户，因为邮件应在接下来的几分钟内收到。<br /> <br />建议：<br /> <br />请求邮件后，您应该使用新密码登录本网站并进行更改以保持数据的完整性.";
...
$pgv_lang["mygedview_desc"]		= "您的MyGedView 页允许您保留您喜爱的人员书签, 跟踪即将来临的活动, 并且与其它PhpGedView 用户合作。";
$pgv_lang["no_messages"]		= "您没有待定消息。";
...
$pgv_lang["no_favorites"]		= "您未选择任何收藏页。  添加单个来您的收藏页, 找到您想要添加和然后点击\"添加来我的收藏页\" 链接或使用身份证配件箱如下添加单个由他们的身份证编号单个的详细资料。";
$pgv_lang["add_to_my_favorites"] 	= "添加来我的收藏";
$pgv_lang["confirm_fav_remove"]		= "是否确实要从您的收藏页去除这个项目吗?";
$pgv_lang["portal"]			= "门户";
...
$pgv_lang["message_email1"]		= "以下消息寄发了到您的PhpGedView 用户帐号:";
$pgv_lang["message_email2"]		= "您寄发了以下消息到PhpGedView 用户帐号:";
$pgv_lang["message_email3"]		= "您寄发了以下消息到PhpGedView 管理员:";
$pgv_lang["viewing_url"]		= "这信被送了当观看以下URL: ";
$pgv_lang["messaging2_help"]		= "当您送这信您将接受复製寄发通过电子邮件到您提供的电子邮件。";
...
$pgv_lang["married_in"] = "在#state###上结婚#";
...
$pgv_lang["shared_note_menu"] = "共享笔记选项";
$pgv_lang["repo_menu"] = "存储库选项";
$pgv_lang["search_DM"] = "Daitch-Mokotoff";
$pgv_lang["search_notes"] = "共享笔记";
$pgv_lang["font"] = "字体";
...
$pgv_lang["maxviews_exceeded"] = "允许的#GLOBALS页面查看率[MAX_VIEWS]#perper#GLOBALS[MAX_VIEW_TIME]超过#秒。";
...
$pgv_lang["edit_shared_note"] = "编辑共享笔记";
$pgv_lang["descent_steps"] = "下降步骤";
...
$pgv_lang["add_fav_or_enter_url"] = "或<br />\ n输入网址和标题";
...
$pgv_lang["others"] = "其他";
$pgv_lang["first_letter_name"] = "选择一个字，来展示以该字开头的名字的家庭。";
$pgv_lang["first_letter_sfname"] = "选择一个以该名字开头的字来向家人展示配偶的名字，。";
$pgv_lang["first_letter_iname"] = "选择一个姓氏，以显示以该字开头姓氏的个人。";
$pgv_lang["first_letter_fname"] = "选择一个字，以显示具有以该字开头的特定姓名的个人。";
...
$pgv_lang["review_changes_body"] = "已经对系谱数据库进行了在线更改。这些更改需要在向所有用户显示之前进行审核和接受。请使用下面的URL输入该PhpGedView网站并登录以查看更改。";
$pgv_lang["top10_pageviews_descr"] = "此块将显示已被查看最多的10条记录。此块需要在GEDCOM配置设置中启用命中计数器。";
$pgv_lang["top10_pageviews_block"] = "观看次数最多的项目";
...
$pgv_lang["shared_note"] = "共享笔记";
$pgv_lang["shared_notes_found"] = "找到共享笔记";
$pgv_lang["find_shared_note"] = "查找共享笔记";
$pgv_lang["shared_note_info"] = "共享笔记信息";
$pgv_lang["total_shared_notes"] = "共享笔记总数";
...
$pgv_lang["move_standard"] = "转向标淮";
$pgv_lang["move_protected"] = "转移到受保护的";
...
$pgv_lang["view_fam_nav_details"] = "查看...的详细信息";
$pgv_lang["view_fam_nav_notes"] = "查看......的注释";
...
$pgv_lang["n_x_brothers_son"] = "%2\$d x孙子";
$pgv_lang["n_x_brothers_daughter"] = "%2\$d x孙女";
...
$pgv_lang["n_x_sisters_son"] = "%2\$d x伟大的侄子";
$pgv_lang["n_x_sisters_daughter"] = "%2\$d x伟大的侄女";
$pgv_lang["n_x_grandson_from_son"] = "%3\$d x伟大的孙子";
$pgv_lang["n_x_granddaughter_from_son"] = "%3\$d x伟大的孙女";
$pgv_lang["n_x_grandson_from_daughter"] = "%3\$d x伟大的孙子";
$pgv_lang["n_x_granddaughter_from_daughter"] = "%3\$d x伟大的孙女";
...
$pgv_lang["n_x_paternal_uncle"] = "%2\$d x伟大的叔叔";
$pgv_lang["n_x_maternal_uncle"] = "%2\$d x伟大的叔叔";
...
$pgv_lang["sosa_uncle_bm_4"] = "伟大的叔叔"; //父亲的父亲的兄弟
$pgv_lang["sosa_uncle_bm_5"] = "伟大的叔叔"; //父亲的母亲的兄弟
$pgv_lang["sosa_uncle_bm_6"] = "伟大的叔叔"; //母亲的父亲的兄弟
$pgv_lang["sosa_uncle_bm_7"] = "伟大的叔叔"; //母亲的母亲的兄弟
//for the general case of uncles of the nth degree use the text below
$pgv_lang["n_x_paternal_uncle_bm"] = "%2\$d x伟大的叔叔";
$pgv_lang["n_x_maternal_uncle_bm"] = "%2\$d x伟大的叔叔";
...
$pgv_lang["n_x_paternal_aunt_bm"] = "%2\$d x伟大的阿姨";
$pgv_lang["n_x_maternal_aunt_bm"] = "%2\$d x伟大的阿姨";
...
$pgv_lang["confirm_delete_shared_note"] = "您确定要删除此共享笔记吗？";
...
$pgv_lang["welcome_text_auth_mode_1"] = "<span class ='center'> <b>欢迎来到这个家谱网站</b> </span> <br />每个拥有用户帐户的访问者都可以访问此网站。<br /> <br如果您有用户帐户，可以在此页面登录。如果您没有用户帐户，可以点击下面的相应链接申请。<br /> <br />验证后应用程序，网站管理员将激活您的帐户。当您的申请获得批淮后，您将收到一封电子邮件。";
...
$pgv_lang["acceptable_use"] = "<div class =\"largeError\">注意：</div> <div class =\"error\">填写并提交此表单，即表示您同意：<ul> <li>保护生活隐私在我们的网站上列出; </li> <li>并在下面的文本框中，向您解释与您有关的人，或向我们提供有关应该在我们网站上列出的人的信息。</li> </ul > </DIV>";
...
$pgv_lang["cal_download"] = "允许日历活动下载？";
$pgv_lang["no_events_living"] = "对于下一个#pgv_lang[global_num1]#days，没有为活着的人提供任何活动。";
$pgv_lang["no_events_living1"] = "明天不存在健在人员的事件。";
$pgv_lang["no_events_all"] = "下一个#pgv_lang[global_num1]#days不存在任何事件。";
$pgv_lang["no_events_all1"] = "明天不存在任何事件。";
$pgv_lang["no_events_privacy"] = "下一个#pgv_lang[global_num1]#days存在事件，但隐私限制会阻止您查看它们。";
$pgv_lang["no_events_privacy1"] = "明天会有活动，但隐私限制会阻止你看到它们。";
$pgv_lang["more_events_privacy"] = "<br />下一个#pgv_lang[global_num1]#days存在更多事件，但隐私限制会阻止您查看它们。";
$pgv_lang["more_events_privacy1"] = "<br />明天会有更多的活动，但隐私限制会阻止你看到它们。";
$pgv_lang["none_today_living"] = "今天没有为活着的人提供的活动。";
$pgv_lang["none_today_all"] = "今天没有任何活动。";
$pgv_lang["none_today_privacy"] = "今天存在的事件，但隐私限制阻止你看到它们。";
$pgv_lang["more_today_privacy"] = "<br />今天有更多的活动，但隐私限制阻止你看到它们。";
...
$pgv_lang["message_instructions"] = "<b>请注意：</b>生活个人的私人信息只会发给亲属和亲密朋友。在您收到任何私人数据之前，您将被要求验证您的关系。有时死者的信息也可能如果是这种情况，那是因为没有足够的信息来确定这个人是否还活着，我们可能没有关于这个人的更多信息。<br /> <br />之前提出问题，请通过查看日期，地点和近亲来验证您是否询问了正确的人。如果您要提交对系谱数据的更改，请包括您获取数据的来源。<br /> <br />";
$pgv_lang["sending_to"] = "此消息将发送至#TO_USER#";
$pgv_lang["preferred_lang"] = "此用户更喜欢在#USERLANG#\"中接收消息";
...
$pgv_lang["user_messages_descr"] = "用户消息块显示已发送给活动用户的消息列表。";
$pgv_lang["user_favorites_descr"] = "用户收藏夹块向用户显示数据库中他最喜欢的人的列表，以便他可以轻松链接到他们。";
$pgv_lang["welcome_descr"] = "用户欢迎程序块向用户显示当前日期和时间，快速链接以修改其帐户或转到他自己的谱系图表，以及用于自定义其MyGedView门户页面的链接。";
$pgv_lang["random_media_descr"] = "随机媒体块从当前活动的数据库中随机选择一张照片或其他媒体项目，并将其显示给用户。<br /> <br />管理员确定此块是否可以显示与人员或事件相关的媒体项目。" ;
$pgv_lang["random_media_persons_or_all"] = "只展示人，事件或所有人？";
$pgv_lang["gedcom_descr"] = "GEDCOM欢迎块与用户欢迎块的工作方式相同。它欢迎访问该站点并显示当前活动数据库的标题以及当前日期和时间。";
$pgv_lang["gedcom_favorites_descr"] = "GEDCOM收藏夹块使管理员能够从数据库中指定个人，以便所有人都可以轻松访问他们的信息。这是一种突出显示您家族历史中重要人物的方式。";
$pgv_lang["gedcom_stats_descr"] = "GEDCOM Statistics块向访问者显示了一些关于数据库的基本信息，例如它何时被创建以及其中有多少人。<br /> <br />它还有一个最常用的姓氏列表。你可以将此块配置为不显示频繁姓氏列表，您还可以配置GEDCOM以删除或添加此列表中的名称。您可以在GEDCOM配置中设置此列表的发生阈值。";
$pgv_lang["portal_config_instructions"] = "~#pgv_lang[customize_page]#~<br />~#pgv_lang[customize_gedcom_page]#~<br /> <br />您可以通过按照您希望的方式在页面上放置块来自定义页面。 /> <br />该页面分为<b> Main </b>和<b> Right </b>部分。";
...
$pgv_lang["block_cookiepolicy_body_extlink"] = "<span class =\"warning\">欧盟Cookie法要求此通知。</span> <br />本网站尽量不使用cookies，仅在技术上需要时才这样做。没有个人信息，不是甚至您的用户名或密码也存储在本网站创建的cookie中。有关本网站cookie政策的更多详情，请关注<a href=\"<link>\" target =\"_ blank\" title =\"特定于网站的cookie政策\">此链接</a>。<br /> <br />由于技术原因超出了本网站的控制范围，当您终止与本网站的会话时，这些cookie不会被删除。但是，当您的浏览器终止时，它们会立即被删除。 ";
...
$pgv_lang["recent_changes_none"] = "<b>最后一个#pgv_lang[global_num1]#days没有变化。</b> <br />";
$pgv_lang["recent_changes_some"] = "<b>在最后一次#pgv_lang[global_num1]#days </b> <br />\"中所做的更改";
...
$pgv_lang["chart_booklet"] = "小册子";
$pgv_lang["show_cousins"] = "表兄弟";
//3rd generation
//4th generation

//for the general case of ancestors of the nth generation use the text below
$pgv_lang["sosa_paternal_male_n_generations"] = "%3\$d x父亲的曾祖父";
$pgv_lang["sosa_paternal_female_n_generations"] = "%3\$d x父亲的曾祖母";
$pgv_lang["sosa_maternal_male_n_generations"] = "%3\$d x产妇曾祖父";
$pgv_lang["sosa_maternal_female_n_generations"] = "%3\$d x产妇曾祖母";

//-- FAN CHART
$pgv_lang["compact_chart"] = "紧凑图表";
$pgv_lang["fan_chart"] = "圆图";
...
$pgv_lang["rss_logo_descr"] = "由PhpGedView创建的Feed";
$pgv_lang["rss_feeds"] = "RSS订阅";
$pgv_lang["no_feed_title"] = "饲料不可用";
$pgv_lang["no_feed"] = "这个PhpGedView网站没有可用的RSS源";
$pgv_lang["feed_login"] = "如果您在此PhpGedView站点上有一个帐户，则可以使用基本HTTP身份验证<a href=\"#AUTH_URL#\">登录</a>以查看私人信息。";
...
$pgv_lang["stat_5_birth"] = 	 "世纪诞生";
$pgv_lang["stat_6_death"] = 	 "世纪死亡";
$pgv_lang["stat_7_marr"] = "按世纪结婚";
$pgv_lang["stat_7_div"] = "按世纪离婚";
...
$pgv_lang["stat_first_divorce"] = "离婚最早";
...
$pgv_lang["stat_lived_longest"] = "去世的最佳年龄";
...
$pgv_lang["stat_youngest_father"] = 	 "最小的父亲";
$pgv_lang["stat_youngest_mother"] = "最小的母亲";
$pgv_lang["stat_oldest_father"] = "最老的父亲";
$pgv_lang["stat_oldest_mother"] = "最老的母亲";
...
$pgv_lang["stat_top_age_siblings"] = "兄弟姐妹之间的最佳年龄";
...
$pgv_lang["top_givennames"] = "最受欢迎的名字";
$pgv_lang["events"] = "事件";
$pgv_lang["stat_records"] = 	 "记录";
$pgv_lang["stat_notes"] = "笔记";
$pgv_lang["stat_first_event"] = "第一次活动";
$pgv_lang["stat_last_event"] = "最后一次活动";
...
$pgv_lang["stat_countries"] = "各国的活动";

//-- statisticsplot utility
$pgv_lang["statistiek_list"] = "统计图";
$pgv_lang["stpl"] = "......";
$pgv_lang["stplinfo"] = "密谋信息：";
...
//-- alive in year
$pgv_lang["alive_in_year"] = "活着";
$pgv_lang["is_alive_in"] = "活着#YEAR#";
$pgv_lang["alive"] = "活着";
$pgv_lang["dead"] = "去世";
$pgv_lang["maybe"] = "也许 ";
$pgv_lang["both_alive"] = "两个都活着";
...
$pgv_lang["click_here_help"] = "~#pgv_lang[click_here]#~<br /> <br />点击此按钮保存更改。<br /> <br />您将返回#pgv_lang[welcome]#或#pgv_lang[mygedview] ] #page，但您的更改可能不会显示。您可能需要使用浏览器的Page Reload功能正确查看更改。";
$pgv_lang["block_summaries"] = "~#pgv_lang[block_desc]#~<br /> <br />以下是您可以在#pgv_lang[welcome]#或#pgv_lang[mygedview] #page上放置的每个块的简短描述。<br/> <table border ='1'align ='center'> <tr> <td class ='list_value'> <b> #pgv_lang[name]#</b> </td> <td class ='list_value'> <b> #pgv_lang[description]#</b> </td> </tr> #pgv_lang[block_summary_table]#</table> <br /> <br />";
...
$pgv_lang["add_faq_body"] = "常见问题解答";
$pgv_lang["add_faq_order"] = "常见问题解答";
$pgv_lang["add_faq_visibility"] = "常见问题解答";
$pgv_lang["no_faq_items"] = "FAQ列表是空的。";
$pgv_lang["position_item"] = "职位项目";
...
$pgv_lang["media_privacy"] = "隐私限制阻止您查看此项目";
$pgv_lang["relations_heading"] = "图像与：";
$pgv_lang["media_broken"] = "此媒体文件已损坏，无法加水印";
$pgv_lang["unknown_mime"] = "媒体防火墙错误：>未知Mimetype <for file";
...
$pgv_lang["button_TREE_L"] = "显示«离开»夫妇或个人。这些人是活着但没有记录在数据库中的孩子。";
$pgv_lang["button_TREE_R"] = "显示«根源»夫妻或个人。这些人也可能被称为\"族长\"。他们是没有父母记录在数据库中的个人。";
