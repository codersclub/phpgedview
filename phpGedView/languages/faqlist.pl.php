...
$faqlist["FAQ_030_PLACES3"] = "W określeniu poprawnego formatu miejsca mogą pomóc dwie metody:<br /><ul><li>skorzystaj z małej ikonki \"świata\" obok pola miejsca, aby zobaczyć, jakie miejsca znajdują się już w naszej bazie danych. To dobry sposób, aby odszukać nieznaną gminę miasta, ponieważ prawdopodobnie znajduje się już w bazie. Skorzystaj z filtra, aby ograniczyć wyszukiwanie i kliknij odpowiednim wyniku, aby umieścić go w pustym polu miejsca,</li><li>kliknij na znak plus (+) poniżej pola miejsca. Zobaczysz dodatkową listę pól dla państwa, stanu, województwa i miasta. Obok pola państwa znajduje się lista rozwijalna państw z ich standardowym skrótem trzyliterowym.</li></ul>";
...
$faqlist["FAQ_030_NAMES"] = "<strong>IMIONA I NAZWISKA</strong>: Wprowadzanie imion i nazwisk za pomocą formularza jest bardzo intuicyjne; masz też do dyspozycji pomoc. Pole INDI ENTRY BOX powinno rozwinąć pola imion i nazwisk; jeśli nie, wówczas to pole oraz pole miejsc możesz rozwinąć, klikając odpowiedni znak plus (+).";
...
$faqlist["FAQ_030_CHNG"] = "<strong>ZMIANY</strong> i <strong>WPISY</strong>: Zmiany w istniejących informacjach na temat osoby lub rodziny nie będą widoczne, dopóki nie zostaną zatwierdzone przez administratora. Mimo że często zaglądamy na stronę, wyślij do nas email, jeśli chcesz, abyśmy szybciej przejrzeli i zatwierdzili dodatki i zmiany. Fakty odnoszące się do tworzenia lub modyfikacji rodziny wprowadza się na stronie \"Bliscy krewni\". To tu wprowadzasz śluby, rozwody, dzieci, spisy ludności — każdy fakt lub wydarzenie, które dotyczy rodziny. Kiedy dodajesz kilkoro dzieci, najlepiej użyć odnośnika pokaż rodzinę dla danego małżonka i dodać dziecko przez odnośnik \"Dodaj dziecko do tej rodziny\". To szybsza metoda, niż używanie strony \"Bliscy krewni\", ponieważ po każdym dodaniu powraca na stronę \"Pokaż INDI\", a nie \"Bliscy krewni\". Pytania? Jeśli czegoś nie rozumiesz, po prostu zapytaj, a my z przyjemnością pomożemy.";
