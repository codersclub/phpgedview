...
$pgv_lang["mod_admin_installed"]	= "Namešceni dodatki";
$pgv_lang["mod_admin_tabs"]		= "Uredi zavihke";
$pgv_lang["mod_admin_menus"]		= "Uredi menije";
$pgv_lang["mod_admin_intro"]		= "Spodaj je seznam vseh dodatkov v tej razlicici PhpGedView.  Dodatki so namešceni s postavitvijo v imenik <i>modules</i>.  Tukaj lahko nastavite nivo dostopa za vsak GEDCOM in vsak dodatek.  Ce dodatek vkljucuje zavihke za posamezno stran ali menije jim lahko nastavite še nivo dostopa in vrstni red.";
$pgv_lang["mod_admin_active"]		= "Aktiven";
$pgv_lang["mod_admin_name"]		= "Ime dodatka";
$pgv_lang["mod_admin_description"]	= "Opis";
$pgv_lang["mod_admin_version"]		= "Razlicica / PGV";
...
$pgv_lang["start_entering"] 		= "Zacni vnašati podatke";
$pgv_lang["add_gedcom_from_path"] 	= "Dodaj GEDCOM z imenika";
$pgv_lang["get_started_instructions"]	= "Izberi eno od teh možnosti za zacetek dela v PhpGedView";
...
$pgv_lang["install_wizard"] = "Namestitveni carovnik";
...
$pgv_lang["checking_php_version"]		= "Preverjanje zahtevane razlicice PHP:";
$pgv_lang["failed"]		= "Neuspešno";
$pgv_lang["pgv_requires_version"]		= "PhpGedView potrebije PHP razlicico #PGV_REQUIRED_PHP_VERSION# ali višjo.";
$pgv_lang["using_php_version"]		= "Uporabljate PHP razlicico #PGV_ACTUAL_PHP_VERSION#";
...
$pgv_lang["config.php_missing_instr"]		= "Ta namestitveni carovnik ne bo mogel zapisati nastavitve v datoteko config.php.  Lahko pa skopirate datoteko config.dist in jo preimenujete v config.php.  Možno je tudi, da po tem, ko koncate s tem carovnikom, prenesete nastavitve in jih naložite v ciljno datoteko config.php.";
$pgv_lang["config.php_not_writable"]		= "config.php ni dostopen za pisanje.";
$pgv_lang["config.php_not_writable_instr"]		= "Ta namestitveni carovnik ne bo model zapisati vaše nastavitve v datoteko config.php.  Za datoteko lahko nastavite dovoljenje za pisanje ali pa po tem, ko koncate s tem carovnikom, prenesete  nastavitve in jih naložite v ciljno datoteko config.php.";
...
$pgv_lang["checking_timelimit"]		= "Preverjanje možnosti za spremembo casovne omejitve:";
$pgv_lang["cannot_change_timelimit"]		= "Sprememba casovne omejitve ni možna.";
$pgv_lang["cannot_change_timelimit_instr"]		= "Ne boste mogli poganjati vseh funkcij v veliki bazi z vekiko osebami.";
$pgv_lang["current_max_timelimit"]		= "Vaša casovna omejitev je";
...
$pgv_lang["current_max_upload"]		= "Najvecja velikost naložene datoteke je:";
$pgv_lang["check_gd"]		= "Preverjanje prisotnosti slikovne knjižnice GD:";
$pgv_lang["cannot_use_gd"]		= "Nimate likovne knjižnice GD.  Samodejna izdelava slicic ne bo možna.";
$pgv_lang["check_sax"]		= "Preverjanje prisotnosti knjižnice SAX XML:";
$pgv_lang["cannot_use_sax"]		= "Nimate knjižnice SAX XML.  Ne boste mogli poganjati porocil in še nekaterih pomožnih funkcij.";
...
$pgv_lang["warning_instr"]		= "Ce katero od teh opozoril ni uspelo boste lahko še vedno uporabljali PhpGedView na tem strežniku. Nekatere funkcionalnosti pa bodo izkljucene ali pa boste zaznali slabšo odzivnost.";
...
$pgv_lang["index_dir_cleanup_inst"]	= "Datoteko ali podimenik iz imenika Index zbrišete tako, da datoteko ali podimenik potegnete v koš ali izberete njegov  okvircek za preverjanje. Za dokoncen izbris oznacenih datotek kliknite gumb za brisanje.<br /><br />Datoteke z oznako <img src=\"./images/RESN_confidential.gif\" alt=\"\" />so nujne za pravilno delovanje, zato jih ni mogoce odstraniti.<br />Datoteteke z oznako <img src=\"./images/RESN_locked.gif\" alt=\"\" /> vsebujejo pomembne nastavitve ali nerazrešene podatkovne spremembe, zato jih izbrišite, le ce to resnicno želite.<br /><br />";
$pgv_lang["index_dir_cleanup"]		= "Pocisti imenik Index";
$pgv_lang["clear_cache_succes"]		= "Vmesne datote so bile odstranjene.";
$pgv_lang["clear_cache"]			= "Pocisti vmesne datoteke";
$pgv_lang["sanity_err0"]			= "Napake:";
$pgv_lang["sanity_err1"]			= "Imeti morate vsaj #PGV_REQUIRED_PHP_VERSION# ali višjo razlicico PHP.";
$pgv_lang["sanity_err2"]			= "Datoteka ali imenik <i>#GLOBALS[whichFile]#</i> ne obstaja. Prosim preverite ali datoteka oz. imenik obstaja, da ni bila napacno poimenovana in da je dovoljenje za branje pravilno nastavljeno.";
...
$pgv_lang["sanity_warn1"]			= "Imenik <i>#GLOBALS[MEDIA_DIRECTORY]#</i> ni zapisljiv. Ne boste mogli naložiti fotografij ali izdelati njihovih slicic.";
$pgv_lang["sanity_warn2"]			= "Imenik <i>#GLOBALS[MEDIA_DIRECTORY]#thumbs</i> ni pisljiv. Ne boste mogli naložiti fotografi in izdelati slicic iz njih.";
$pgv_lang["sanity_warn3"]			= "Slikovna knjižnica GD ne obstaja. PhpGedView bo sicer še deloval, brez knjižnice GD pa ne bo mogoce izvajanje dolocenih funkcij, kot sta izdelava slicic ali krožni prikaz. Za vec informacij poglejte <a href='http://www.php.net/manual/en/ref.image.php'>http://www.php.net/manual/en/ref.image.php</a>.";
$pgv_lang["sanity_warn4"]			= "Knjižnica XML Parser ne obstaja.  PhpGedView bo sicer še deloval, brez knjižnice XML Parser pa ne bo mogoce izvajanje dolocenih funkcij, kot so izdelava porocil ali spletnih storitev. Za vec informacij poglejte <a href='http://www.php.net/manual/en/ref.xml.php'>http://www.php.net/manual/en/ref.xml.php</a>.";
$pgv_lang["sanity_warn5"]			= "Knjižnica DOM XML ne obstaja.  PhpGedView bo sicer še deloval, ne bo pa mogoce izvajanje dolocenih funkcij, kot so možnosti izvoza Gramps v košarici za izreze, prenos  in spletne storitve. Za vec informacij poglejte <a href='http://www.php.net/manual/en/ref.domxml.php'>http://www.php.net/manual/en/ref.domxml.php</a>.";
$pgv_lang["sanity_warn6"]			= "Knjižnica Koledar ne obstaja. PhpGedView bo sicer deloval, ne bo pa mogoce izvajanje dolocenih funkcij, kot je pretvorba koledarjev v drugacne koledarje, npr. v hebrejskega ali francoskega. Ta knjižnica namrec ni bistvena za delovanje programa PhpGedView. Za vec informacij poglejte  It is not essential for running PhpGedView. <a href='http://www.php.net/manual/en/ref.calendar.php'>http://www.php.net/manual/en/ref.calendar.php</a>.";
$pgv_lang["ip_address"]				= "IP naslov";
$pgv_lang["date_time"]				= "Datum in cas";
$pgv_lang["log_message"]			= "Sporocilo dnevnika";
...
$pgv_lang["nobody"]				= "Nihce";
$pgv_lang["thumbnail_deleted"]			= "Slicica je bila uspešno izbrisana.";
$pgv_lang["thumbnail_not_deleted"]		= "Slicice ni bilo mogoce izbrisati.";
$pgv_lang["step2"]				= "Korak 2 od 4:";
$pgv_lang["refresh"]				= "Osveži";
$pgv_lang["move_file_success"]			= "Datoteke fotografij in slicic so bile uspešno premešcene.";
...
$pgv_lang["search_add_links"]		= "Išci osebe za vstavitev v seznam povezav.";
...
$pgv_lang["files_in_backup"]		= "Datoteke, vkljucene v ta backup.";
$pgv_lang["created_remotelinks"]	= "Tabela <i>Remotelinks</i> uspešno ustvarjena.";
$pgv_lang["created_remotelinks_fail"] 	= "Tabele <i>Remotelinks</i> ni mogoce ustvariti.";
$pgv_lang["created_indis"]			= "Tabela <i>Individuals</i> uspešno ustvarjena.";
$pgv_lang["created_indis_fail"] 	= "Tabele <i>Individuals</i> ni mogoce ustvariti.";
$pgv_lang["created_fams"]			= "Tabela <i>Families</i> uspešno ustvarjena.";
$pgv_lang["created_fams_fail"]		= "Tabele <i>Families</i> ni bilo mogoce ustvariti.";
$pgv_lang["created_sources"]		= "Tabela <i>Sources</i> uspešno ustvarjena.";
$pgv_lang["created_sources_fail"]	= "Tabele <i>Sources</i> ni bilo mogoce ustvariti.";
$pgv_lang["created_other"]			= "Tabela <i>Other</i> uspešno ustvarjena.";
$pgv_lang["created_other_fail"] 	= "Tabele <i>Other</i> ni bilo mogoce ustvariti.";
$pgv_lang["created_places"] 		= "Tabela <i>Places</i> uspešno ustvarjena.";
$pgv_lang["created_places_fail"]	= "Tabele <i>Places</i> ni bilo mogoce ustvariti.";
$pgv_lang["created_placelinks"] 	= "Tabela <i>Place links</i> uspešno ustvarjena.";
$pgv_lang["created_placelinks_fail"]	= "Tabele <i>Place links</i> ni bilo mogoce ustvariti.";
$pgv_lang["created_media_fail"]	= "Tabela <i>Media</i> uspešno ustvarjena.";
$pgv_lang["created_media_mapping_fail"]	= "Tabele <i>Media mappings</i> ni bilo mogoce ustvariti.";
$pgv_lang["no_thumb_dir"]			= " Imenik slicic ne obstaja in ga ni mogoce ustvariti. ";
$pgv_lang["folder_created"]			= "Imenik ustvarjen";
$pgv_lang["folder_no_create"]		= "Imenika ni bilo mogoce ustvariti";
$pgv_lang["security_no_create"]		= "Varnostno opozorilo: Datoteke <b><i>index.php</i></b> ni bilo mogoce ustvariti v ";
$pgv_lang["security_not_exist"]		= "Varnostno opozorilo: Datoteka <b><i>index.php</i></b> ne obstaja v ";
$pgv_lang["label_delete"]           	= "Izbriši";
$pgv_lang["progress_bars_info"]			= "Spodaj je prikazan potek uvoza. Ce se casovna omejitev iztece, se bo uvoz sicer ustavil, vi pa boste imeli možnost, da postopek nadaljujete s pritiskom gumba <b>Nadaljuj</b>. Ce gumba <b>Nadaljuj</b> ne vidite, vnovic zaženite uvoz z nižjo vrednostjo casovne omejitve.";
...
$pgv_lang["admin_user_warnings"]		= "En ali vec racunov ima opozorila";
$pgv_lang["admin_verification_waiting"] = "Uporabniški racuni cakajo na odobritev upravitelja";
...
$pgv_lang["cleanup_places"] 				= "Pocisti kraje";
$pgv_lang["cleanup_users"]				= "Pocisti uporabnike";
...
$pgv_lang["config_help"]						= "Pomoc za nastavitve";
...
$pgv_lang["unsync_warning"] 					= "Ta datoteka GEDCOM <em>ni</em> sinhronizirana s podatkovno bazo. Mogoce ne vsebuje zadnje razlicice vaših podatkov. Za ponoven uvoz iz podatkovne baze in ne iz te datoteke jo morate prenesti in vnovic naložiti.";
...
$pgv_lang["del_gedrights"]						= "GEDCOM ni vec aktiven, odstranite povezave uporabnikov.";
...
$pgv_lang["download_note"]						= "OPOZORILO: Obsežne podatkovne baze zahtevajo pred prenosom daljši cas priprave. Ce se cas vmesnika PHP iztece pred koncem prenosa, datoteka mogoce ne bo v celoti prenesena.<br /><br />Ce se želite prepricati, ali je datoteka pravilno prenesena, preverite, ali se zadnja vrstica datoteke v obliki GEDCOM glasi <b>0&nbsp;TRLR</b> ali pa da se zadnja vrstica v obliki XML glasi <b></database></b>.  Te datoteke so v tekstni obliki in zato lahko uporabite ustrezen urejevalnik, vendar pazite, da  datoteke <u>ne</u> shranite, potem ko ste jo po prenosu ogledali.<br /><br />V splošnem lahko traja prenos tako dolgo, kot je bilo potrebno za uvoz vaše GEDCOM datoteke.";
$pgv_lang["editaccount"]						= "Dovoli uporabniku, da uredi informacije svojega racuna";
$pgv_lang["empty_dataset"]						= "Ali želite izbrisati stare podatke in jih nadomestiti z novimi?";
$pgv_lang["empty_lines_detected"]				= "Zaznane so bile prazne vrstice v GEDCOM datoteki. Pri cišcenju so bile odstranjene te prazne vrstice.";
$pgv_lang["enable_disable_lang"]				= "Nastavi podprte jezike";
$pgv_lang["error_ban_server"]       			= "Napacen IP naslov.";
...
$pgv_lang["error_url_blank"]					= "Prodim, da ne pušcate naziv ali URL oddaljenega spretnega mesta prazno";
$pgv_lang["error_view_info"]       				= "Izbrati morate osebo za katero želite pogledati informacije.";
$pgv_lang["example_date"]						= "Primer napacnega datuma v vašem GEDCOM-u:";
$pgv_lang["example_place"]						= "primer napacnega kraja v vašem GEDCOM-u:";
...
$pgv_lang["import_complete"]					= "Uvoz koncan";
...
$pgv_lang["import_time_exceeded"]				= "Omejitev casa izvajanja je bila dosežena.  Kliknite gumb Nadaljuj za obnovitev uvoza GEDCOM datoteke.";
$pgv_lang["inc_languages"]					= " Jeziki";
$pgv_lang["INDEX_DIRECTORY"]					= "Imenik Index";
$pgv_lang["invalid_dates"]					= "Zaznani so napacni zapisi datumov. Ob cišcenju bodo ti spremenjeni v obliko DD MMM YYYY (npr. 1 JAN 2009).";
$pgv_lang["BOM_detected"] 					= "Zaznano je zaporedje Byte Order Mark (BOM) na zacetku datoteke. Pri cišcenju bo ta posebna koda odstranjena.";
$pgv_lang["invalid_header"] 					= "Zaznane so vrstce pred GEDCOM glavo <b>0&nbsp;HEAD</b>.  Ob cišcenju bodo te vrstice odstranjene.";
...
$pgv_lang["label_manual_search_engines"]			= "Rocno oznaci iskalne stroje po IP-jihh";
...
$pgv_lang["last_login"]							= "Zadnjic prijavljen";
$pgv_lang["lasttab"]							= "Zavihek zadnjega obiska za uporabnika";
$pgv_lang["leave_blank"]						= "Pustite polja za geslo prazno, ce želite ohtaniti trenutno geslo.";
$pgv_lang["link_manage_servers"]   				= "Upravljaj spletne strani";
$pgv_lang["logfile_content"]					= "Vsebina dnevnika";
$pgv_lang["macfile_detected"]					= "Zaznana Macintosh datoteka.  Ob cišcenju vaše datoteke, bo pretvorjena v DOS datoteko.";
$pgv_lang["mailto"]								= "Povezava pošlji-k";
$pgv_lang["merge_records"]						= "Združi zapise";
$pgv_lang["message_to_all"]						= "Pošlji sporocilo vsem uporabnikom";
$pgv_lang["messaging"]							= "PhpGedView interno sporocanje";
$pgv_lang["messaging2"]							= "Interno sporocanje z e-pošto";
$pgv_lang["messaging3"]							= "E-pošto";
$pgv_lang["month_before_day"]					= "Dni pred dnem (MM DD YYYY)";
$pgv_lang["monthly"]							= "Mesecno";
$pgv_lang["msql"]								= "Mini SQL";
$pgv_lang["mssql"]								= "Microsoft SQL server";
$pgv_lang["mysql"]								= "MySQL";
$pgv_lang["never"]								= "Nikoli";
$pgv_lang["no_logs"]							= "Izkljuci beleženje";
$pgv_lang["no_messaging"]						= "Nobenega nacina kontakta";
...
$pgv_lang["PGV_SESSION_TIME"]					= "Casovna omejitev seje";
...
$pgv_lang["PGV_STORE_MESSAGES"]					= "Dovoli, da se sporocila shranijo na spletno stran";
$pgv_lang["phpinfo"]							= "Informacije o PHP";
$pgv_lang["place_cleanup_detected"] 					= "Zaznane napake kodiranja.  Te napake se mora odpraviti";
$pgv_lang["please_be_patient"]						= "Prosim pocakaje";
...
$pgv_lang["time_limit"]							= "Casovna omejitev:";
...
$pgv_lang["update_myaccount"]						= "Posodobi moj racun";
$pgv_lang["update_user"]						= "Posodobi racun";
$pgv_lang["upload_gedcom"]						= "Naloži GEDCOM";
$pgv_lang["USE_REGISTRATION_MODULE"]					= "Dovoli gostom, da zaprosijo za registracijo racuna";
$pgv_lang["user_auto_accept"]						= "Samodejno sprejmi spremembe, ki jih naredi ta uporabnik";
$pgv_lang["user_contact_method"]					= "Zaželjen nacin kontakta";
...
$pgv_lang["user_path_length"]						= "Najvecja dolžina poti zasebnosti";
...
$pgv_lang["usr_idle"]							= "Število mesecev do zadnje prijave v uporabnicki racun, da je voden kot neaktiven: ";
$pgv_lang["usr_idle_toolong"]						= "Uporabniški racuni, ki so bili predolg neaktivni: ";
$pgv_lang["usr_no_cleanup"]						= "Nic ni najdeno za pocistiti";
$pgv_lang["usr_unset_gedcomid"]						= "Odstrani GEDCOM ID za ";
$pgv_lang["usr_unset_rights"]						= "Odstrani GEDCOM pravice za ";
$pgv_lang["usr_unset_rootid"]						= "Odstrani izhodišcni ID za ";
$pgv_lang["valid_gedcom"]						= "Zaznan pravilen GEDCOM. Cišcenje ni potrebno.";
...
$pgv_lang["verify_upload_instructions"]					= "GEDCOM datoteka z istime imenom že obstaja. Ce boste nadaljevali, bo stara GEDCOM datoteka zamenjana z datoteko, ki ste jo naložili in postopek uvoza se bo zacel. Ce prekinete, bo stari GEDCOM ostal nespremenjen.";
...
$pgv_lang["gedcheck_text"]= "Ta modul preverja format GEDCOM datoteke glede na <a href=\"http://phpgedview.sourceforge.net/ged551-5.pdf\">5.5.1 GEDCOM Specifikacijo</a>.  Preverja tudi pogoste napake v vaših podatkih. Pomnite, da obstaja veliko razlicic, razširitev in varijacij te specifikacije, zato ne smete biti zaskrbljeni pri vrsticah oznacenih kot  \"Kriticno\".  Razlaga vseh napak po vrstica se najde v specifikaciji, zato popreje preverite tam preden prosite za pomoc.";
...
$pgv_lang["multiple"]     = "veckratni";
$pgv_lang["invalid"]      = "napacno";
$pgv_lang["too_many"]     = "prevec";
$pgv_lang["too_few"]      = "premalo";
$pgv_lang["no_link"]      = "se ne povezuje nazaj";
$pgv_lang["data"]         = "podatek";
$pgv_lang["see"]          = "glej";
$pgv_lang["noref"]        = "Nic se ne sklicuje na ta zapis";
$pgv_lang["tag"]          = "oznaka";
...
$pgv_lang["tradition_paternal"]		= "Ocetova";
