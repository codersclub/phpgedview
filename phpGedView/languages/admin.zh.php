...
$pgv_lang["error_header"] 		= "家譜文件,[#GEDCOM#], 不存在在被指定的地點。";
...
$pgv_lang["ALLOW_USER_THEMES"]			= "用戶可以選擇自己的背景主題";
...
$pgv_lang["date_registered"]					= "注冊日";
$pgv_lang["day_before_month"]					= "在一個月前面的日子 (DD MM YYYY)";
$pgv_lang["DEFAULT_GEDCOM"]						= "選擇家譜";
$pgv_lang["default_user"]						= "創造管理用戶";
...
$pgv_lang["duplicate_username"]		= "複制用戶名。  一名用戶與那用戶名已經存在。  請回去和選擇其它用戶名。";
...
$pgv_lang["import_marr_names"]					= "計算婚後名字";
$pgv_lang["import_options"]						= "讀入選項";
$pgv_lang["import_progress"]					= "正在倒入...";
$pgv_lang["import_statistics"]					= "導入統計";
$pgv_lang["inc_languages"]						= "語言";
$pgv_lang["INDEX_DIRECTORY"]					= "工作文件夾";
...
$pgv_lang["logfile_content"]					= "看電腦日記文件";
$pgv_lang["mailto"]								= "發電郵件";
$pgv_lang["merge_records"]						= "合並紀錄";
...
$pgv_lang["upload_gedcom"]		= "上載的家譜文件";
$pgv_lang["USE_REGISTRATION_MODULE"]			= "允許客人申請注冊";
$pgv_lang["user_auto_accept"]					= "自動接受用戶的更改變化";
$pgv_lang["user_contact_method"]				= "理想的聯系方法";
...
$pgv_lang["users_unver_admin"]					= "沒有被管理員確認";
$pgv_lang["usr_deleted"]						= "刪除用戶：";
$pgv_lang["verified"]			= "User verified himself:";
$pgv_lang["verified_by_admin"]		= "用戶被管理員接受";
$pgv_lang["verify_gedcom"]						= "確認家譜文件";
$pgv_lang["visitor"]							= "客人";
$pgv_lang["weekly"]								= "每周";
$pgv_lang["welcome_new"]						= "歡迎來到你的家譜網站。";
$pgv_lang["yearly"]								= "每年";
$pgv_lang["admin_OK_subject"]					= "允許賬戶在#SERVER_NAME#";
$pgv_lang["gedcheck"]     = "家譜文件測驗";
$pgv_lang["level"]        = "層次";
$pgv_lang["error"]        = "出錯";
$pgv_lang["warning"]      = "警告";
$pgv_lang["info"]         = "信息";
...
$pgv_lang["associated_files"]		= "有聯系的文件：";
$pgv_lang["warn_file_delete"]		= "這個文件有重要的語言設置或等待改變的數據。你肯等要刪除它嗎？";
$pgv_lang["deleted_files"]          = "被刪除的文件：";
$pgv_lang["index_dir_cleanup_inst"]	= "如果想刪除次文件夾的文件，請把它們拉到垃圾箱或者把它打上鈎。按下刪除便永久刪除此文件。<br /><br />有<img src=\"./images/RESN_confidential.gif\" /> 標簽的文件不能被刪除，因爲它被系統用。<br /> 有<img src=\"./images/RESN_locked.gif\" /> 標簽的文件有重要的設置或等待改變的數據，所以建議不要刪除。<br /><br />";
$pgv_lang["sanity_err0"]			= "錯誤：";
$pgv_lang["sanity_warn0"]			= "警告：";
$pgv_lang["refresh"]				= "刷新";
$pgv_lang["gedadmin"]				= "家譜管理員";
$pgv_lang["remove_all_files"]		= "刪除沒有必要的文件";
$pgv_lang["label_timedban_servers"] = "通過IP拒絕定時訪問";
$pgv_lang["enter_banexpiry"] = "輸入拒絕訪問的到期日期和時間：<br /> 2012.12.31@23:59";
...
$pgv_lang["mod_admin_tabs"] = "管理標簽";
$pgv_lang["mod_admin_menus"] = "管理菜單";
$pgv_lang["mod_admin_intro"] = "下面是PhpGedView實例中安裝的所有模塊的列表。模塊通過將它們放在<i> modules </i>目錄中來安裝。在這裏你可以爲每個模塊設置每個GEDCOM的訪問級別。如果是模塊包括單個頁面的選項卡或菜單欄的菜單，您還可以設置每個頁面的訪問級別和順序。";
...
$pgv_lang["enter_comment"] = "你可以在這裏輸入評論。";
...
$pgv_lang["config.php_missing_instr"] = "此安裝向導將無法將您的設置寫入config.php文件。您可以複制config.dist文件並將其重命名爲config.php。或者，完成此向導後，您可以選擇下載您的設置並上傳生成的config.php文件。";
$pgv_lang["config.php_not_writable"] = "config.php不可寫。";
$pgv_lang["config.php_not_writable_instr"] = "此安裝向導將無法將您的設置寫入config.php文件。您可以在文件上設置寫入權限，或者在完成此向導後，您可以選擇下載設置並上傳生成的config.php文件。";
$pgv_lang["passed"] = "通過。";
...
$pgv_lang["current_max_upload"] = "您的最大上傳文件大小爲：";
...
$pgv_lang["sanity_warn6"] = "日曆庫不存在.PhpGedView仍然可以運行，但某些功能，例如轉換爲其他日曆，如希伯來語或法語，將無法正常工作。運行PhpGedView並不是必需的。請參閱<a href =' http://www.php.net/manual/en/ref.calendar.php'>http://www.php.net/manual/en/ref.calendar.php </a>了解更多信息。";
...
$pgv_lang["click_choose_head"] = "點擊#GLOBALS[tempStringHead]#選擇人爲家長。";
$pgv_lang["click_choose_head_text"] = "點擊選擇人爲家長。";
$pgv_lang["head"] = "頭";
$pgv_lang["id_empty"] = "添加鏈接時，ID字段不能爲空。";
$pgv_lang["link_deleted"] = "鏈接到#GLOBALS[remLinkId]#deleted";
$pgv_lang["link_added"] = "鏈接到#GLOBALS[addLinkId]#add added";
...
$pgv_lang["progress_bars_info"] = "下面的狀態欄將告訴您導入的進度。如果時間限制用完，導入將停止，並且將要求您按<b>繼續</b>按鈕。如果您沒有看到<b>繼續</b>按鈕，您必須以較小的時間限制值重新啓動導入。";
...
$pgv_lang["change_id"] = "將個人ID更改爲";
$pgv_lang["choose_priv"] = "選擇隱私級別：";
$pgv_lang["comment"] = "管理員對用戶的評論";
$pgv_lang["comment_exp"] = "日期管理員警告";
$pgv_lang["config_still_writable"] = "您的<i> config.php </i>文件仍然可寫。爲了安全起見，您應該在完成站點配置後將此文件的權限設置爲只讀。";
...
$pgv_lang["error_remove_site_linked"] = "無法刪除遠程服務器，因爲其Connections列表不爲空。";
$pgv_lang["error_remote_duplicate"] = "這個遠程數據庫已作爲<i>#GLOBALS[whichFile]#</i>列在列表中";
...
$pgv_lang["gedcom_downloadable"] = "此GEDCOM文件可通過互聯網下載！<br />請參閱<a href=\"readme.txt\"> <b> readme.txt </b> </a>文件的安全部分以修複這個問題";
...
$pgv_lang["invalid_dates"] = "檢測到無效日期格式，清理後這些格式將更改爲DD MMM YYYY格式（例如2004年1月1日）。";
...
$pgv_lang["label_banned_servers"] = "通過IP拒絕訪問";
$pgv_lang["label_manual_search_engines"] = "通過IP手動標記搜索引擎";
$pgv_lang["label_new_server"] = "添加新網站";
$pgv_lang["label_server_info"] = "所有通過網站遠程鏈接的人和家庭：";
$pgv_lang["label_server_url"] = "網站網址/IP";
$pgv_lang["label_view_local"] = "查看關于人的當地信息";
$pgv_lang["label_view_remote"] = "查看關于人的遠程信息";
$pgv_lang["LANGUAGE_DEFAULT"] = "您尚未配置您的網站將支持的語言。<br /> PhpGedView將使用其默認操作。";
$pgv_lang["lasttab"] = "最後訪問個人標簽";
$pgv_lang["leave_blank"] = "如果要保留當前密碼，請將密碼留空。";
$pgv_lang["macfile_detected"] = "檢測到Macintosh文件。在清理時，您的文件將轉換爲DOS文件。";
...
$pgv_lang["no_logs"] = "禁用日志記錄";
$pgv_lang["no_messaging"] = "沒有聯系方式";
...
$pgv_lang["user_path_length"] = "最大關系隱私路徑長度";
$pgv_lang["user_relationship_priv"] = "限制對相關人員的訪問";
$pgv_lang["usr_idle"] = "自上次登錄以來用戶帳戶被視爲非活動狀態的月數：";
...
$pgv_lang["verify_upload_instructions"] = "找到了一個同名的GEDCOM文件。如果你選擇繼續，舊的GEDCOM文件將替換爲你上傳的文件，導入過程將重新開始。如果你選擇取消，舊的GEDCOM將保留不變。";
...
$pgv_lang["admin_OK_message"] = "PhpGedView網站#SERVER_NAME#的管理員已經批淮了您的帳戶申請。\ r\ n\ r\ n您現在可以通過訪問以下鏈接登錄：#SERVER_NAME#";
$pgv_lang["batch_update"] = 	"在GEDCOM上執行批量更新/編輯";
//Text for the Gedcom Checker
$pgv_lang["gedcheck_text"] = "該模塊根據<a href=\"http://phpgedview.sourceforge.net/ged551-5.pdf\"> 5.5.1 GEDCOM規範</a>檢查GEDCOM文件的格式。它還檢查您的數據中存在許多常見錯誤。請注意，規範中有許多版本，擴展和變體，因此除了標記爲嚴重的問題之外，您不應該關注任何問題。所有行的解釋 - 在規範中可以找到線上錯誤，因此請在尋求幫助前查看。";
$pgv_lang["gedcheck_sync"] = "對數據庫所做的編輯不會同步到文件#GLOBALS[ged]#。文件內容可能已過時。您現在可以通過執行<b> <a\"#GLOBALS將其與數據庫同步[ged_link]#\">出口</A> </b>。";
$pgv_lang["gedcheck_nothing"] = "在這個級別沒有發現任何錯誤。";
$pgv_lang["critical"] = "危急";
$pgv_lang["open_link"] = "打開鏈接"; //在哪裏打開鏈接
$pgv_lang["same_win"] = "相同標簽/窗口";
$pgv_lang["new_win"] = "新標簽/窗口";
...
$pgv_lang["tag"] = "標簽";
$pgv_lang["spacing"] = "間距";
$pgv_lang["ADVANCED_NAME_FACTS"] = "高級名稱事實";
$pgv_lang["ADVANCED_PLAC_FACTS"] = "高級地名事實";
$pgv_lang["tradition_spanish"] = "西班牙";
$pgv_lang["tradition_portuguese"] = "葡萄牙語";
$pgv_lang["tradition_icelandic"] = "冰島的";
$pgv_lang["tradition_paternal"] = "父本";
$pgv_lang["tradition_polish"] = "抛光";
