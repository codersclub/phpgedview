...
$pgv_lang["birth_M"]				= "#name#s Geburtstag";		// For male persons
$pgv_lang["birth_F"]				= "#name#s Geburtstag";		// For female persons
$pgv_lang["born_in_M"]				= "Am #date# in #place# geboren";		// For male persons
$pgv_lang["born_in_F"]				= "Am #date# in #place# geboren";		// For female persons
$pgv_lang["born_on_M"]				= "Am #date# geboren";		// For male persons
$pgv_lang["born_on_F"]				= "Am #date# geboren";		// For female persons
$pgv_lang["death_M"]				= "Jahrestag des Todes von #name#";		// For male persons
$pgv_lang["death_F"]				= "Jahrestag des Todes von #name#";		// For female persons
$pgv_lang["died_in_M"]				= "Am #date# in #place# verstorben";		// For male persons
$pgv_lang["died_in_F"]				= "Am #date# in #place# verstorben";		// For female persons
$pgv_lang["died_on_M"]				= "Am #date# verstorben";		// For male persons
$pgv_lang["died_on_F"]				= "Am #date# verstorben";		// For female persons
$pgv_lang["anniversary_of"]			= "Hochzeitstag von #husband# und #wife#";
$pgv_lang["married_in"]				= "Am #date# in #place# verheiratet";
$pgv_lang["married_on"]				= "Am #date# in #place# verheiratet";
...
$pgv_lang["charts_block"]				= "Diagramme";
$pgv_lang["charts_block_descr"]			= "Der »Diagramme« Block ermöglicht Ihnen, Diagramme auf den haupt und persönlichen Begrüßungsseiten zu zeigen.  Sie können in dessen Konfiguration bestimmen, ob der Block das Ahnen-, Nachfahren-, oder Sanduhr-Diagramm zeigen soll.  Sie können auch die ID-Nummer der Startperson bestimmen.";
...
$pgv_lang["medialist_unlinked"]			= "Nur unverknüpfte Medien zeigen";
$pgv_lang["medialist_current_dir"]		= "Aktuelles Unterverzeichnis";
...
$pgv_lang["shared_note_menu"]			= "Optionen für gemeinsame Bemerke";
...
$pgv_lang["search_notes"]				= "Gemeinsame Bemerke";
...
$pgv_lang["search_prtnames"]			= "Personennamen zu drucken:";
...
$pgv_lang["remove_custom_tags"]			= "Benutzerdefinierte PGV Tags entfernen";
...
$pgv_lang["top10_pageviews_descr"]		= "Der »Meist aufgerufene Einträge« Block zeigt Datensätze an, die am häufigsten aufgerufen wurden. Sie müssen dazu in der GEDCOM Konfiguration die Zähler zunächst aktivieren.";
...
$pgv_lang["shared_note_list"]			= "Gemeinsame Bemerke";
...
$pgv_lang["NN"]				= "(Nachname unbekannt)";			// Family name
$pgv_lang["PN"]				= "(Vorname unbekannt)";			// Given name
...
$pgv_lang["NNother"]		= "(Nachname unbekannt)";
$pgv_lang["PNother"]		= "(Vorname unbekannt)";
...
$pgv_lang["no_tab2"]					= "Zu dieser Person gibt es keine Bemerke.";
...
$pgv_lang["first_page"]				= "Erste Seite";
$pgv_lang["previous_page"]			= "Vorige Seite";
$pgv_lang["next_page"]				= "Nächste Seite";
$pgv_lang["last_page"]				= "Letzte Seite";
...
$pgv_lang["search_russell"]				= "Einfach";
...
$pgv_lang["add_another"]				= "Andere Person zur Ansicht hinzufügen";
...
$pgv_lang["utf8_to_ansi"]				= "Von UTF-8 nach ANSI konvertieren";
...
$pgv_lang["year_yahrzeit"]				= "#yahrzeit_date#, #yahrzeit# Jahrzeit von #event_date#";
...
$pgv_lang["mail02_line02"]				= "Ein neuer Benutzer hat bei PhpGedView #PGV_SERVER_NAME##PGV_SCRIPT_PATH# einen Zugang angefordert.";
...
$pgv_lang["mail02_subject"]				= "Neue Anmeldung bei #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["more_events_privacy"]		= "Für die folgenden #pgv_lang[global_num1]# Tage stehen zwar mehr Ereignisse bevor, aber wegen Datenschutz werden diese nicht gezeigt.";
$pgv_lang["more_events_privacy1"]		= "Für morgen stehen zwar mehr Ereignisse bevor, aber wegen Datenschutz werden diese nicht gezeigt.";
...
$pgv_lang["more_today_privacy"]			= "Heute gibt es zwar mehr Ereignisse, aber wegen Datenschutz werden diese nicht gezeigt.";
$pgv_lang["chat"]						= "Chat";
...
$pgv_lang["block_top10_descr"]			= "Der »Häufigste Nachnamen« Block zeigt eine Liste mit den häufigsten Nachnamen der Datenbank. Die tatsächliche Länge der Liste ist konfigurierbar. Sie können auch bestimmte Namen in der Liste unterdrücken.";
...
$pgv_lang["block_cookiepolicy_body_extlink"]	= "<span class='warning'>Das Gesetz der EU verlangt diese Notiz.</span><br />Diese Website bemüht sich, Cookies nur dann zu verwenden, wenn es keine andere Möglichkeit gibt. Cookies dieser Webseite speichern niemals persönliche Informationen oder Benutzernamen und Kennwort. Weitere Details über die Cookie-Politik dieser Website können Sie über <a href='<link>' target='_blank' title='Cookie-Politik dieser Website'>dieses Link</a> erhalten.<br /><br />Aus technischen Gründen werden diese Cookies nicht nach dem Ende des Programms PhpGedView gelöscht. Sie werden aber sofort nach dem Ende des Browsers gelöscht.";
$pgv_lang["block_cookiepolicy_link"]	= "Link: Cookie-Politik Seite";
$pgv_lang["block_givn_top10_title"]		= "Häufigste Vornamen";
$pgv_lang["block_givn_top10"]			= "Häufigste Vornamen";
$pgv_lang["block_givn_top10_descr"]		= "Der »Häufigste Vornamen« Block zeigt eine Liste mit den häufigsten Vornamen der Datenbank. Die tatsächliche Länge der Liste ist konfigurierbar.";
...
$pgv_lang["gedcom_news_published"]		= "Veröffentlicht : ";
$pgv_lang["gedcom_news_archive"]		= "Archiv zeigen";
$pgv_lang["user_news_block"]			= "Benutzer Tagebuch";
$pgv_lang["user_news_descr"]			= "Der »Benutzer Tagebuch« Block ermöglicht dem Benutzer Notizen oder ein Tagebuch online zu verwalten.";
$pgv_lang["my_journal"]					= "Mein Tagebuch";
...
$pgv_lang["news_saved"]					= "Der Eintrag wurde gespeichert.";
...
//-- RSS Feed
$pgv_lang["rss_descr"]					= "Neuigkeiten und Links von der Seite #GLOBALS[GEDCOM_TITLE]#";
...
$pgv_lang["stat_17_arb"]				= "Geburtsjahr";
$pgv_lang["stat_18_ard"]				= "Todesalter";
$pgv_lang["stat_18_aard"]				= "Durchschnittliches Todesalter";
$pgv_lang["stat_19_arm"]				= "Alter bei der Ehe";
$pgv_lang["stat_19_aarm"]				= "Durchschnittsalter bei der Ehe";
$pgv_lang["stat_20_arm1"]				= "Alter bei der ersten Ehe";
