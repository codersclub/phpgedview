...
$pgv_lang["label_timedban_servers"]	= "Zugang bis zu bestimmten Zeiten sperren";
...
$pgv_lang["USE_PIWIK_ANALYTICS"]	= "Matomo Analytics aktivieren?";
$pgv_lang["PGV_PIWIK_URL"]			= "URL des Matomo Analytics servers";
$pgv_lang["PGV_PIWIK_SITE"]			= "Matomo Analytics Sitenummer";
...
$pgv_lang["mod_admin_hastab"]		= "Ordner?";
...
$pgv_lang["config_not_saved"]		= "* Ihre Einstellungen werden erst im Schritt 6 gespeichert";
...
$pgv_lang["checking_config.php"]	= "Überprüfung der Konfigurationsdatei <i>config.php</i>:";
$pgv_lang["config.php_missing"]		= "Die Konfigurationsdatei <i>config.php</i> ist nicht vorhanden.";
$pgv_lang["config.php_missing_instr"]	= "Ihre Einstellungen können nicht in der Konfigurationsdatei <i>config.php</i> gespeichert werden. Sie können nun die fehlende Datei <i>config.php</i> erstellen, indem Sie die Datei <i>config.dist</i> kopieren und umbenennen. Alternativ erhalten Sie im Anschluss Gelegenheit, Ihre Einstellungen herunterzuladen und diese in einer Datei <i>config.php</i> auf Ihren Server hochzuladen.";
$pgv_lang["config.php_not_writable"]	= "Die Datei <i>config.php</i> ist nicht überschreibbar.";
$pgv_lang["config.php_not_writable_instr"]	= "Ihre Einstellungen können in der Konfigurationsdatei <i>config.php</i> nicht gespeichert werden. Sie können die Schreibrechte auf Ihrem Server manuell einstellen. Alternativ erhalten Sie im Anschluss Gelegenheit, Ihre Einstellungen herunterzuladen und diese als Datei <i>config.php</i> auf Ihren Server hochzuladen.";
$pgv_lang["passed"]					= "Keine Fehler";
$pgv_lang["config.php_writable"]	= "Die Konfigurationsdatei <i>config.php</i> existiert und kann überschrieben werden.";
...
$pgv_lang["sanity_warn3"]			= "Werkzeuge zur Bearbeitung von Bildern (GD-Bibliothek) sind nicht vorhanden. PhpGedView funktioniert, aber einige Programmbestandteile, z.B. Miniaturbilderstellung und Kreisdiagramm, benötigen die GD-Bibliothek. Bitte besuchen Sie <a href='https://www.php.net/manual/de/ref.image.php' target='_blank'>https://www.php.net/manual/de/ref.image.php</a> für eine ausführlichere Auskunft.";
$pgv_lang["sanity_warn4"]			= "Werkzeuge zur Bearbeitung von XML Dateien (XML-Parser) sind nicht vorhanden. PhpGedView funktioniert, aber einige Programmbestandteile, z.B. Erstellung von Berichten und Verbindungen zu anderen PhpGedView-Webseiten, benötigen die XML-Parser Werkzeuge. Bitte besuchen Sie <a href='https://www.php.net/manual/de/ref.xml.php' target='_blank'>https://www.php.net/manual/de/ref.xml.php</a> für eine ausführlichere Auskunft.";
$pgv_lang["sanity_warn5"]			= "Werkzeuge zur Bearbeitung von XML Dateien (XML-Bibliothek DOM) sind nicht vorhanden. PhpGedView funktioniert, aber einige Programmbestandteile, z.B. GRAMPS-Funtionen wie Exportieren, Herunterladen und Verbindungen zu anderen PhpGedView-Webeiten, benötigen die XML-Bibliothek DOM. Bitte besuchen Sie <a href='https://www.php.net/manual/de/refs.xml.php' target='_blank'>https://www.php.net/manual/de/refs.xml.php</a> für eine ausführlichere Auskunft.";
$pgv_lang["sanity_warn6"]			= "Spezielle Kalenderfunktionen fehlen. PhpGedView funktioniert, aber einige Programmbestandteile, z.B. Bearbeitung von Hebräischen oder Französischen Daten, benötigen die Kalenderbibliothek. Für das  Funktionieren von PhpGedView ist sie allerdings nicht unbedingt notwendig. Bitte besuchen Sie <a href='https://www.php.net/manual/de/ref.calendar.php' target='_blank'>https://www.php.net/manual/de/ref.calendar.php</a> für eine ausführlichere Auskunft.";
...
$pgv_lang["gedcom_deleted"]			= "GEDCOM <b>#GED#</b> wurde gelöscht.";
...
$pgv_lang["progress_bars_info"]		= "Der Fortschrittsbalken unten zeigt den Fortschritt des Datenimports an. Wenn das angegebene Zeitlimit erreicht ist, wird der Import unterbrochen. Sie können dann auf einen Button <b>Fortsetzen</b> klicken. Falls Ihnen dieser Button nicht zugänglich ist, müssen Sie den Datenimport mit einer kleineren Zeitlimit neu starten.";
...
$pgv_lang["import_time_exceeded"]	= "Die maximale Ausführungszeit wurde erreicht. Drücke den <b>Fortsetzen</b> Button zur Wiederaufnahme der Einfuhr der GEDCOM-Datei.";
...
$pgv_lang["label_banned_servers"]	= "Zugang sperren";
$pgv_lang["label_families"]			= "Familien";
$pgv_lang["label_gedcom_id2"]		= "Datenbank ID:";
$pgv_lang["label_individuals"]		= "Personen";
$pgv_lang["label_manual_search_engines"]	= "Suchmaschinen manuell markieren";
...
$pgv_lang["PGV_SMTP_DEBUG"]						= "PHPMailer Fehler";
$pgv_lang["PGV_SMTP_DEBUG_OPTION0"]				= "Keine Fehlermeldungen";
$pgv_lang["PGV_SMTP_DEBUG_OPTION1"]				= "Client-Programmmeldungen";
$pgv_lang["PGV_SMTP_DEBUG_OPTION2"]				= "Client-Programm & Server-Meldungen";
$pgv_lang["PGV_SMTP_DEBUG_OPTION3"]				= "Client-Programm & Server-Meldungen plus Verbindungsstatus";
$pgv_lang["PGV_SMTP_DEBUG_OPTION4"]				= "Ausführliche Datenausgabe, die nur selten benötigt wird";
...
$pgv_lang["upload_gedcom"]			= "GEDCOM-Datei hoch laden";
...
$pgv_lang["user_default_tab"]		= "Vorausgewählter Ordner auf der »Persönliche Details« Seite";
...
$pgv_lang["verified_by_admin"]		= "Benutzer vom Verwalter freigegeben";
...
$pgv_lang["admin_OK_subject"]		= "Zugangserlaubnis bei #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["admin_OK_message"]		= "Der Verwalter von PhpGedView bei #PGV_SERVER_NAME##PGV_SCRIPT_PATH# hat Ihren Zugangsantrag erlaubt.\r\n\r\nSie können sich jetzt mit dem folgenden Link anmelden: #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
