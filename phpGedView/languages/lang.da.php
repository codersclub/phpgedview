...
$pgv_lang["note"]				= "Note";
$pgv_lang["NN"]					= "(Navn ukendt)";		// Family name
...
$pgv_lang["NNother"] 			= "(Navn ukendt)";
$pgv_lang["PNother"] 			= "(Fornavn ukendt)";
...
$pgv_lang["convertPath"]			= "Konverter mediesti til";
$pgv_lang["convertSlashes"]			= "Konverter mediemappeseparatorer til";
...
$pgv_lang["search_russell"]			= "Ordinær";
...
$pgv_lang["shared_note"]				= "Delte noter";
...
$pgv_lang["welcome_text_auth_mode_1"]	= "<span class='center'><b>Velkommen til disse slægtssider !</b><br />Siderne er kun tilgængelig for besøgende med en brugerkonto.<br /><br />Har du en brugerkonto, kan du logge dig ind herunder.<br /><br />Hvis du ikke har en brugerkonto endnu, kan du søge om at få en ved at klikke på linket <i>#pgv_lang[requestaccount]#</i> neden for.<br /><br />Efter at have godkendt din ansøgning, vil administratoren af hjemmesiden aktivere din konto.<br /><br />Du vil modtage en e-mail når du kan komme ind på siden med dit brugernavn og kodeord.</span>";
$pgv_lang["welcome_text_auth_mode_2"]	= "<span class='center'><b>Velkommen til disse slægtssider !</b><br />Siderne er kun tilgængelig for <i>registrerede</i> brugere med en konto.<br /><br />Har du en brugerkonto, kan du logge dig ind herunder.<br /><br />Hvis du ikke har en brugerkonto endnu, kan du søge om at få en ved at klikke på linket #pgv_lang[requestaccount]#.<br /><br />Efter at have godkendt din ansøgning, vil administratoren af hjemmesiden aktivere din konto.<br /><br />Du vil modtage en e-mail når du kan komme ind på siden med dit brugernavn og kodeord.</span>";
$pgv_lang["welcome_text_auth_mode_3"]	= "<span class='center'><b>Velkommen til disse slægtssider !</b><br />Siderne er kun tilgængelig for <i>familliemedlemmer</i>.<br /><br />Har du en brugerkonto, kan du logge dig ind herunder.<br /><br />Hvis du ikke har en brugerkonto endnu, kan du søge om at få en ved at klikke på linket #pgv_lang[requestaccount]#.<br /><br />Efter at have godkendt din ansøgning, vil administratoren af hjemmesiden aktivere din konto.<br /><br />Du vil modtage en e-mail når du kan komme ind på siden med dit brugernavn og kodeord.</span>";
$pgv_lang["welcome_text_cust_head"]		= "<span class='center'><b>Velkommen til disse slægtssider !</b><br />Siderne er <i>kun</i> tilgængelig for brugere som har gyldigt brugernavn og adgangskode.</span><br />";
...
$pgv_lang["message_invalid_from"]	= "Ugyldig afsenderadresse: &lt;#email#&gt;";
$pgv_lang["message_invalid_to"]		= "Ugyldig modtageradresse: &lt;#email#&gt;";
...
$pgv_lang["todo_descr"] = "«At Gøre» blok viser alle udestående _TODO fakta i databasen.";
...
$pgv_lang["block_cookiepolicy_descr"]	= "Denne blok viser cookiepolitikken på dette websted som krævet i EU-cookieloven.";
...
$pgv_lang["gedcom_news_descr"]	= "Nyhedsrammen viser besøgende sidste nyt eller artikler indlagt af en bruger med administratorrettigheder.<br /><br />Rammen er et fint sted til at bekendtgøre opdateringer af slægtsdatabasen, en sammenkomst, en fødsel og meget mere....";
