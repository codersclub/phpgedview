...
$pgv_lang["birth_M"]				= "#name#'s birthday";		// For male persons
$pgv_lang["birth_F"]				= "#name#'s birthday";		// For female persons
$pgv_lang["born_in_M"]				= "Born on #date# in #place#";		// For male persons
$pgv_lang["born_in_F"]				= "Born on #date# in #place#";		// For female persons
$pgv_lang["born_on_M"]				= "Born on #date#";		// For male persons
$pgv_lang["born_on_F"]				= "Born on #date#";		// For female persons
$pgv_lang["death_M"]				= "Anniversary of #name#'s death";		// For male persons
$pgv_lang["death_F"]				= "Anniversary of #name#'s death";		// For female persons
$pgv_lang["died_in_M"]				= "Died on #date# in #place#";		// For male persons
$pgv_lang["died_in_F"]				= "Died on #date# in #place#";		// For female persons
$pgv_lang["died_on_M"]				= "Died on #date#";		// For male persons
$pgv_lang["died_on_F"]				= "Died on #date#";		// For female persons
$pgv_lang["anniversary_of"]			= "Wedding anniversary of #husband# and #wife#";
$pgv_lang["married_in"]				= "Married on #date# in #place#";
$pgv_lang["married_on"]				= "Married on #date#";
...
$pgv_lang["current_dir"]			= "Current folder";
...
$pgv_lang["medialist_unlinked"]		= "Show only unlinked media";
$pgv_lang["medialist_current_dir"]	= "Current subfolder";
...
$pgv_lang["search_prtnames"]		= "Persons' names to print:";
...
$pgv_lang["label_search_engine_detected"]  = "Search Engine detected";
...
$pgv_lang["top10_pageviews_descr"]	= "The «Most Viewed Items» block will show the records that have been viewed the most.  This block requires that Hit Counters be enabled in the GEDCOM configuration settings.";
...
$pgv_lang["print_preview"]			= "Simplify page";
$pgv_lang["cancel_preview"] 		= "Normal view";
...
$pgv_lang["given_name"] 			= "Given Names";
$pgv_lang["surname"]				= "Surname";
$pgv_lang["sex"]					= "Gender";
$pgv_lang["personal_details"]		= "Personal Details";
...
$pgv_lang["convertPath"]			= "Convert media path";
$pgv_lang["convertSlashes"]			= "Convert media folder separators";
...
$pgv_lang["first_page"]				= "First page";
$pgv_lang["previous_page"]			= "Previous page";
$pgv_lang["next_page"]				= "Next page";
$pgv_lang["last_page"]				= "Last page";
...
$pgv_lang["add_another"]			= "Add another person to chart";
...
$pgv_lang["serverTime"]				= "Server time";
$pgv_lang["localTime"]				= "Local time";
...
$pgv_lang["media_dir_2"]			= "This media object is in the standard media folder";
$pgv_lang["media_dir_3"]			= "This media object is in the protected media folder";
$pgv_lang["thumb_dir_1"]			= "This thumbnail is located on an external server";
$pgv_lang["thumb_dir_2"]			= "This thumbnail is in the standard media folder";
$pgv_lang["thumb_dir_3"]			= "This thumbnail is in the protected media folder";
$pgv_lang["moveto_2"]				= "Move to protected folder";
$pgv_lang["moveto_3"]				= "Move to standard folder";
...
$pgv_lang["setperms_time_exceeded"]	= "The execution time limit was reached.  Try the command again on a smaller folder.";
$pgv_lang["move_time_exceeded"]		= "The execution time limit was reached.  Try the command again to move the rest of the files.";
$pgv_lang["media_firewall_rootdir_no_exist"]			= "The Media Firewall root folder you requested does not exist.  You must create it first.";
$pgv_lang["media_firewall_protected_dir_no_exist"]		= "The protected media folder could not be created in the Media Firewall root folder.  Please create this folder and make it world-writable.";
$pgv_lang["media_firewall_protected_dir_not_writable"]	= "The protected media folder in the Media Firewall root folder is not world writable. ";
$pgv_lang["media_firewall_invalid_dir"]	= "Error: The Media Firewall was launched from a folder other than the media folder.";
...
$pgv_lang["mail04_subject"] 		= "New password at #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["welcome_text_auth_mode_1"]	= "<span class='center'><b>Welcome to this Genealogy website</b></span><br />Access to this site is permitted to every visitor who has a user account.<br /><br />If you have a user account, you can login on this page.  If you don't have a user account, you can apply for one by clicking on the appropriate link below.<br /><br />After verifying your application, the site administrator will activate your account.  You will receive an email when your application has been approved.";
$pgv_lang["welcome_text_auth_mode_2"]	= "<span class='center'><b>Welcome to this Genealogy website</b></span><br />Access to this site is permitted to <u>authorized</u> users only.<br /><br />If you have a user account you can login on this page.  If you don't have a user account, you can apply for one by clicking on the appropriate link below.<br /><br />After verifying your information, the administrator will either approve or decline your account application.  You will receive an email message when your application has been approved.";
$pgv_lang["welcome_text_auth_mode_3"]	= "<span class='center'><b>Welcome to this Genealogy website</b></span><br />Access to this site is permitted to <u>family members only</u>.<br /><br />If you have a user account you can login on this page.  If you don't have a user account, you can apply for one by clicking on the appropriate link below.<br /><br />After verifying the information you provide, the administrator will either approve or decline your request for an account.  You will receive an email when your request is approved.";
$pgv_lang["welcome_text_cust_head"] 	= "<span class='center'><b>Welcome to this Genealogy website</b></span><br />Access is permitted to users who have an account and a password for this website.";
...
$pgv_lang["chat"]					= "Chat";
$pgv_lang["users_logged_in"]		= "Logged-in Users";
...
$pgv_lang["user_messages_block"]	= "My Messages";
$pgv_lang["user_messages_descr"]	= "The «My Messages» block shows a list of the messages that have been sent to the active user.";
$pgv_lang["user_favorites_block"]	= "My Favorites";
$pgv_lang["user_favorites_descr"]	= "The «My Favorites» block shows the user a list of his favorite people in the database so that he can easily link to them.";
$pgv_lang["welcome_block"]			= "Welcome";
$pgv_lang["welcome_descr"]			= "The «Welcome» block shows the user the current date and time, quick links to modify his account or go to his own Pedigree chart, and a link to customize his MyGedView Portal page.";
...
$pgv_lang["block_top10_title"]		= "Frequent Surnames";
$pgv_lang["block_top10"]			= "Frequent Surnames";
$pgv_lang["block_top10_descr"]		= "The «Frequent Surnames» block shows a table of the most frequently occurring surnames in the database.  The actual number of surnames shown in this block is configurable.  You can configure the GEDCOM to remove names from this list.";
$pgv_lang["block_cookiepolicy"]			= "Cookie Policy";
$pgv_lang["block_cookiepolicy_title"]	= "Cookie Policy";
$pgv_lang["block_cookiepolicy_descr"]	= "The «Cookie Policy» block shows the cookie policy of this site, as required by the EU Cookie Law.";
...
$pgv_lang["block_givn_top10_title"]		= "Frequent Given Names";
$pgv_lang["block_givn_top10"]			= "Frequent Given Names";
$pgv_lang["block_givn_top10_descr"]		= "The «Frequent Given Names» block shows a table of the most frequently occurring given names in the database.  The actual number of given names shown in this block is configurable.";

$pgv_lang["gedcom_news_block"]		= "GEDCOM News";
$pgv_lang["gedcom_news_descr"]		= "The «GEDCOM News» block shows the visitor news releases or articles published by an admin user.<br /><br />This is a good place to announce a significant database update, a family reunion, or the birth of a child.";
...
$pgv_lang["user_news_block"]		= "My Journal";
...
$pgv_lang["show_abbr_notes"] 		= "Show abbreviated notes?";
...
//-- RSS Feed
$pgv_lang["rss_descr"]				= "News and links from the #GLOBALS[GEDCOM_TITLE]# site";
