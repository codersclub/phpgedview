...
$pgv_lang["INDI_FACTS_ADD_help"]        = "~#pgv_lang[INDI_FACTS_ADD]#~<br /><br />Liste des codes GEDCOM pour les événements qu'il sera possible d'ajouter à une fiche individu.  Vous pouvez librement ajouter ou supprimer des codes à cette liste, à l'exception de ceux figurant dans la liste <i>#pgv_lang[INDI_FACTS_UNIQUE]#</i>.";
...
$pgv_lang["SHOW_QUICK_RESN_help"]       = "Option pour ajouter les champs de restrictions d'accès dans le formulaire <i>Mise à jour rapide</i>.";
$pgv_lang["USE_QUICK_UPDATE"]           = "Autoriser le mode <i>Mise à jour rapide</i>";
$pgv_lang["USE_QUICK_UPDATE_help"]      = "Option pour autoriser les utilisateurs connectés à soumettre des modifications à l'aide du formulaire de <i>Mise à jour rapide</i>.";
...
$pgv_lang["PREFER_LEVEL2_SOURCES_help"] = "~#pgv_lang[PREFER_LEVEL2_SOURCES]#~<br /><br />Lors de la saisie, les sources peuvent être enregistrées au niveau de l'enregistrement complet (INDI, FAM) ou au niveau de l'évènement (BIRT, MARR, DEAT). Cette option permet de choisir le mode par défaut.";
...
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"]= "~#pgv_lang[EXPAND_RELATIVES_EVENTS]#~<br /><br />Option pour ouvrir par défaut la liste <i>#pgv_lang[SHOW_RELATIVES_EVENTS]#</i>.";
$pgv_lang["EXPAND_SOURCES"]             = "Ouvrir automatiquement les sources";
$pgv_lang["EXPAND_SOURCES_help"]        = "~#pgv_lang[EXPAND_SOURCES]#~<br /><br />Option pour afficher par défaut le contenu des <i>Sources</i> sur la page individuelle.";
$pgv_lang["EXPAND_NOTES"]               = "Ouvrir automatiquement les notes";
$pgv_lang["EXPAND_NOTES_help"]          = "~#pgv_lang[EXPAND_NOTES]#~<br /><br />Option pour afficher par défaut le contenu des <i>Notes</i> sur la page individuelle.";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]        = "~#pgv_lang[EDIT_AUTOCLOSE]#~<br /><br />Option pour fermer automatiquement la fenêtre d'édition après une mise à jour réussie, sans avoir besoin de cliquer sur le bouton «Fermer».";
...
$pgv_lang["POSTAL_CODE_help"]           = "~#pgv_lang[POSTAL_CODE]#~<br /><br />Option pour afficher le code postal devant ou derrière le nom de la ville, selon le pays.";
...
$pgv_lang["SERVER_URL_help"]            = "Si vous utilisez le protocole https ou un port autre que celui par défaut, entrez ici le chemin d'accès au serveur.";
...
$pgv_lang["PGV_SMTP_ACTIVE_help"]       = "~#pgv_lang[PGV_SMTP_ACTIVE]#~<br /><br />Utilisez le protocole SMTP pour envoyer des mail depuis PhpGedView.<br /><br />Cette option nécessite un une connexion à un serveur de mail SMTP.  Si désactivée, PhpGedView utilise le système de mail intégré sur ce serveur.";
$pgv_lang["PGV_SMTP_HOST_help"]         = "~#pgv_lang[PGV_SMTP_HOST]#~<br /><br />Nom du serveur de mail SMTP.  Exemple: <b>smtp.foo.bar.com</b>.";
$pgv_lang["PGV_SMTP_HELO_help"]         = "~#pgv_lang[PGV_SMTP_HELO]#~<br /><br />Nom de domaine d'une adresse e-mail valide pour ce serveur SMTP.<br /><br />Par exemple, si vous avez un compte e-mail tel que <b>votre.nom@abc.xyz.com</b>, entrez <b>abc.xyz.com</b>.";
$pgv_lang["PGV_SMTP_PORT_help"]         = "~#pgv_lang[PGV_SMTP_PORT]#~<br /><br />Port à utiliser sur le serveur SMTP. Il s'agit généralement du port <b>25</b>.";
$pgv_lang["PGV_SMTP_AUTH_help"]         = "~#pgv_lang[PGV_SMTP_AUTH]#~<br /><br />Certains serveurs SMTP demandent une authentification afin d'envoyer un mail. Entrez le login et le mot de passe ci-dessous.";
$pgv_lang["PGV_SMTP_AUTH_USER_help"]    = "~#pgv_lang[PGV_SMTP_AUTH_USER]#~<br /><br />Login requis pour s'authentifier sur le serveur SMTP (si nécessaire).";
$pgv_lang["PGV_SMTP_AUTH_PASS_help"]    = "~#pgv_lang[PGV_SMTP_AUTH_PASS]#~<br /><br />Mot de passe requis pour s'authentifier sur le serveur SMTP (si nécessaire).";
$pgv_lang["PGV_SMTP_SSL_help"]          = "~#pgv_lang[PGV_SMTP_SSL]#~<br /><br />Transport Layer Security (TLS) et Secure Sockets Layer (SSL) sont des protocoles d'encryption des données sur Internet.<br /><br />TLS 1.0, 1.1 et 1.2 sont des développements standardisés de SSL 3.0. TLS 1.0 et SSL 3.1 sont équivalents. Des travaux plus approfondis sur SSL sont effectués sous le nouveau nom TLS.<br /><br />Si votre serveur SMTP requiert les protocoles TLS ou SLL durant la connexion, sélectionnez l'option <b>#pgv_lang[yes]#</b>.";
...
$pgv_lang["META_SURNAME_KEYWORDS_help"] = "Option pour ajouter les principaux noms de familles dans la balise HTML des mots-clés (META Keywords) pour une meilleure indexation par les moteurs de recherche.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]     = "#pgv_lang[SHOW_LIVING_NAMES]#";
...
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]= "#pgv_lang[USE_RELATIONSHIP_PRIVACY]#<br /><br />Option désactivée : les utilisateurs authentifiés peuvent voir les détails de toutes les personnes vivantes.<br />Option activée : accès aux détails privés des proches uniquement.";
