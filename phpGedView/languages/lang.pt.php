...
$pgv_lang["charts_block"]			= "Bloco de gráficos";
$pgv_lang["charts_block_descr"]		= "O bloco de gráficos permite que você coloque um gráfico sobre o página Bem-vindo ou o Meu Portal.  Você pode configurar o bloco para mostrar um ver ancestrais, descendentes ou ampulheta.  Você também pode escolher a pessoa de raiz para o gráfico.";
...
$pgv_lang["roman_surn"]="Sobrenome Românico";
$pgv_lang["roman_givn"]="Nomes Românicos";
...
$pgv_lang["label_search_engine_detected"]="Detetado Robô de Site de Pesquisa";
...
$pgv_lang["num_to_show"]="Quantidade de itens exibidos";
$pgv_lang["days_to_show"]="Quantidade de dias exibidos";
...
$pgv_lang["PNother"] 			= "(Prenome desconhecido)";
...
$pgv_lang["convertPath"]			= "Converter caminho da mídia para";
$pgv_lang["convertSlashes"]			= "Converter separadores de pasta de mídia para";
...
$pgv_lang["requestaccount"]="Solicitação de cadastramento de novo Membro";
...
$pgv_lang["mail02_line02"]="Existe um registro de novo Membro em ( #SERVER_NAME# ).";
...
$pgv_lang["pls_note06"]="Você receberá um e-mail de confirmação no endereço ( #user_email# ). Siga as instruções do e-mail de confirmação para validar seu pedido de uma conta. Você terá até 7 dias para validar seu pedido, após este prazo seu pedido será eliminado. Sua validação será enviada para ser aprovada pelo Administrador do site. Após aprovada a conta, você precisará saber seu nome de Membro e senha para acessar o site.";
$pgv_lang["pls_note06a"]="Um email será enviado para o endereço #user_email#, com as instruções para desbloquear sua conta. A conta será removida se não for desbloqueada em 7 dias.<br /><br />Após o desbloqueio, informe seu Nome de Membro/Senha e entre no site.<br /><br />";
...
$pgv_lang["pls_note11"]="Para refazer sua senha perdida, forneça os nome de Membro e endereço de e-mail de sua conta. <br /><br />Nós enviaremos via e-mail uma URL especial, a qual contém uma confirmação para sua conta. Visitando a URL fornecida, nós permitiremos a mudança de sua senha e nome de Membro para este site. Por medida de segurança, você não deve fornecer informações desse e-mail para ninguém, incluindo os administradores desse site.<br /><br />Se você precisar de ajuda, por favor, entre em contato com o administrator do site.";
...
$pgv_lang["welcome_text_auth_mode_1"]="<span class='center'><b>BEM-VINDO A ESTE SITE GENEALÓGICO</b></span><br /><br />O acesso a este site é permitido a qualquer visitante, desde que tenha uma conta.<br />Se já tem uma conta, basta identificar-se, caso contrário clique no link apropriado nesta página e solicite a sua.<br />Sua solicitação será enviada ao Administrador do site que ativará sua conta e lhe enviará um email instruindo-o de como acessar o site.";
$pgv_lang["welcome_text_auth_mode_2"]="<span class='center'><b>BEM-VINDO A ESTE SITE GENEALÓGICO</b></span><br /><br />Para acessar este site é necessário ter uma conta.<br />Se já tem uma, basta identificar-se, caso contrério, clique no link apropriado nesta página e solicite a sua conta.<br />Sua solicitação será enviada ao Administrador do site e pode ser aceita ou não.<br />Um email será enviado informando-o da decisão do Administrador.";
$pgv_lang["welcome_text_auth_mode_3"]="<span class='center'><b>BEM-VINDO A ESTE SITE GENEALÓGICO</b></span><br /><br />O acesso a este site é permitido <b>somente a pessoas da família</b>.<br />Se já tem uma conta, basta identificar-se, caso contrário clique no link apropriado nesta página e solicite a sua.<br />Sua solicitação será enviada ao Administrador do site e pode ser aceita ou não.<br />Um email será enviado informando-o da decisão do Administrador.";
$pgv_lang["welcome_text_cust_head"]="<span class='center'><b>BEM-VINDO A ESTE SITE GENEALÓGICO</b></span><br /><br />O acesso é permitido a todos que tenham uma conta.<br />";
...
$pgv_lang["yahrzeit_block"]			= "Próximos aniversários Yahrzeit";
$pgv_lang["yahrzeit_descr"]			= "O bloco Próximos aniversário Yahrzeit mostra aniversários de datas morte que irá ocorrer no futuro próximo. Você pode configurar o período indicado, eo administrador pode configurar o quão longe no futuro, este bloco vai olhar.";
...
$pgv_lang["welcome_block"]="Bem-Vindo - Membro";
$pgv_lang["welcome_descr"]="O bloco 'Bem-Vindo - Membro' exibe o nome do Membro, data e hora corrente, bem como links que permitem acessar rapidamente a sua conta, seus dados, sua árvore genealógica e link para customizar a página <b>Meu Portal<b/>.";
...
$pgv_lang["gedcom_descr"]="O bloco 'Bem-Vindo - Site' funciona da mesma forma que o o bloco 'Bem-Vindo - Membro'. Exibe o titulo do arquivo de genealogia, bem como a data e hora corrente.";
...
$pgv_lang["portal_config_instructions"]="~#pgv_lang[customize_page]#~<br />~#pgv_lang[customize_gedcom_page]#~<br /><br />Adapte a página <b>Meu Portal</b> posicionando os blocos na página da maneira que quiser. A página é dividida em duas seções: A seção ‘Principal’ e a seção ‘Auxiliar’. Os blocos da seção 'Principal' são mostrados em destaque e abaixo do título da página. A seção 'Auxiliar' ocupa o lado direito da página. Cada seção tem sua própria lista de blocos que serão mostrados na página na ordem que forem relacionados. Você pode adicionar, remover e reordenar de acordo com sua preferência.";
...
$pgv_lang["gedcom_news_descr"]="O bloco 'Notícias' mostrará aos visitantes notícias ou artigos publicados pelo Membro Administrador.  'Notícias' é um bom local para anunciar alterações no banco de dados ou uma reunião familiar.";
...
$pgv_lang["gedcom_news_limit_count"]="Quantidade de Itens";
$pgv_lang["gedcom_news_flag"]="Limite";
$pgv_lang["gedcom_news_archive"]="Exibir arquivo";
$pgv_lang["user_news_block"]="Minhas Notícias";
$pgv_lang["user_news_descr"]="O bloco 'Meu Jornal' permite ao Membro a manutenção de notícias ou um Jornal on-line.";
...
// 5th generation
$pgv_lang["sosa_32"]="Tataravô";
$pgv_lang["sosa_33"]="Tataravó";
$pgv_lang["sosa_34"]="Tataravô";
$pgv_lang["sosa_35"]="Tataravó";
$pgv_lang["sosa_36"]="Tataravô";
$pgv_lang["sosa_37"]="Tataravó";
$pgv_lang["sosa_38"]="Tataravô";
$pgv_lang["sosa_39"]="Tataravó";
$pgv_lang["sosa_40"]="Tataravô";
$pgv_lang["sosa_41"]="Tataravó";
$pgv_lang["sosa_42"]="Tataravô";
$pgv_lang["sosa_43"]="Tataravó";
$pgv_lang["sosa_44"]="Tataravô";
$pgv_lang["sosa_45"]="Tataravó";
$pgv_lang["sosa_46"]="Tataravô";
$pgv_lang["sosa_47"]="Tataravó";
$pgv_lang["sosa_48"]="Tataravô";
$pgv_lang["sosa_49"]="Tataravó";
$pgv_lang["sosa_50"]="Tataravô";
$pgv_lang["sosa_51"]="Tataravó";
$pgv_lang["sosa_52"]="Tataravô";
$pgv_lang["sosa_53"]="Tataravó";
$pgv_lang["sosa_54"]="Tataravô";
$pgv_lang["sosa_55"]="Tataravó";
$pgv_lang["sosa_56"]="Tataravô";
$pgv_lang["sosa_57"]="Tataravó";
$pgv_lang["sosa_58"]="Tataravô";
$pgv_lang["sosa_59"]="Tataravó";
$pgv_lang["sosa_60"]="Tataravô";
$pgv_lang["sosa_61"]="Tataravó";
$pgv_lang["sosa_62"]="Tataravô";
$pgv_lang["sosa_63"]="Tataravó";
...
$pgv_lang["statnnames"]="Quantidade de nomes =";
$pgv_lang["statnfam"]="Quantidade de famílias =";
...
$pgv_lang["stat_18_aard"]		= "Idade média no século da morte";
$pgv_lang["stat_19_arm"]="Idade quando casou.";
$pgv_lang["stat_19_aarm"]		= "Idade média no século de casamento";
$pgv_lang["stat_20_arm1"]="Idade no 1ro casamento.";
$pgv_lang["stat_21_nok"]="Quantidade de filhos.";
$pgv_lang["stat_22_fwok"]		= "Quantidade de famílias sem filhos";
