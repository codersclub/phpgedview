...
$pgv_lang["charts_block"]   			= "Diagrammes";
...
$pgv_lang["duplicate_username"] 		= "Utilisateur «#username#� déjà existant.  Un utilisateur existe déjà sous ce nom.  Veuillez retourner à la page précédente et choisir un autre nom.";
$pgv_lang["usercreate_fail"]			= "Impossible d'ajouter l'utilisateur «#username#� au système.";
$pgv_lang["cache_life"] 				= "Vider le cache";
$pgv_lang["genealogy"]  				= "Généalogie";
$pgv_lang["activate"]   				= "Activer";
$pgv_lang["deactivate"] 				= "Désactiver";
$pgv_lang["play_stop"]					= "Démarrer / Arrêter";
$pgv_lang["random_media_start_slide"]   = "Démarrer le diaporama au chargement de la page ?";
$pgv_lang["random_media_ajax_controls"] = "Afficher les contrôles du diaporama ?";
$pgv_lang["description"]				= "Description";
$pgv_lang["current_dir"]				= "Répertoire actif : ";
$pgv_lang["SHOW_ID_NUMBERS"]			= "Afficher le code GEDCOM";
$pgv_lang["SHOW_HIGHLIGHT_IMAGES"]  	= "Afficher les miniatures";
...
$pgv_lang["enter_email"]				= "Vous devez entrer une adresse e-mail.";
...
$pgv_lang["search_indis"]   			= "Personnes";
...
$pgv_lang["search_prtnames"]			= "Noms des personnes à imprimer:";
...
$pgv_lang["add_individual_by_id"]   	= "Ajout de personnes par leur code";
$pgv_lang["advanced_options"]   		= "Options avancées";
$pgv_lang["zip_files"]  				= "Compresser (zip) les fichiers";
$pgv_lang["include_media"]  			= "Inclure les objets MultiMédia (compressés Zip)";
$pgv_lang["roman_surn"] 				= "Nom de famille romanisé";
$pgv_lang["roman_givn"] 				= "Prénoms romanisés";
...
$pgv_lang["add_fav_enter_id"]   		= "Entrer un code de Personne, Famille ou Source";
$pgv_lang["remove_child"]   			= "Retirer cet enfant de la famille";
$pgv_lang["link_new_husb"]  			= "Relier à une personne existante comme époux";
...
$pgv_lang["htmlplus_block_name"]		= "HTML avancé";
$pgv_lang["htmlplus_block_descr"]   	= "C'est un bloc HTML que vous pouvez placer sur votre page afin d'ajouter tout type de message. Vous pouvez insérer des références à certaines informations issues de votre fichier GEDCOM dans un format texte HTML.";
...
$pgv_lang["indis_with_surname"] 		= "Personnes portant le nom #surname#";
...
$pgv_lang["first_letter_iname"] 		= "Choisissez une lettre pour montrer les personnes dont le nom de famille commence par cette lettre.";
$pgv_lang["first_letter_fname"] 		= "Choisissez une lettre pour montrer les personnes dont un prénom commence par cette lettre.";
...
$pgv_lang["review_changes_descr"]   	= "Le bloc «Modifications à valider» affiche la liste des changements que l'administrateur doit confirmer avant leur enregistrement définitif dans la base. Un rappel lui est envoyé chaque jour par e-mail.";
$pgv_lang["review_changes_block"]   	= "Modifications à valider";
$pgv_lang["review_changes_subject"] 	= "PhpGedView - Liste des modifications en attente";
$pgv_lang["review_changes_body"]		= "Il reste des modifications à valider sur le site PhpGedView. Merci d'utiliser le lien suivant pour vous connecter et confirmer ces changements.";
$pgv_lang["show_pending"]   			= "Voir les modifications à valider";
...
$pgv_lang["update_name"]				= "Modifier nom";
$pgv_lang["update_fact"]				= "Modifier événement";
...
$pgv_lang["update_address"] 			= "Modifier adresse";
$pgv_lang["top10_pageviews_descr"]  	= "Le bloc «Pages les plus visitées» affiche les pages les plus visitées pour ce fichier GEDCOM. Le compteur de visites doit être activé (voir les options de configuration).";
$pgv_lang["top10_pageviews"]			= "Pages les plus visitées";
$pgv_lang["top10_pageviews_block"]  	= "Pages les plus visitées";
...
$pgv_lang["indis_charts"]   			= "Options pour cette personne";
$pgv_lang["none"]   					= "Libre";
...
$pgv_lang["invalid_username"]   		= "L'identifiant d'utilisateur «#username#» contient des caractères interdits";
...
$pgv_lang["rootid"] 					= "Personne racine";
$pgv_lang["root_person"]				= "Code de la personne";
...
$pgv_lang["individual_list"]			= "Personnes";
$pgv_lang["family_list"]				= "Familles";
$pgv_lang["branch_list"]				= "Branches";
$pgv_lang["source_list"]				= "Sources";
$pgv_lang["shared_note_list"]   		= "Notes partagées";
$pgv_lang["place_list"] 				= "Lieux";
...
$pgv_lang["indi_info"]  				= "Informations sur la personne";
$pgv_lang["pedigree_chart"] 			= "Arbre d'ascendance";
$pgv_lang["individual"] 				= "Personne";
...
$pgv_lang["no_tab1"]					= "Aucun fait lié à cette personne.";
$pgv_lang["no_tab2"]					= "Aucune note liée à cette personne.";
$pgv_lang["no_tab3"]					= "Aucune source liée à cette personne.";
$pgv_lang["no_tab4"]					= "Aucun objet MultiMédia lié à cette personne.";
$pgv_lang["no_tab5"]					= "Aucun proche lié à cette personne.";
$pgv_lang["no_tab6"]					= "Aucune recherche liée à cette personne.";
...
$pgv_lang["linked_source"]  			= "Ajouter cette source et les personnes/familles qui y sont liés.";
$pgv_lang["person_private"] 			= "Respect de la vie privée : les détails personnels sur cette personne ne seront pas inclus.";
...
$pgv_lang["convertPath"]				= "Convertir le chemin d'accès des Médias";
$pgv_lang["convertSlashes"]				= "Convertir les séparateurs de répertoire";
...
$pgv_lang["individuals"]				= "Personnes";
...
$pgv_lang["first_page"]				= "Première page";
$pgv_lang["previous_page"]			= "Page précédente";
$pgv_lang["next_page"]				= "Page suivante";
$pgv_lang["last_page"]				= "Dernière page";
...
$pgv_lang["changes_present"]			= "Il reste des modifications à valider pour ce fichier GEDCOM. Elles seront automatiquement validées si vous rechargez le fichier maintenant.";
$pgv_lang["sec"]						= "sec.";

//-- INDIVIDUAL AND FAMILYLIST FILE MESSAGES
$pgv_lang["total_fams"] 				= " Familles";
$pgv_lang["total_indis"]				= " Personnes";
...
$pgv_lang["find_individual"]			= "Choisir une personne";
...
$pgv_lang["firstname_alpha_index"]  	= "Index alphabétique de prénom";
...
$pgv_lang["age"]						= "Age";
$pgv_lang["husb_age"]   				= "Age de l'époux";
$pgv_lang["wife_age"]   				= "Age de l'épouse";
$pgv_lang["year1"]  					= "an";
$pgv_lang["years2"] 					= "années";
$pgv_lang["years"]  					= "ans";
...
//-- Admin File Messages
$pgv_lang["email_invalid"]				= "Adresse e-mail invalide.";
...
$pgv_lang["utf8_to_ansi"]   			= "Convertir de UTF-8 à (ISO 8859-1) ?";
...
$pgv_lang["setperms"]   				= "Modifier les permissions de lecture/écriture";
$pgv_lang["setperms_fix"]   			= "Corriger les permissions de lecture/écriture";
$pgv_lang["setperms_success"]   		= "Les permissions de lecture/écriture ont été paramétrées";
$pgv_lang["setperms_failure"]   		= "Les permissions de lecture/écriture n'ont pas été paramétrées";
...
$pgv_lang["media_firewall_protected_dir_no_exist"]= "Le répertoire contenant les média protégés n'est pas créé dans le répertoire racine du pare-feu des média.  Créez ce répertoire et rendez-le modifiable par tout le monde.";
...
$pgv_lang["no_link_found"]  			= "Aucun (autre) lien trouvé entre les deux personnes.";
$pgv_lang["no_other_link_found"]		= "Aucun autre lien entre les deux personnes pourraient être trouvées.";
...
$pgv_lang["delete_person"]  			= "Supprimer la fiche de cette personne";
...
$pgv_lang["siteadmin"]  				= "Administrateur PhpGedView";
$pgv_lang["PGV_program"]				= "Programme PhpGedView";
...
$pgv_lang["emailadress"]				= "Adresse e-mail";
$pgv_lang["mandatory"]  				= "Les champs marqués * sont obligatoires.";
$pgv_lang["mail01_line01"]  			= "Bonjour #user_fullname# ...";
$pgv_lang["mail01_line02"]  			= "Une demande a été adressée à #PGV_SERVER_NAME##PGV_SCRIPT_PATH#  pour une connexion avec votre adresse e-mail «#user_email#».";
$pgv_lang["mail01_line03"]  			= "Les informations suivantes ont été utilisées.";
$pgv_lang["mail01_line04"]  			= "Merci de cliquer sur le lien ci-dessous et de renseigner les champs demandés pour vérifier votre compte et l'adresse e-mail.";
...
$pgv_lang["mail01_subject"] 			= "Votre inscription sur #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["mail02_line01"]  			= "Bonjour à l'administrateur ...";
$pgv_lang["mail02_line02"]  			= "Un nouvel utilisateur s'est inscrit sur #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail02_line04a"] 			= "Vous serez averti par e-mail lorsque l'utilisateur aura fait la vérification de son compte. Il pourra se connecter sans action de votre part.";
$pgv_lang["mail02_subject"] 			= "Nouvelle inscription sur #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["hashcode"]   				= "Code de vérification";
$pgv_lang["thankyou"]   				= "Bonjour #user_fullname# ...<br />Merci pour votre inscription";
$pgv_lang["pls_note06"] 				= "Vous allez recevoir un message de confirmation à l'adresse <b>#user_email#</b>.<br /><br />En suivant les instructions de ce message vous pourrez activer votre compte.<br /><br />Si vous n'activez pas votre compte avant sept jours, il sera supprimé (vous pourrez vous enregistrer à nouveau dans ce cas).<br /><br />Pour vous connecter au site, votre nom de connexion et votre mot de passe sont nécessaires.";
$pgv_lang["pls_note06a"]				= "Vous allez recevoir un message de confirmation à l'adresse <b>#user_email#</b>. En suivant les instructions de ce message vous pourrez activer votre compte. Si vous n'activez pas votre compte avant sept jours, il sera supprimé (vous pourrez vous enregistrer à nouveau dans ce cas). Après activation de votre compte, vous pourrez vous connecter au site.";
...
$pgv_lang["pls_note07"] 				= "~#pgv_lang[user_verify]#~<br /><br />Merci d'entrer votre identifiant, votre mot de passe et le code de vérification que vous avez reçu par e-mail afin de vérifier votre demande de compte.";
...
$pgv_lang["mail03_subject"] 			= "Nouvelle vérification sur #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["pls_note09"] 				= "Vous avez été identifié comme un utilisateur inscrit.";
$pgv_lang["pls_note10"] 				= "L'administrateur a été informé. Vous pourrez vous connecter avec votre identifiant de connexion et votre mot de passe dès qu'il vous en aura donné l'autorisation.";
$pgv_lang["pls_note10a"]				= "Vous pouvez maintenant vous connecter avec votre nom de compte et votre mot de passe.";
$pgv_lang["data_incorrect"] 			= "Informations incorrectes. Merci de réessayer!";
$pgv_lang["user_not_found"] 			= "Impossible de vérifier les informations que vous avez saisies. Veuillez réessayer ou contacter l'administrateur du site pour plus d'informations.";

$pgv_lang["lost_pw_reset"]  			= "Demande de mot de passe perdu";
$pgv_lang["pls_note11"] 				= "Pour restaurer votre mot de passe, fournissez votre nom d'utilisateur PhpGedView sur ce site et l'adresse e-mail associée à ce compte.<br /><br />Vous recevrez par e-mail une URL spéciale qui contiendra un code de confirmation de votre compte. Vous pourrez alors vous connecter et ensuite changer votre mot de passe.<br /><br />Par mesure de sécurité, vous ne devez fournir votre code de confirmation à personne, même pas aux administrateurs de ce site (ils ne vous le demanderont pas).<br /><br />Si vous avez besoin d'aide de la part de l'administrateur du site, faites une demande d'assistance.";
...
$pgv_lang["mail04_subject"] 			= "Nouveau mot de passe à #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["welcome_text_cust_head"] 	= "<span class='center'><b>Bienvenue à ce site généalogique.</b></span><br />L'accès à ce site est autorisé aux utilisateurs ayant un compte et un mot de passe.";
...
$pgv_lang["cal_download"]   			= "Autoriser le téléchargement des événements du calendrier ?";
...
$pgv_lang["more_events_privacy"]		= "D'autres événements existent dans les #pgv_lang[global_num1]# prochains jours, mais leur accès est restreint.";
$pgv_lang["more_events_privacy1"]   	= "D'autres événements existent pour demain, mais leur accès est restreint.";
...
$pgv_lang["more_today_privacy"] 		= "D'autres événements existent pour aujourd'hui, mais leur accès est restreint.";
...
$pgv_lang["message_from"]   			= "Adresse e-mail";
$pgv_lang["message_from_name"]  		= "Expéditeur";
...
$pgv_lang["provide_email"]  			= "Merci d'indiquer votre adresse e-mail. Sans cette adresse, nous ne pourrons pas vous répondre. Votre adresse ne sera utilisée que pour faire cette réponse.";
...
$pgv_lang["message_invalid_from"]	= "L'adresse de l'expéditeur invalide: &laquo;#email#&raquo;";
$pgv_lang["message_invalid_to"]		= "L'adresse du destinataire invalide: &laquo;#email#&raquo;";
$pgv_lang["message_illegal_chars"]	= "Caractères illégaux dans l'adresse &laquo;#email#&raquo;";
$pgv_lang["message_bad_format"]		= "L'adresse &laquo;#email#&raquo; n'est pas formatée correctement";
$pgv_lang["message_no_MX"]			= "Le domaine de l'adresse &laquo;#email#&raquo; n'existe pas ou n'a pas d'enregistrement MX";
...
$pgv_lang["no_favorites"]   			= "Vous n'avez pas sélectionné de favoris. Pour ajouter une personne à vos favoris, lancez une recherche et cliquez sur <b>Ajouter</b> ou utilisez la case ci-dessous pour entrer un identifiant.";
...
$pgv_lang["invalid_email"]  			= "Merci de fournir une adresse e-mail valide.";
...
$pgv_lang["gedcom_created_using"]   	= "Fichier GEDCOM créé avec <b>#CREATED_SOFTWARE# #CREATED_VERSION#</b>.";
$pgv_lang["gedcom_created_on"]  		= "Fichier GEDCOM créé le <b>#CREATED_DATE#</b>.";
$pgv_lang["gedcom_created_on2"] 		= " le <b>#CREATED_DATE#</b>";
$pgv_lang["gedcom_stats"]   			= "Statistiques GEDCOM";
$pgv_lang["stat_individuals"]   		= "Personnes";
...
$pgv_lang["todo_nothing"]   			= "La liste des tâches à faire est vide";
$pgv_lang["yahrzeit_block"] 			= "Yahrzeiten";
$pgv_lang["yahrzeit_descr"] 			= "Le bloc «Yahrzeiten» affiche les anniversaires des décès qui vont arriver dans un futur proche. Vous pouvez configurer la période qui est affichée, et l'administrateur peut configurer la date jusqu'à laquelle ce bloc doit aller chercher ces anniversaires.";
$pgv_lang["logged_in_users_block"]  	= "Utilisateurs connectés";
...
$pgv_lang["gedcom_block"]   			= "Accueil GEDCOM";
$pgv_lang["gedcom_descr"]   			= "Le bloc «Accueil GEDCOM» est similaire au bloc «Bienvenue».";
$pgv_lang["gedcom_favorites_block"] 	= "Favoris GEDCOM";
$pgv_lang["gedcom_favorites_descr"] 	= "Le bloc «Favoris GEDCOM» affiche les liens mémorisés par l'administrateur.";
$pgv_lang["gedcom_stats_block"] 		= "Statistiques GEDCOM";
$pgv_lang["gedcom_stats_descr"] 		= "Le bloc «Statistiques GEDCOM» affiche quelques informations générales sur la base : date de création, nombre de personnes...";
...
$pgv_lang["block_top10_title"]  		= "Fréquents Noms";
$pgv_lang["block_top10"]				= "Fréquents noms";
$pgv_lang["block_top10_descr"]  		= "Le bloc «Fréquents Noms» affiche les noms les plus fréquents.";
$pgv_lang["block_cookiepolicy"]			= "Politique Cookies";
...
$pgv_lang["block_givn_top10_title"] 	= "Fréquents Prénoms";
$pgv_lang["block_givn_top10"]   		= "Fréquents Prénoms";
$pgv_lang["block_givn_top10_descr"] 	= "Le bloc «Fréquents Préoms» affiche les noms les plus fréquents. Le nombre de prénoms affiché dans ce bloc est configurable.";

$pgv_lang["gedcom_news_block"]  		= "Nouvelles GEDCOM";
...
$pgv_lang["user_news_block"]			= "Mon journal";
...
$pgv_lang["common_surnames"]			= "Fréquents noms de familles";
...
$pgv_lang["recent_changes_block"]   	= "Modifications récentes";
...
$pgv_lang["changes_pending_tot"]		= "Nombre total des modifications à valider : ";
...
$pgv_lang["on"] 						= "le";
$pgv_lang["in"] 						= "en";
$pgv_lang["individual_report"]  		= "Personne";
$pgv_lang["individual_with_rela_report"]= "Famille proche";
$pgv_lang["enter_pid"]  				= "Code de la personned";
...
//-- RSS Feed
$pgv_lang["rss_descr"]  				= "Nouvelles et liens du site #GLOBALS[GEDCOM_TITLE]#";
...
$pgv_lang["statnmale"]  				= "nombre de personnes masculins ";
$pgv_lang["statnfemale"]				= "nombre de personnes féminins ";
$pgv_lang["with_sources"]				= "Avec les sources";
$pgv_lang["without_sources"]			= "Sans les sources";
$pgv_lang["stat_sindi"] 				= "personnes avec sources";
...
$pgv_lang["stat_1_map"] 				= "répartition des personnes";
...
$pgv_lang["stat_9_indi"]				= "personnes avec sources";
...
$pgv_lang["stat_16_mmb"]				= "mois entre l'mariage et le premier enfant";
...
$pgv_lang["stat_302_cgp"]   			= "périodes";
...
$pgv_lang["aft_marr"]   				= "mois après l'mariage";
$pgv_lang["bef_marr"]   				= "mois avant et après l'mariage";
$pgv_lang["quarters"]   				= "trimestres après l'mariage";
$pgv_lang["half_year"]  				= "semestres après l'mariage";
...
$pgv_lang["stplmf"] 					= " par sexe";
$pgv_lang["stplipot"]   				= " par période";
...
$pgv_lang["stplmarrbirth"]  			= "Mois entre l'mariage et la naissance du premier enfant";
$pgv_lang["indi_distribution_chart"]	= "carte de répartition des personnes";
...
$pgv_lang["button_DEAT_H"]  			= "Affichage des couples dont seul l'époux est décédé à la date d'aujourd'hui.";
...
$pgv_lang["button_DEAT_W"]  			= "Affichage des couples dont seule l'épouse est décédée à la date d'aujourd'hui.";
...
$pgv_lang["button_TREE_L"]  			= "Affichage des couples ou personnes «feuilles», c'est-à-dire : vivants à la date d'aujourd'hui mais n'ayant pas d'enfant enregistré dans la base.";
$pgv_lang["button_TREE_R"]  			= "Affichage des couples ou personnes «racines», appelés également «patriarches» c'est-à-dire : dont ni le père ni la mère ne sont enregistrés dans la base.";
