...
abstract class FileAssertion implements Assertion {
	protected $id = null;
	protected $type = null;
	...
	public function equals($arg0) {
		if ($arg0 instanceof FileAssertion) {
	...
	public function compareTo($args0) {
		if ($this instanceof FileName){
			if ($args0 instanceof FileName){
				return strcmp($this->getType(),$args0->getType());
			} else{
				return -1;
			}
		} else if ($this instanceof FileEvent){
			if ($args0 instanceof FileEvent){
