...
class PHPMailer
{
	...
	/**
	 * Whether to show or hide wiki URL on connection errors.
	 *
	 * Options:
	 * * true  On connection errors, show the Wiki URL: https://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting
	 * * false Hide the Wiki URL
	 *
	 */
	public $showWikiURL = true;
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
			if ('smtp_connect_failed' === $key && $this->showWikiURL) {
