...
$AncStyle1RootBoxPosn = 60;		// -- Position of the leftmost Person Box (style 1)
$AncStyle1ColumnWidth = 15;		// -- Spacing between adjacent columns (style 1)
$AncStyle2aRootBoxPosn = 77;	// -- Position of the leftmost Person Box (style 2 - parents)
$AncStyle2aColumnWidth = 60;	// -- Spacing between adjacent columns (style 2 - parents)
$AncStyle2bRootBoxPosn = 79;	// -- Position of the leftmost Person Box (style 2 - children)
...
//    kinda kludgy -- JavaScript doesn't cut it here
$DesStyle1RootBoxPosn = 60;		// -- Position of the leftmost Person Box (style 1)
$DesStyle1ColumnWidth = 15;		// -- Spacing between adjacent columns (style 1)
$DesStyle2aRootBoxPosn = 112;	// -- Position of the leftmost Person Box (style 2 - parents)
$DesStyle2aColumnWidth = 95;	// -- Spacing between adjacent columns (style 2 - parents)
$DesStyle2bRootBoxPosn = 114;	// -- Position of the leftmost Person Box (style 2 - children)
...
//    kinda kludgy -- JavaScript doesn't cut it here
$FamARootBoxPosn = 37;			// -- Position of the leftmost Person Box (descendant side)
...
$HouALastBoxAdj  = 32;			// -- Correction to last box position (the actual Root person box)
