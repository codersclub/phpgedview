...
$AncStyle1RootBoxPosn = 39;		// -- Position of the leftmost Person Box (style 1)
$AncStyle1ColumnWidth = 17;		// -- Spacing between adjacent columns (style 1)
$AncStyle2aRootBoxPosn = 36;	// -- Position of the leftmost Person Box (style 2 - parents)
$AncStyle2aColumnWidth = 42;	// -- Spacing between adjacent columns (style 2 - parents)
$AncStyle2bRootBoxPosn = 36;	// -- Position of the leftmost Person Box (style 2 - children)
...
//    kinda kludgy -- JavaScript doesn't cut it here
$DesStyle1RootBoxPosn = 39;		// -- Position of the leftmost Person Box (style 1)
$DesStyle1ColumnWidth = 16;		// -- Spacing between adjacent columns (style 1)
$DesStyle2aRootBoxPosn = 71;	// -- Position of the leftmost Person Box (style 2 - parents)
$DesStyle2aColumnWidth = 77;	// -- Spacing between adjacent columns (style 2 - parents)
$DesStyle2bRootBoxPosn = 71;	// -- Position of the leftmost Person Box (style 2 - children)
...
//    kinda kludgy -- JavaScript doesn't cut it here
$FamARootBoxPosn = 14;			// -- Position of the leftmost Person Box (descendant side)
...
$HouALastBoxAdj  = 9;			// -- Correction to last box position (the actual Root person box)
