...
$pgv_lang["config_not_saved"] = "* Le impostazioni non saranno salvate fino al passo 6";
...
$pgv_lang["checking_config.php"]		= "Controllo file <i>config.php</i>:";
$pgv_lang["config.php_missing"]		= "Il file <i>config.php</i> non è stato trovato.";
$pgv_lang["config.php_missing_instr"]		= "Questa procedura guidata di installazione non sarà in grado di scrivere le tue impostazioni nel file <i>config.php</i>. Dovresti fare una copia del file <i>config.dist</i> e rinominarlo in <i>config.php</i>. In alternativa, dopo aver completato la procedura guidata potrai scaricare le tue impostazioni e caricare il file <i>config.php</i> risultante.";
$pgv_lang["config.php_not_writable"]		= "Il file <i>config.php</i> non è scrivibile.";
$pgv_lang["config.php_not_writable_instr"]		= "Questa procedura guidata di installazione non sarà in grado di scrivere le tue impostazioni nel file <i>config.php</i>. Dovresti impostare i permessi di scrittura sul file. In alternativa, dopo aver completato la procedura guidata potrai scaricare le tue impostazioni e caricare il file <i>config.php</i> risultante.";
$pgv_lang["passed"]		= "Passato";
$pgv_lang["config.php_writable"]		= "Il file <i>config.php</i> è presente e scrivibile.";
...
$pgv_lang["index_dir_cleanup_inst"]	= "Per cancellare un file o una sottocartella dall'Indice delle cartelle, trascinarli nel cestino o selezionare la casella di controllo. Fare clic sul pulsante Cancella per rimuovere definitivamente i file indicati.<br /><ul><li>I File contrassegnati con  <img src=\"./images/RESN_confidential.gif\" alt=\"\" /> richiedono appropriate operazioni e non possono essere rimossi.</li><li>I File contrassegnati con <img src=\"./images/RESN_locked.gif\" alt=\"\" /> hanno impostazioni importanti o modifiche pendenti e dovrebbero essere eliminati solo se sei sicuro di sapere cosa stai facendo.</li></ul>";
...
$pgv_lang["gedcom_deleted"] 		= "File GEDCOM <b>#GED#</b> cancellato con successo.";
...
$pgv_lang["add_gedcom"]   = "Aggiungi un file GEDCOM";
...
$pgv_lang["unsync_warning"] 					= "Questo file GEDCOM <i>non</i> è sincronizzato con il database. Potrebbe non contenere l'ultima versione dei dati. Per reimportare dal database, piuttosto che dal file, dovresti scaricare e ricaricare.";
...
$pgv_lang["import_time_exceeded"]				= "Il tempo massimo di esecuzione è stato raggiunto. Fai clic sul pulsante <b>Continua</b> qui sotto per riprendere l'importazione del file GEDCOM.";
...
$pgv_lang["PGV_SMTP_DEBUG"]						= "Errori di PHPMailer";
$pgv_lang["PGV_SMTP_DEBUG_OPTION0"]				= "Nessun messaggio di errore";
$pgv_lang["PGV_SMTP_DEBUG_OPTION1"]				= "Messaggi del programma clients";
$pgv_lang["PGV_SMTP_DEBUG_OPTION2"]				= "Messaggi del programma clients e del server";
$pgv_lang["PGV_SMTP_DEBUG_OPTION3"]				= "Messaggi del programma clients e del server più lo stato della connessione";
$pgv_lang["PGV_SMTP_DEBUG_OPTION4"]				= "Output di dati di basso livello dettagliato, raramente necessario";
...
$pgv_lang["upload_gedcom"]		= "Carica GEDCOM";
...
$pgv_lang["user_default_tab"]		= "Scheda predefinita da mostrare nella pagina «Dettagli personali»";
...
$pgv_lang["admin_OK_subject"]					= "Approvazione di un account su #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["admin_OK_message"]					= "L'amministratore del sito PhpGedView #PGV_SERVER_NAME##PGV_SCRIPT_PATH# ha approvato la tua richiesta di un account.\r\n\r\nÈ ora possibile accedere connettendosi al seguente link: #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
