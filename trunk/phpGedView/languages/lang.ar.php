 ...
 * Copyright (C) 2002 to 2015  Ezz (sfezz)
 *
...
$pgv_lang["mail01_line02"]		= "تم استلام طلب في #SERVER_NAME# لإنشاء حساب جديد لعنوان البريد الإلكتروني #user_email#.";
...
$pgv_lang["mail01_subject"] 		= "تسجيلك في #SERVER_NAME#";

$pgv_lang["mail02_line01"]		= "مرحباً بمدير النظام...";
$pgv_lang["mail02_line02"]		= "قام مستخدم جديد بتسجيل نفسه في موقع شجرة العائلة في #SERVER_NAME#.";
...
$pgv_lang["mail02_subject"] 		= "تسجيل جديد في #SERVER_NAME#";
...
$pgv_lang["mail03_subject"] 		        = "مستخدم جديد في #SERVER_NAME#";
...
$pgv_lang["mail04_subject"] 		        = "طلب بيانات في #SERVER_NAME#";
...
$pgv_lang["welcome_text_auth_mode_1"]	= "<center> <a class=\"title\" style=\"bold\"> مرحبا بكم في موقع أنساب العائلة </a> </ center> <br /><br />  للاطلاع على بيانات شجرة العائلة ينبغي أن يكون لديك حساب مستخدم. <br /> <br /> إذا كان لديك حساب مستخدم، يمكنك تسجيل الدخول هنا. إذا لم يكن لديك حساب مستخدم، يمكنك تقديم طلب خلال النقر على الرابط أدناه. <br /> <br />  ومن ثم سيقوم مدير النظام بتفعيل حسابك بعد التحقق من بياناتك. سوف تتلقى رسالة بريد إلكتروني عندما يتم الموافقة على طلبك.";

$pgv_lang["welcome_text_auth_mode_2"]	= "<center><b>مرحبا بكم في موقع أنساب العائلة </b></center><br />Access to this site is permitted to <u>authorized</u> users only.<br /><br />إذا كان لديك حساب مستخدم، يمكنك تسجيل الدخول هنا. إذا لم يكن لديك حساب مستخدم، يمكنك تقديم طلب خلال النقر على الرابط أدناه.<br /><br />ومن ثم سيقوم مدير النظام بتفعيل حسابك بعد التحقق من بياناتك. سوف تتلقى رسالة بريد إلكتروني عندما يتم الموافقة على طلبك.";

$pgv_lang["welcome_text_auth_mode_3"]	= "<center><b>مرحبا بكم في موقع أنساب العائلة </b></center><br />Access to this site is permitted to <u>family members only</u>.<br /><br />إذا كان لديك حساب مستخدم، يمكنك تسجيل الدخول هنا. إذا لم يكن لديك حساب مستخدم، يمكنك تقديم طلب خلال النقر على الرابط أدناه.<br /><br />ومن ثم سيقوم مدير النظام بتفعيل حسابك بعد التحقق من بياناتك. سوف تتلقى رسالة بريد إلكتروني عندما يتم الموافقة على طلبك.";

$pgv_lang["welcome_text_cust_head"] 	= "<center><b>مرحبا بكم في موقع أنساب العائلة </b></center><br />للاطلاع على بيانات شجرة العائلة ينبغي أن يكون لديك حساب مستخدم وكلمة سر <br />";
...
$pgv_lang["show"]			= "إظهار";
$pgv_lang["year"]			= "سنة:";
$pgv_lang["timeline_instructions"]	= "في معظم متصفحات الانترنت الحديثة يمكنك سحب وتحربك المربعات في الرسم البياني.";
...
$pgv_lang["portal_config_intructions"]	= "~#pgv_lang[customize_page]# <br /> #pgv_lang[customize_gedcom_page]#~<br /><br /> يمكنك تعديل الصفحة عن طريق تغيير أماكن تواجد الصناديق على الصفحة. تنقسم الصفحة الى  <b>رئيسية</b> و <b>يمنى</b>. <br /> <br /> ولكل قسم قائمتها الخاصة من الصناديق المتوفرة للعرض على الصفحة وتحريكها حسب رغبتك. . <br /> <br />";
