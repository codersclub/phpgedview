...
$pgv_lang["birth_M"]				= "Ziua de naștere a lui #name#";		// For male persons
$pgv_lang["birth_F"]				= "Ziua de naștere a lui #name#";		// For female persons
$pgv_lang["born_in_M"]				= "Născut la #date# la #place#";		// For male persons
$pgv_lang["born_in_F"]				= "Născută la #date# la #place#";		// For female persons
$pgv_lang["born_on_M"]				= "Născut la #date#";		// For male persons
$pgv_lang["born_on_F"]				= "Născută la #date#";		// For female persons
$pgv_lang["death_M"]				= "Aniversarea morții lui #name#";		// For male persons
$pgv_lang["death_F"]				= "Aniversarea morții lui #name#";		// For female persons
$pgv_lang["died_in_M"]				= "A murit la #date# la #place#";		// For male persons
$pgv_lang["died_in_F"]				= "A murit la #date# la #place#";		// For female persons
$pgv_lang["died_on_M"]				= "A murit la #date#";		// For male persons
$pgv_lang["died_on_F"]				= "A murit la #date#";		// For female persons
$pgv_lang["anniversary_of"]			= "Aniversarea de aniversare a lui #husband# și #wife#";
$pgv_lang["married_in"]				= "Căsătorit la #date# la #place#";
$pgv_lang["married_on"]				= "Căsătorit la #date#";
$pgv_lang["clustrmaps_locations"]	= "Locațiile vizitatorilor acestei pagini";
...
$pgv_lang["welcome_text_auth_mode_1"]	= "<span class='center'><b>Bine aţi venit pe acest site de genealogie</b></span><br />Accesul la acest site este permis oricărui vizitator care are un cont.<br /><br />Dacă aveţi un cont, puteţi să vă autentificaţi pe această pagină.  Dacă nu aveţi un cont, puteţi să cereţi unul dacă daţi click pe linkul potrivit de mai jos.<br /><br />După ce este verificată cererea dumneavoastră, administratorul siteului va activa contul dumneavoastră.  Veţi primi un email când cererea a fost aprobată.";
$pgv_lang["welcome_text_auth_mode_2"]	= "<span class='center'><b>Bine aţi venit pe acest site de genealogie</b></span><br />Accesul la acest site este permis doar utilizatorilor <u>autorizaţi</u>.<br /><br />Dacă aveţi un cont, puteţi să vă autentificaţi pe această pagină.  Dacă nu aveţi un cont, puteţi să cereţi unul dacă daţi click pe linkul potrivit de mai jos.<br /><br />După ce este verificată cererea dumneavoastră, administratorul siteului fie va aproba fie va respinge cererea dumneavoastră.  Veţi primi un email când cererea a fost aprobată.";
$pgv_lang["welcome_text_auth_mode_3"]	= "<span class='center'><b>Bine aţi venit pe acest site de genealogie</b></span><br />Accesul la acest site este permis doar <u>membrilor familiei</u>.<br /><br />Dacă aveţi un cont, puteţi să vă autentificaţi pe această pagină.  Dacă nu aveţi un cont, puteţi să cereţi unul dacă daţi click pe linkul potrivit de mai jos.<br /><br />După ce sunt verificate informaţiile furnizate, administratorul siteului fie va aproba fie va respinge cererea dumneavoastră.  Veţi primi un email când cererea a fost aprobată.";
$pgv_lang["welcome_text_cust_head"] 	= "<span class='center'><b>Bine aţi venit pe acest site de genealogie</b></span><br />Access is permitted to users who have an account and a password for this website.<br />";
...
$pgv_lang["message_invalid_from"]	= "Adresa nevalidă a expeditorului: &lt;#email#&gt;";
$pgv_lang["message_invalid_to"]		= "Adresă nevalidă a destinatarului: &lt;#email#&gt;";
