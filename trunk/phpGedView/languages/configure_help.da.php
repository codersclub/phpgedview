...
$pgv_lang["LANG_SELECTION_help"]		= "~#pgv_lang[LANG_SELECTION]#~<br /><br />Du kan ændre listen over sprog, der understøttes af din PhpGedView site ved at tilføje eller fjerne de tilhørende checkmærker.  Dette vil ændre de sprog, som brugerne kan vælge imellem.<br /><br />Du kan opnå det samme ved at klikke på linket: <b>#pgv_lang[enable_disable_lang]#</b> i #pgv_lang[admin]# menuen, hvor du også kan ændre fx. ikonet for sprogets flag, datoformatet, eller om efternavnet altid skal printes først.";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Medie-ID præfiks";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "~#pgv_lang[MEDIA_ID_PREFIX]#~<br /><br />Når en ny mediefil tilføjes online i PhpGedView, vil et nyt ID for mediefilen blive genereret automatisk. Mediefilens ID vil få dette præfiks.";
$pgv_lang["FAM_ID_PREFIX"]		= "Familie ID præfiks";
$pgv_lang["FAM_ID_PREFIX_help"]	= "~#pgv_lang[FAM_ID_PREFIX]#~<br /><br />Når en ny familie tilføjes online i PhpGedView, så vil et nyt ID for familien blive genereret automatisk. Familiens ID vil få dette præfiks.";
...
$pgv_lang["QUICK_ADD_FACTS_help"]		= "~#pgv_lang[QUICK_ADD_FACTS]#~<br /><br />Dette er en komma-separeret liste med GEDCOM-koder, der vil blive vist på formularen til hurtig opdatering.  Kun de fakta på denne liste vil blive vist på formularen eller gjort tilgængelige, så de kan vælges i det område, hvor du tilføjer nye fakta i formularen.";
$pgv_lang["AUTO_GENERATE_THUMBS"]			= "Automatisk genererede miniaturebilleder";
$pgv_lang["AUTO_GENERATE_THUMBS_help"]		= "~#pgv_lang[AUTO_GENERATE_THUMBS]#~<br /><br />Skal systemet automatisk generere miniaturebilleder for billeder, hvor der ikke findes nogle.  Din PHP installation understøtter muligvis ikke denne funktion.";
$pgv_lang["phpinfo_help"]				= "~#pgv_lang[phpinfo]#~<br /><br />Denne side giver uddybende information om den server hvor PhpGedView er installeret.  Mange konfigurationsmæssige detaljer om serverens software, der vedrører PHP og PhpGedView, kan ses.";
$pgv_lang["config_help_help"]			= "~#pgv_lang[config_help]#~<br /><br />Denne side samler alle hovedemnerne vedr. hjælp til konfigurationen på et sted.  Du kan se informationen på din skærm, eller du kan printe den til senere brug.";
...
$pgv_lang["THUMBNAIL_WIDTH_help"]		= "~#pgv_lang[THUMBNAIL_WIDTH]#~<br /><br />Dette er den bredde (i pixels), som programmet vil bruge nåsr den genererer miniaturebilleder automatisk.  Standard indstillingen er 100.";
...
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] = "~#pgv_lang[EXPAND_RELATIVES_EVENTS]#~<br /><br />Ved hjælp af denne valgmulighed kan man bestemme om listen over <i>Begivenheder for nære slægtninge</i> skal udvides automatisk eller ej.";
$pgv_lang["EXPAND_SOURCES"]      = "Udvid automatisk listen over kilder";
$pgv_lang["EXPAND_SOURCES_help"] = "~#pgv_lang[EXPAND_SOURCES]#~<br /><br />Ved hjælp af denne valgmulighed kan man bestemme om indholdet under fanebladet <i>Kilder</i> skal vises automatisk på siderne med fakta og detaljer for den enkelte person.";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]	= "~#pgv_lang[EDIT_AUTOCLOSE]#~<br /><br />Denne valgmulighed gør det muligt at bestemme om redigeringsvinduet skal lukkes automatisk efter at redigeringen er færdig.";
...
$pgv_lang["POSTAL_CODE_help"] = "~#pgv_lang[POSTAL_CODE]#~<br /><br />I forskellige lande skrives en adresse på en anden måde. Denne valgmulighed gør det muligt at placere postnummeret enten før eller efter bynavnet.";
...
$pgv_lang["SHOW_FACT_ICONS_help"]	= "~#pgv_lang[SHOW_FACT_ICONS]#~<br /><br />Vælg <b>#pgv_lang[yes]#</b> for at vise ikoner ved faktanavne på siden med #pgv_lang[personal_facts]#.  Fakta ikoner vil kun blive vist, hvis de findes i <i>images/facts</i> mappen for det aktuelle tema.";
...
$pgv_lang["lang_edit_help"]			= "~#pgv_lang[translator_tools]#~<br /><br />Denne side er beregnet for oversættere.  Du kan oversætte, sammenligne og eksportere sprogfiler.  Der er også en mulighed for at hjælpe oversættere med at bestemme kilden til tekst, der vises som output af PhpGedView.<br /><br />Du kan bruge følgende valgmuligheder og værktøjer:";
...
$pgv_lang["language_to_edit_help"]		= "~#pgv_lang[language_to_edit]#~<br /><br />I denne drop down liste kan du vælge det sprog, som du ønsker at redigere.";
...
$pgv_lang["config_lang_utility_help"]	= "~#pgv_lang[config_lang_utility]#~<br /><br />Her kan du aktivere/deaktivere sprog, der er understøttet i PhpGedView.";
...
$pgv_lang["restore_faq_edits_help"] = "~#pgv_lang[restore_faq_edits]#~<br />Denne mulighed genskaber FAQ-siden til det en administrator normalt ser, således at de enkelte punkter på FAQ-siden kan redigeres.";
...
$pgv_lang["edit_faq_item_help"] = "~#pgv_lang[edit_faq_item]#~<br />Vælges denne mulighed kan du redigere et punkt på FAQ-siden.";
$pgv_lang["delete_faq_item"] = "Slet en FAQ";
$pgv_lang["delete_faq_item_help"] = "~#pgv_lang[delete_faq_item]#~<br />Vælges denne mulighed kan du slette et punkt på FAQ-siden";
...
$pgv_lang["add_faq_header_help"] = "~FAQ-hoved~<br />Her skrives titlen eller emnet for et punkt på FAQ-siden.<br /><br />Titlen kan formatteres; HTML tags som &lt;b&gt; og &lt;br&gt; er tilladte, såvel som HTML koder som fx &amp;amp; og &amp;nbsp;.  Man kan ikke anvende HTML tags.";
$pgv_lang["add_faq_body_help"] = "~FAQ-indhold~<br />FAQ-teksten skrives her.<br /><br />Teksten kan formatteres; HTML tags som &lt;b&gt; og &lt;br&gt; er tilladte, såvel som HTML koder som fx &amp;amp; og &amp;nbsp;.  Man kan ikke anvende HTML tags.";
...
$pgv_lang["USE_MEDIA_VIEWER_help"]		= "~#pgv_lang[USE_MEDIA_VIEWER]#~<br /><br />Når denne indstilling <b>#pgv_lang[yes]#</b>, ved tryk på billede vil de producer en Media visning side. Denne side viser i detailjer omkring billedet. Hvis du har rigtigheder til det, kan du også rediger i dette.<br /><br /><b>#pgv_lang[no]#</b>, trykning på billede vil producer it fuld størrelse billede i et nyt vindue.";
$pgv_lang["USE_MEDIA_FIREWALL"]			= "Brug Media Firewall";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />See wiki for beskrivelse på hvordan man bruger Media Firewall <a href=\http://wiki.phpgedview.net/en/index.php?title=Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php?title=Media_Firewall</a>";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Media Firewall Rod Mappe";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Mappen hvori de beskyttet Media can blive oprettet. #pgv_lang[MEDIA_FIREWALL_ROOTDIR_note]#";
