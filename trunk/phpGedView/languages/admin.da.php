...
$pgv_lang["USE_GOOGLE_ANALYTICS"]	= "Aktivér Google Analytics?";
$pgv_lang["PGV_GOOGLE_ANALYTICS"]	= "Google Analytics Kontonummer";
$pgv_lang["piwik_analytics"]		= "Matomo Analytics";
$pgv_lang["USE_PIWIK_ANALYTICS"]	= "Aktivér Matomo Analytics?";
$pgv_lang["PGV_PIWIK_URL"]			= "URL til Matomo Analytics server";
$pgv_lang["PGV_PIWIK_SITE"]			= "Webstedsnummer i Matomo Analytics";
$pgv_lang["clustrmaps_analytics"]	= "ClustrMaps Analytics";
$pgv_lang["USE_CLUSTRMAPS_ANALYTICS"] = "Aktivér ClustrMaps Analytics?";
...
$pgv_lang["config_not_saved"] = "*Dine indstillinger vil ikke blive gemt før trin 6";
...
$pgv_lang["checking_config.php"]		= "Undersøger <i>config.php</i>:";
$pgv_lang["config.php_missing"]		= "filen <i>config.php</i> blev ikke fundet.";
$pgv_lang["config.php_missing_instr"]		= "Installationsguiden vil ikke være i stand til at skrive din indstillinger i <i>config.php</i> filen. Du kan lave en kopi af <i>config.dist</i> filen og omdøbe den til <i>config.php</i>. Alternativt vil du, når denne guide er færdig, have mulighed for at downloade dine indstillinger og derefter selv uploade den færdige <i>config.php</i> fil.";
$pgv_lang["config.php_not_writable"]		= "<i>config.php</i> er ikke skrivbar.";
$pgv_lang["config.php_not_writable_instr"]		= "Installationsguiden vil ikke være i stand til at skrive dine indstillinger i <i>config.php</i> filen. Du kan ændre skriverettigheder på filen. Du vil også efter at guiden er færdig have mulighed for at downloade dine indstillinger der efter selv uploade <i>config.php</i> filen.";
$pgv_lang["passed"]		= "Bestået";
$pgv_lang["config.php_writable"]		= "<i>config.php</i> er tilgængelig og skrivbar.";
...
$pgv_lang["index_dir_cleanup_inst"]	= "For at slette en fil eller undermappe fra Index mappen, skal du trække den til skraldespanden eller vælge dens afkrydsningsboks. Klik på Slet knappen for at fjerne de valgte filer permanent.<br /><ul><li>Filer der er markeret med <img src=\"./images/RESN_confidential.gif\" /> er påkrævet for korrekt afvikling og kan ikke fjernes.</li><li>Filer markeret med <img src=\"./images/RESN_locked.gif\" /> har vigtige indstillinger eller ventende data og bør kun slettes hvis du er sikker på at du ved hvad du gør.</li></ul>";
...
$pgv_lang["sanity_err1"]			= "Du skal have PHP version #PGV_REQUIRED_PHP_VERSION# eller nyere installeret.";
...
$pgv_lang["sanity_warn3"]			= "GD imaging library kan ikke findes. PhpGedView virker stadig, men nogle af funktionerne, såsom dannelse af miniaturer (thumbnails) og cirkeldiagrammet, kræver GD imaging library. Se venligst <a href='https://www.php.net/manual/da/ref.image.php' target='_blank'>https://www.php.net/manual/da/ref.image.php</a> for yderligere oplysninger.";
$pgv_lang["sanity_warn4"]			= "XML Parser library kan ikke findes. PhpGedView virker stadig, men nogle af funktionerne, såsom rapportgenerering og webservices, vil ikke virke uden XML Parser library. Se venligst <a href='https://www.php.net/manual/da/ref.xml.php' target='_blank'>https://www.php.net/manual/da/ref.xml.php</a> for yderligere oplysninger.";
$pgv_lang["sanity_warn5"]			= "DOM XML library kan ikke findes. PhpGedView virker stadig, men nogle af funktionerne, såsom Gramps Export funktionerne i udklipsholderen, download og web services vil ikke virke. Se venligst <a href='https://www.php.net/manual/da/refs.xml.php' target='_blank'>https://www.php.net/manual/da/refs.xml.php</a> for yderligere oplysninger.";
$pgv_lang["sanity_warn6"]			= "Calendar library kan ikke findes. PhpGedView virker stadig, men nogle af funktionerne, såsom konvertering til andre kalendere som f.eks hebræisk og fransk, vil ikke virke. Dette er ikke nødvendigt for at bruge PhpGedView. Se venligst <a href='https://www.php.net/manual/da/ref.calendar.php' target='_blank'>https://www.php.net/manual/da/ref.calendar.php</a> for yderligere oplysninger.";
...
$pgv_lang["gedcom_deleted"]		= "GEDCOM-filen <b>#GED#</b> er nu slettet.";
$pgv_lang["gedadmin"]				= "GEDCOM administrator";
$pgv_lang["full_name"]				= "Fulde navn";
$pgv_lang["error_header"] 		= "GEDCOM-filen <b>#GEDCOM#</b> findes ikke på det angivne sted.";
...
$pgv_lang["unsync_warning"] 					= "Denne GEDCOM fil er <i>ikke</i> synkroniseret med databasen. Den indeholder muligvis ikke den nyeste version af dine data. For at gen-importere fra databasen i stedet for filen, bør du downloade og uploade igen.";
...
$pgv_lang["download_note"]			= "NB: Store GEDCOM-filer kan tage lang tid at downloade. Hvis PHP giver besked om, at tiden er udløbet førend downloading er færdig, så kan det være, at du ikke har modtaget hele filen.<br /><br />For at sikre, at filen blev downloadet korrekt, skal du kontrollere, at den sidste linje i en fil i GEDCOM-format er <b>0&nbsp;TRLR</b>, eller at den sidste linje i en fil i XML-format er <b>&lt;/database&gt;</b>. Disse filer er tekst; du kan bruge en hvilken som helst egnet teksteditor, men sørg for at <u>ikke</u> gemme den downloadede fil, når du har inspiceret den.<br /><br />Som en tommelfingerregel kan det tage lige så lang tid at downloade GEDCOM-filen, som det tog at importere den afhængig af hastigheden på din internetforbindelse.";
...
$pgv_lang["error_header_write"]	= "GEDCOM-filen <b>#GEDCOM#</b> er ikke skrivbar. Kontroller eventuel skrivebeskyttelse og adgangsrettigheder.";
...
$pgv_lang["gedcom_downloadable"]	= "Denne GEDCOM-fil kan downloades over internettet!<br />Se afsnittet SIKKERHED i <a href=\"readme.txt\"><b>readme.txt</b></a> filen for at løse dette problem";
...
$pgv_lang["import_time_exceeded"]	= "Grænsen for eksekvering af importeringen blev nået. Klik på knappen <b>Fortsæt</b> herunder for at genoptage importen af GEDCOM-filen.";
...
$pgv_lang["PGV_SMTP_DEBUG"]						= "PHPMailer-fejl";
$pgv_lang["PGV_SMTP_DEBUG_OPTION0"]				= "Ingen fejlmeddelelser";
$pgv_lang["PGV_SMTP_DEBUG_OPTION1"]				= "Meddelelser fra klientprogrammet";
$pgv_lang["PGV_SMTP_DEBUG_OPTION2"]				= "Klientprogram og servermeddelelser";
$pgv_lang["PGV_SMTP_DEBUG_OPTION3"]				= "Klientprogram og servermeddelelser plus forbindelsesstatus";
$pgv_lang["PGV_SMTP_DEBUG_OPTION4"]				= "Omfattende dataoutput, sjældent nødvendigt";
...
$pgv_lang["TBLPREFIX"]							= "Præfikset for databasetabellens navne";
...
$pgv_lang["user_default_tab"]		= "Fanebladet der vises som standard på siden «Personlige detaljer»";
...
$pgv_lang["verified"]			= "Bruger har bekræftet ansøgningen";
$pgv_lang["verified_by_admin"]	= "Bruger er godkendt af administrator";
...
$pgv_lang["admin_OK_subject"]					= "Godkendelse af konto på #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["admin_OK_message"]					= "Administratoren af hjemmesiden #PGV_SERVER_NAME##PGV_SCRIPT_PATH# har godkendt din ansøgning om en konto.\r\n\r\nDu kan nu logge på ved at bruge følgende genvej: #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["batch_update"]="Udfør gruppe opdateringer/redigeringer på din GEDCOM";

// Text for the Gedcom Checker
$pgv_lang["gedcheck"]     = "Gedcom kontrol";
$pgv_lang["gedcheck_text"]= "Dette modul kontrollerer formatet af en GEDCOM fil i forhold til specifikationen af <a href=\"http://phpgedview.sourceforge.net/ged551-5.pdf\">5.5.1 GEDCOM standarden</a>. Den kontrollerer også almindeligt forekommende fejl i dine data.<br /><br />Bemærk at der er masser af versioner, udvidelser og varianter på standarden så du skal ikke være bekymre dig om andre fejl end dem der er markeret med \"Kritisk\". Forklaringen på de enkelte fejl kan findes i standarden, så kig venligst i den før du spørger om hjælp.";
