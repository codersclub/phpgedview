...
$pgv_lang["config_not_saved"] = "* Your settings will not be saved until step 6";
...
$pgv_lang["checking_config.php"]		= "Checking <i>config.php</i>:";
$pgv_lang["config.php_missing"]		= "<i>config.php</i> file was not found.";
$pgv_lang["config.php_missing_instr"]		= "This installation wizard will not be able to write your settings to the <i>config.php</i> file.  You may make a copy of the <i>config.dist</i> file and rename it to <i>config.php</i>.  Alternately, after completing this wizard you will have the option to download your settings and upload the resulting <i>config.php</i> file.";
$pgv_lang["config.php_not_writable"]		= "<i>config.php</i> is not writable.";
$pgv_lang["config.php_not_writable_instr"]		= "This installation wizard will not be able to write your settings to the <i>config.php</i> file.  You can set write permissions on the file, or after completing this wizard you will have the option to download your settings and upload the resulting <i>config.php</i> file.";
$pgv_lang["passed"]		= "Passed";
$pgv_lang["config.php_writable"]		= "<i>config.php</i> is present and writable.";
...
$pgv_lang["index_dir_cleanup_inst"]	= "To delete a file or subdirectory from the Index directory drag it to the wastebasket or select its checkbox.  Click the Delete button to permanently remove the indicated files.<br /><ul><li>Files marked with <img src=\"./images/RESN_confidential.gif\" alt=\"\" /> are required for proper operation and cannot be removed.</li><li>Files marked with <img src=\"./images/RESN_locked.gif\" alt=\"\" /> have important settings or pending change data and should only be deleted if you are sure you know what you are doing.</li></ul>";
...
$pgv_lang["sanity_warn3"]			= "The GD imaging library does not exist. PhpGedView will still function, but some of the features, such as thumbnail generation and the circle diagram, will not work without the GD library.  Please see <a href='https://www.php.net/manual/en/ref.image.php' target='_blank'>https://www.php.net/manual/en/ref.image.php</a> for more information.";
$pgv_lang["sanity_warn4"]			= "The XML Parser library does not exist. PhpGedView will still function, but some of the features, such as report generation and web services, will not work without the XML Parser library. Please see <a href='https://www.php.net/manual/en/ref.xml.php' target='_blank'>https://www.php.net/manual/en/ref.xml.php</a> for more information.";
$pgv_lang["sanity_warn5"]			= "The DOM XML library does not exist. PhpGedView will still function, but some of the features, such as Gramps Export features in the clippings cart, download, and web services, will not work. Please see <a href='https://www.php.net/manual/en/refs.xml.php' target='_blank'>https://www.php.net/manual/en/refs.xml.php</a> for more information.";
$pgv_lang["sanity_warn6"]			= "The Calendar library does not exist. PhpGedView will still function, but some of the features, such as conversion to other calendars such as Hebrew or French, will not work.  It is not essential for running PhpGedView. Please see <a href='https://www.php.net/manual/en/ref.calendar.php' target='_blank'>https://www.php.net/manual/en/ref.calendar.php</a> for more information.";
...
$pgv_lang["gedcom_deleted"] 		= "GEDCOM <b>#GED#</b> deleted.";
...
$pgv_lang["unsync_warning"] 					= "This GEDCOM file is <i>not</i> synchronized with the database.  It may not contain the latest version of your data.  To re-import from the database rather than the file, you should download and re-upload.";
...
$pgv_lang["import_time_exceeded"]				= "The execution time limit was reached.  Click the <b>Continue</b> button below to resume importing the GEDCOM file.";
...
$pgv_lang["PGV_SMTP_DEBUG"]						= "PHPMailer errors";
$pgv_lang["PGV_SMTP_DEBUG_OPTION0"]				= "No error messages";
$pgv_lang["PGV_SMTP_DEBUG_OPTION1"]				= "Client program messages";
$pgv_lang["PGV_SMTP_DEBUG_OPTION2"]				= "Client program & server messages";
$pgv_lang["PGV_SMTP_DEBUG_OPTION3"]				= "Client program & server messages plus connection status";
$pgv_lang["PGV_SMTP_DEBUG_OPTION4"]				= "Verbose low-level data output, rarely needed";
...
$pgv_lang["user_default_tab"]					= "Default Tab to show on «Personal Details» page";
