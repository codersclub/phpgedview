...
$pgv_lang["birth_M"]				= "Τα γενέθλια του #name#";		// For male persons
$pgv_lang["birth_F"]				= "Τα γενέθλια του #name#";		// For female persons
$pgv_lang["born_in_M"]				= "Γεννήθηκε την #date# στο #place#";		// For male persons
$pgv_lang["born_in_F"]				= "Γεννήθηκε στις #date# στο #place#";		// For female persons
$pgv_lang["born_on_M"]				= "Γεννήθηκε την #date#";		// For male persons
$pgv_lang["born_on_F"]				= "Γεννήθηκε στις #date#";		// For female persons
$pgv_lang["death_M"]				= "Επέτειος του θανάτου του #name#";		// For male persons
$pgv_lang["death_F"]				= "Επέτειος του θανάτου του #name#";		// For female persons
$pgv_lang["died_in_M"]				= "Πέθανε στις #date# στο #place#";		// For male persons
$pgv_lang["died_in_F"]				= "Πέθανε στις #date# στο #place#";		// For female persons
$pgv_lang["died_on_M"]				= "Πέθανε στις #date#";		// For male persons
$pgv_lang["died_on_F"]				= "Πέθανε στις #date#";		// For female persons
$pgv_lang["anniversary_of"]			= "Γιορτή του #husband# και της #wife#";
$pgv_lang["married_in"]				= "Παντρεμένος στις #date# στο #place#";
$pgv_lang["married_on"]				= "Παντρεμένος στις #date#";
$pgv_lang["clustrmaps_locations"]	= "Τοποθεσίες επισκεπτών σε αυτήν τη σελίδα";
...
$pgv_lang["first_page"]				= "Πρώτη σελίδα";
$pgv_lang["previous_page"]			= "Προηγούμενη σελίδα";
$pgv_lang["next_page"]				= "Επόμενη σελίδα";
$pgv_lang["last_page"]				= "Τελευταία σελίδα";
...
$pgv_lang["mail01_line02"]						= "Μία αίτηση λήφθηκε στο #PGV_SERVER_NAME##PGV_SCRIPT_PATH# για τη δημιουργία ενός λογαριασμού, με χρήση του email σας #user_email#.";
...
$pgv_lang["mail01_subject"]						= "Η καταχώρηση σας στο #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["mail02_line01"]						= "Γεια σου διαχειριστή ...";
$pgv_lang["mail02_line02"]						= "Ένας υποψήφιος χρήστης καταχώρησε τον εαυτό του με το PhpGedView στο #PGV_SERVER_NAME##PGV_SCRIPT_PATH#.";
...
$pgv_lang["mail02_subject"]						= "Νέα καταχώρηση στο #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail03_subject"]						= "Νέος χρήστης στο #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail04_subject"]						= "Αίτημα δεδομένων στο #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["welcome_text_auth_mode_1"]			= "<span class='center'><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></span><br />Η πρόσβαση σε αυτή την τοποθεσία επιτρέπεται σε κάθε επισκέπτη που διαθέτει ένα λογαριασμό χρήστη.<br /><br />Εάν έχετε ένα λογαριασμό χρήστη, μπορείτε να συνδεθείτε σε αυτή τη σελίδα. Εάν δεν έχετε λογαριασμό χρήστη, μπορείτε να υποβάλετε αίτημα για έναν, επιλέγοντας το κατάλληλο σύνδεσμο παρακάτω.<br /><br />Μετά την επιβεβαίωση του αιτήματος σας, ο διαχειριστής της τοποθεσίας θα ενεργοποιήσει τον λογαριασμό σας. Θα λάβετε ένα email μόλις το αίτημα σας εγκριθεί.";
$pgv_lang["welcome_text_auth_mode_2"]			= "<span class='center'><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></span><br />Η πρόσβαση σε αυτή την τοποθεσία επιτρέπεται μόνο σε <u>εγκεκριμένους</u> χρήστες.<br /><br />Εάν έχετε ένα λογαριασμό χρήστη, μπορείτε να συνδεθείτε σε αυτή τη σελίδα. Εάν δεν έχετε λογαριασμό χρήστη, μπορείτε να υποβάλετε αίτημα για έναν, επιλέγοντας το κατάλληλο σύνδεσμο παρακάτω.<br /><br />Μετά την επιβεβαίωση του αιτήματος σας, ο διαχειριστής της τοποθεσίας είτε θα εγκρίνει τον λογαριασμό σας είτε θα απορρίψει το αίτημα σας. Θα λάβετε ένα email μόλις το αίτημα σας εγκριθεί.";
$pgv_lang["welcome_text_auth_mode_3"]			= "<span class='center'><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></span><br />Η πρόσβαση σε αυτή την τοποθεσία επιτρέπεται <u>μόνο σε μέλη της οικογένειας</u>.<br /><br />Εάν έχετε ένα λογαριασμό χρήστη, μπορείτε να συνδεθείτε σε αυτή τη σελίδα. Εάν δεν έχετε λογαριασμό χρήστη, μπορείτε να υποβάλετε αίτημα για έναν, επιλέγοντας το κατάλληλο σύνδεσμο παρακάτω.<br /><br />Μετά την επιβεβαίωση του αιτήματος σας, ο διαχειριστής της τοποθεσίας είτε θα εγκρίνει τον λογαριασμό σας είτε θα απορρίψει το αίτημα σας. Θα λάβετε ένα email μόλις το αίτημα σας εγκριθεί.";
$pgv_lang["welcome_text_cust_head"]				= "<span class='center'><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></span><br />Η πρόσβαση επιτρέπεται σε χρήστες που έχουν λογαριασμό και κωδικό για αυτή την τοποθεσία.<br />";
//-- mygedview page
...
$pgv_lang["message_invalid_from"]		= "Μη έγκυρη διεύθυνση αποστολέα: &lt;#email#&gt;";
$pgv_lang["message_invalid_to"]			= "Μη έγκυρη διεύθυνση παραλήπτη: &lt;#email#&gt;";
