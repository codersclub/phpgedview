...
$pgv_lang["create_repository"]				= "Nova arquivo";
$pgv_lang["repo_not_exist"]					= "O arquivo %s não existe";
...
$pgv_lang["note_not_exist"]					= "A nota compartilhada %s não existe";
...
$pgv_lang["create_source"]					= "Crie uma nova fonte";
$pgv_lang["sour_not_exist"]         		= "A fonte %s não existe";
$pgv_lang["media_not_exist"]				= "O item de mídia% s não existe";
...
$pgv_lang["update_successful"]				= "A atualização foi bem sucedida";
$pgv_lang["update_failed"]					= "A atualização falhou";
