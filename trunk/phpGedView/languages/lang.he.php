...
$pgv_lang["print_preview"]		= "פשט את הדף";
$pgv_lang["cancel_preview"]		= "תצוגה רגילה";
...
$pgv_lang["NNother"] 			= "(לא-ידוע)";
$pgv_lang["PNother"] 			= "(לא-ידוע)";
...
$pgv_lang["serverTime"]				= "זמן שרת";
$pgv_lang["localTime"]				= "זמן מקומי";
...
$pgv_lang["mail01_line02"]		= "קיבלנו בקשה ב- <span dir=\"ltr\">#PGV_SERVER_NAME##PGV_SCRIPT_PATH#</span>  ליצור קוד משתמש של PhpGedView עם הכתובת האלקטרונית שלך  <span dir=\"ltr\">#user_email# .";
...
$pgv_lang["mail01_subject"]		= "הרשמתך ב-#PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["mail02_line01"]		= "שלום המנהלן ...";
$pgv_lang["mail02_line02"]		= "משתמש פוטנציאלי נרשם ב-PhpGedView של <span dir=\"ltr\">#PGV_SERVER_NAME##PGV_SCRIPT_PATH#</span>";
...
$pgv_lang["mail02_subject"]		= "רישום חדש ב-#PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail03_subject"]		= "משתמש חדש ב-#PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail04_subject"]		= "בקשת נתונים על #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["welcome_text_auth_mode_1"] = "<span class='center'><b>ברוכים הבאים לאתר הזה של חקר שושלת היוחסין</b></span><br />גישה לאתר זה מותרת לכל המשתמשים בעלי קוד משתמש באתר.<br /><br />אם יש לך קוד משתמש, תוכל להתחבר למערכת באמצעות הדף הזה. אם אין לך קוד משתמש, תוכל לבקש קוד משתמש ע\"י לחיצה על הקישור המתאים מלמטה.<br /><br />מנהלן האתר יבדוק את נתוניך ויפעיל את קוד המשתמש שלך. תקבל דואר אלקטרוני אחרי שקוד המשתמש שלך יאושר.";
$pgv_lang["welcome_text_auth_mode_2"] = "<span class='center'><b>ברוכים הבאים לאתר הזה של חקר שושלת היוחסין</b></span><br />גישה לאתר זה מותרת רק למשתמשים <u>מורשים.</u><br /><br />אם יש לך קוד משתמש תוכל להתחבר למערכת באמצעות הדף הזה. אם אין לך קוד משתמש, תוכל לבקש קוד משתמש ע\"י לחיצה על הקישור מלמטה.<br /><br />מנהלן האתר יבדוק את נתוניך ויאשר או ידחה את בקשתך. תקבל דואר אלקטרוני אחרי שבקשתך תאושר.";
$pgv_lang["welcome_text_auth_mode_3"] = "<span class='center'><b>ברוכים הבאים לאתר הזה של חקר שושלת היוחסין</b></span><br />גישה לאתר זה מותרת <u>רק לבני משפחה</u>.<br />אם יש לך קוד משתמש תוכל להתחבר למערכת באמצעות הדף הזה. אם אין לך קוד משתמש, תוכל לבקש קוד משתמש ע\"י לחיצה על הקישור המתאים מלמטה.<br /><br />מנהלן האתר יבדוק את נתוניך ויאשר או ידחה את בקשתך. תקבל דואר אלקטרוני אחרי שבקשתך תאושר.";
$pgv_lang["welcome_text_cust_head"]	= "<span class='center'><b>ברוכים הבאים לאתר הזה של חקר שושלת היוחסין</b></span><br />גישה לאתר זה מותרת למשתמשים בעלי קוד משתמש וסיסמא.<br />";
