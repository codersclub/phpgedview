...
$pgv_lang["DBHOST_help"]                = "~#pgv_lang[DBHOST]#~<br /><br />DNS eller IP adress till datorn med databasservern. Denna inställning ignoreras om du använder en SQLite databas. Detta ställer in \$DBHOST variabeln i <i>config.php</i>.";
$pgv_lang["DBUSER"]                     = "Databasens användarnamn";
$pgv_lang["DBUSER_help"]                = "~#pgv_lang[DBUSER]#~<br /><br />Databasens användarnamn, som krävs för att logga in på databasen. Denna inställning ignoreras om du använder en SQLite databas. Detta ställer in variabeln \$DBUSER i <i>config.php</i>.";
$pgv_lang["DBPASS"]                     = "Databasens lösenord";
$pgv_lang["DBPASS_help"]                = "~#pgv_lang[DBPASS]#~<br /><br />Databasens lösenord för den användare du angivit i #pgv_lang[DBUSER]#-fältet. Denna inställning ignoreras om du använder en SQLite databas. This sets the \$DBPASS variable in the <i>config.php</i>.";
...
$pgv_lang["ALLOW_CHANGE_GEDCOM_help"]   = "~#pgv_lang[ALLOW_CHANGE_GEDCOM]#~<br /><br />Genom att sätta detta värde till <b>Ja</b> tillåter du besökare <b>och</b> användare på din sajt att byta mellan olika GEDCOM-filer om du har fler än en GEDCOM konfigurerad.<br /><br />Om satt till <b>Nej</b>, både besökare <b>och</b> inloggade användare, kommer inte att kunna byta GEDCOM-fil.<br /><br />Detta ställer in variabeln \$ALLOW_CHANGE_GEDCOM i filen <i>config.php</i>.";
...
$pgv_lang["LANGUAGE_help"]              = "~#pgv_lang[LANGUAGE]#~<br /><br />Ange standardspråk för din site.<br /><br />När <b>#pgv_lang[ENABLE_MULTI_LANGUAGE]#</b> valet är satt kan användare ändra denna denna inställning genom webläsarens språkinställning, konfigurationsval på deras kontosida eller genom länkareller knappar på de flesta siorna i PhpGedView.";
$pgv_lang["ENABLE_MULTI_LANGUAGE"]      = "Tillåt användare att byta språk";
$pgv_lang["ENABLE_MULTI_LANGUAGE_help"] = "~#pgv_lang[ENABLE_MULTI_LANGUAGE]#~<br /><br />Sätt till <b>Ja</b> om du vill tillåta användare ändra sajtens standardspråk. De kan göra det via webläsaren föredragna språkinställning, konfigurationsval via deras kontosida eller via länkar eller knappar på de flesta PhpGedViews sidor.";
...
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]  = "~#pgv_lang[DEFAULT_PEDIGREE_GENERATIONS]#~<br /><br />Ställer in det antal generationer som kommer att visas i antavlan som standard.";
$pgv_lang["MAX_PEDIGREE_GENERATIONS"]		= "Max antal generationer i antavla";
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"]	= "~#pgv_lang[MAX_PEDIGREE_GENERATIONS]#~<br /><br />Ange maximalt antal generationer som skall visas för antavlor.";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"]	= "Max antal generationer i stamtavla";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"]	= "~#pgv_lang[MAX_DESCENDANCY_GENERATIONS]#~<br /><br />Ange maximalt antal generationer som skall visas i trädet över ättlingar.";
...
$pgv_lang["PEDIGREE_ROOT_ID_help"]  	= "~#pgv_lang[PEDIGREE_ROOT_ID]#~<br /><br />Anger ID för den person som skall vara utgångspunkt för alla släktträd som standard.";
$pgv_lang["GEDCOM_ID_PREFIX"]			= "GEDCOM-ID Prefix";
$pgv_lang["GEDCOM_ID_PREFIX_help"]		= "~#pgv_lang[GEDCOM_ID_PREFIX]#~<br /><br />På släkträd och andra tavlor där användare efterfrågas att mata in ett ID kommer detta prefix användas om inget annat anges.";
$pgv_lang["SOURCE_ID_PREFIX"]			= "Käll-ID prefix";
$pgv_lang["SOURCE_ID_PREFIX_help"]		= "~#pgv_lang[SOURCE_ID_PREFIX]#~<br /><br />Ifall ett nytt källpost läggs till online i PhpGedView, ett nytt ID för källan automatiskt att skapas. Käll-IDt kommer att få detta prefix.";
$pgv_lang["REPO_ID_PREFIX"]				= "Arkiv-ID prefix";
$pgv_lang["REPO_ID_PREFIX_help"]		= "~#pgv_lang[REPO_ID_PREFIX]#~<br /><br />Ifall ett nytt arkiv läggs till online i PhpGedView, kommer ett nytt ID automatiskt att genereras. Arkiv-ID kommer att få detta prefix.";
$pgv_lang["PEDIGREE_FULL_DETAILS"]      = "Visa detaljer om födelse och död i släktträden";
$pgv_lang["PEDIGREE_FULL_DETAILS_help"] = "~#pgv_lang[PEDIGREE_FULL_DETAILS]#~<br /><br />Anger om detaljer för födelse och död skall visas eller ej för en person som standard.";
$pgv_lang["PEDIGREE_SHOW_GENDER"]	= "Visa könsikon i diagram";
$pgv_lang["PEDIGREE_LAYOUT"]			= "Standard anträdslayout";
$pgv_lang["PEDIGREE_LAYOUT_help"]		= "~#pgv_lang[PEDIGREE_LAYOUT]#~<br /><br />Denna inställning bestämmer om anträdet ska skapas i stående eller liggande format.";
$pgv_lang["SHOW_EMPTY_BOXES"]			= "Visa tomma rutor i antavla.";
$pgv_lang["SHOW_EMPTY_BOXES_help"]		= "~#pgv_lang[SHOW_EMPTY_BOXES]#~<br /><br />Anger om tomma rutor skall visas i antavlan.";
$pgv_lang["ZOOM_BOXES"]					= "Zoomrutor i tavlor";
$pgv_lang["ZOOM_BOXES_help"]			= "~#pgv_lang[ZOOM_BOXES]#~<br /><br />Tillåter en användare att zooma på tavlor för att få mer information. Sätt till <b>#pgv_lang[disabled]#</b> för att avaktivera denna funktion. Sätt till <b>#pgv_lang[mouseover]#</b> för att zooma rutor när musmarkören befinner sig ovanför rutans ikon. Sätt till <b>#pgv_lang[click]#</b> för att zooma när användaren klickar på rutans ikon.";
...
$pgv_lang["ABBREVIATE_CHART_LABELS_help"]		= "~#pgv_lang[ABBREVIATE_CHART_LABELS]#~<br /><br />Om du vska förkorta beteckningar som födelse om tavlor med endast den första bokstaven som 'F'.";
$pgv_lang["SHOW_AGE_DIFF"]			= "Visa åldersskillnad";
$pgv_lang["SHOW_PARENTS_AGE"]			= "Visa ålder för föräldrar intill barnets födelsedatum";
$pgv_lang["SHOW_PARENTS_AGE_help"]		= "~#pgv_lang[SHOW_PARENTS_AGE]#~<br /><br />Visa ålder för föräldrar intill barnets födelsedatum i tavlor";
$pgv_lang["SHOW_RELATIVES_EVENTS"]      = "Visa födelse och död för släktingar på personsidan";
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] = "~#pgv_lang[SHOW_RELATIVES_EVENTS]#~<br /><br />Födslar, vigslar och dödsfall av släktingar är viktiga händelser i våra liv. Detta val kontrollerar om du vill visa dessa händelser på <i>Personliga fakta och detaljer</i>-fliken på ansidan.<br /><br />Händelser som påverkas av detta val är: <ul><li>Död av ingift</li><li>Födelse och död för barn</li><li>Föräldrars död</li><li>Syskons födelse och död</li><li>Far/morföräldrars död</li><li>Födelse och död för föräldrars syskon</li></ul>";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]      = "Expandera händelselistan automatiskt";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] = "~#pgv_lang[EXPAND_RELATIVES_EVENTS]#~<br /><br />Detta val kontrollerar om listan <i>Händelser för nära släktingar</i> ska expanderas automatiskt.";
...
$pgv_lang["HIDE_LIVE_PEOPLE_help"]      = "~#pgv_lang[HIDE_LIVE_PEOPLE]#~<br /><br />Detta val talar om ifall PhpGedView skall dölja detaljer för personer som fortfarande lever.  Levande personer är definierade som en person som inte har några händelser yngre än \$MAX_ALIVE_AGE. Av denna anledning betraktas födelse av barn som ett sådan händelse också.";
$pgv_lang["REQUIRE_AUTHENTICATION"]		= "Kräver besökarens autenticiering";
$pgv_lang["REQUIRE_AUTHENTICATION_help"]= "~#pgv_lang[REQUIRE_AUTHENTICATION]#~<br /><br />Sätta på denna val tvingar all besökare att logga in innan de se någon data på denna sajten.";
...
$pgv_lang["CHECK_CHILD_DATES_help"]     = "~#pgv_lang[CHECK_CHILD_DATES]#~<br /><br />Kontrollerar datumen för händelser hos barn för att kunna kontrollera om personen kan tänkas vara i livet eller ej.  På äldre system och stora GEDCOM-filer kan denna kontroll leda till en dålig och långsammare responstid för din sajt.";
$pgv_lang["MAX_ALIVE_AGE"]              = "Åldersgräns då person antas vara död";
$pgv_lang["MAX_ALIVE_AGE_help"]         = "~#pgv_lang[MAX_ALIVE_AGE]#~<br /><br />Om denna person har någon händelse förutom död, begravning eller kremering senare än detta år, betraktas han som \"levande\". Barnens födelsedatum betraktas som ett sådan händelse för detta ändamål.";
$pgv_lang["SHOW_GEDCOM_RECORD"]         = "Tillåt användare att se rådata i GEDCOM-poster";
$pgv_lang["SHOW_GEDCOM_RECORD_help"]    = "~#pgv_lang[SHOW_GEDCOM_RECORD]#~<br /><br />Genom att sätta detta val till <b>Ja</b> kommer en länk placeras på alla sidor för personer, källor och familjer som tillåter användaren att läsa rådata från GEDCOM-filen om personen eller källan i fråga i ett separat fönster.";
$pgv_lang["ALLOW_EDIT_GEDCOM"]			= "Tillåt online-redigering";
$pgv_lang["ALLOW_EDIT_GEDCOM_help"]		= "~#pgv_lang[ALLOW_EDIT_GEDCOM]#~<br /><br />Tillåter online-redigeringsmöjligheten för denna databas så att användare med redigeringsprivilegium kan uppdatera data online.";
$pgv_lang["EDIT_AUTOCLOSE"]		= "Automatstängning av redigeringsfönster";
$pgv_lang["EDIT_AUTOCLOSE_help"]	= "~#pgv_lang[EDIT_AUTOCLOSE]#~<br /><br />Detta val kontrollerar om redigeringsfönstret ska stängas automatiskt efter lyckad uppdatering.";
$pgv_lang["INDEX_DIRECTORY_help"]       = "~#pgv_lang[INDEX_DIRECTORY]#~<r /><br />Sökvägen till den katalog med läs och skrivrättigheter som PhpGedView skall använda för att lagra indexfiler (inkludera avslutande \"/\")<br />Detta ställer in variabeln \$INDEX_DIRECTORY i filen <i>config.php</i>.";
...
$pgv_lang["POSTAL_CODE_help"] = "~#pgv_lang[POSTAL_CODE]#~<br /><br />Olika länder använder olika sätt att skriva adresser. Detta val låter dig placera postnummret antingen före eller efter stadsnamnet.";
$pgv_lang["SUBLIST_TRIGGER_I"]		= "Maximalt antal efternamn";
$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "~#pgv_lang[SUBLIST_TRIGGER_I]#~<br /><br />Långa listor av personer med samma efternamn kan brytas upp till mindre underlistor efter första bokstaven i personen förnamn.<br /><br />Detta val bestämmer när underlistor av efternamn ska skapas. För att stänga av detta val helt, sätt detta val till noll.";
$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maximalt antal familjenamn";
$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "~#pgv_lang[SUBLIST_TRIGGER_F]#~<br /><br />Långa listor av familjer med samma efternamn kan brytas upp till mindre underlistor efter första bokstaven i personen förnamn.<br /><br />Detta val bestämmer när underlistor av familjenamn ska skapas. För att stänga av detta val helt, sätt detta val till noll.";
...
$pgv_lang["SHOW_ID_NUMBERS_help"]		= "~#pgv_lang[SHOW_ID_NUMBERS]#~<br /><br />Visa ID-nummer i en parantes efter personnamnet i tavlorna.";
$pgv_lang["SHOW_LAST_CHANGE"]		= "Visa GEDCOM-posternas senaste ändrade datum i listor";
$pgv_lang["SHOW_LAST_CHANGE_help"]	= "~#pgv_lang[SHOW_LAST_CHANGE]#~<br /><br />Denna inställning kontrollerar om senaste ändrade datum ska visas i listor eller inte.";
$pgv_lang["SHOW_PEDIGREE_PLACES"]		= "Orter detaljnivå";
$pgv_lang["SHOW_PEDIGREE_PLACES_help"]	= "~#pgv_lang[SHOW_PEDIGREE_PLACES]#~<br /><br />Denna sätter nivån av ortsinformation som visas i en personruta i tavlorna. Värdet 9 motsvarar all ortsinformation medans 0 kommer att dölja all ortsinformation. Värdet 1 visar första nivån av ortsinformationen, Värdet 2 visar dom första 2 nivåerna, osv.";
...
$pgv_lang["SHOW_CONTEXT_HELP_help"]		= "~#pgv_lang[SHOW_CONTEXT_HELP]#~<br /><br />Detta val kommer att sätta på frågeteckenhjälplänkarna på sidorna intill valmöjligheterna så att besökare kan få hjälptexter om valen på sidorna.";
...
$pgv_lang["HOME_SITE_URL_help"]         = "~#pgv_lang[HOME_SITE_URL]#~<br /><br />Varje PhpGedView-sida inkludera en länk till din huvudhemsida. Utseendet på denna länk kontrolleras av det tema som används. Du skriver in URL till din hemsida här.";
$pgv_lang["HOME_SITE_TEXT"]             = "Huvudsidans text";
$pgv_lang["HOME_SITE_TEXT_help"]        = "~#pgv_lang[HOME_SITE_TEXT]#~<br /><br />Den text som kommer att användas som titel för länken till din huvudsida.";
$pgv_lang["CONTACT_EMAIL"]              = "Släktforskningskontakt";
$pgv_lang["CONTACT_EMAIL_help"]         = "~#pgv_lang[CONTACT_EMAIL]#~<br /><br />E-post-adress som besökare kan använda för att kontakta dig om frågor gällande dina genealogiska data på din sida.";
...
$pgv_lang["WEBMASTER_EMAIL_help"]       = "~#pgv_lang[WEBMASTER_EMAIL]#~<br /><br />E-mail-adress besökare kan använda för att kontakta dig angående tekniska frågor eller fel på din site.";
...
$pgv_lang["SHOW_FACT_ICONS_help"]	= "~#pgv_lang[SHOW_FACT_ICONS]#~<br /><br />Sett detta vat till <b>#pgv_lang[yes]#</b> för att visa ikoner nära faktanamn på #pgv_lang[personal_facts]#-sidan. Faktaikoner kommer att visas endast om de finns i <i>images/facts</i> mappen i det nuvarande temat.";
$pgv_lang["FAVICON"]                    = "Favoritikon";
$pgv_lang["FAVICON_help"]               = "~#pgv_lang[FAVICON]#~<br /><br />Ändra denna sökväg så att den pekar på den ikon du vill skall visas i besökares favoriter när lagt till din sida bland sina bokmärken.";
$pgv_lang["THEME_DIR"]                  = "Temakatalog";
$pgv_lang["THEME_DIR_help"]             = "~#pgv_lang[THEME_DIR]#~<br /><br />Katalogen där dina PhpGedView-teman är lagrade. Du kan ändra vilken som helst av medföljande tema för att sätta din egna unika prägel på din PhpGedView-sajt.  Se sektionen om att skräddarsy teman i filen <a href=\"readme.txt\">readme.txt</a>, för mer information.";
...
$pgv_lang["SERVER_URL_help"]			= "~#pgv_lang[SERVER_URL]#~<br /><br />Om du använder https eller en annan port än HTTP standardport, behöver du ange en URL för att få åtkomst till din server.<br /><br />Detta sätter variablen \$SERVER_URL i filen <i>config.php</i>.";
...
$pgv_lang["PGV_SESSION_TIME_help"]		= "~#pgv_lang[PGV_SESSION_TIME]#~<br /><br />Tiden i sekunder en session i PhpGedView varar innan en ny inloggning krävs. Standardtiden är 120 minuter.<br /><br />Detta sätter variabeln \$PGV_SESSION_TIME i filen <i>config.php</i>.";
$pgv_lang["SHOW_COUNTER_help"] 			= "~#pgv_lang[SHOW_COUNTER]#~<br /><br />Visa träffräknare i portalen och på enskilda sidor.";
$pgv_lang["SHOW_COUNTER"]  				= "Visa träffräknare";
$pgv_lang["SHOW_STATS"]					= "Visa processstatistik";
$pgv_lang["SHOW_STATS_help"]			= "~#pgv_lang[SHOW_STATS]#~<br /><br />Visa körtid och antalet databasfrågor längst ner på varje sida.";
...
$pgv_lang["ALLOW_USER_THEMES_help"]		= "~#pgv_lang[ALLOW_USER_THEMES]#~<br /><br />Ger användaren möjligheten att välja sitt eget tema.<br /><br />Detta sätter variabeln \$ALLOW_USER_THEMES i filen <i>config.php</i>.";
$pgv_lang["PGV_SIMPLE_MAIL_help"]		= "~#pgv_lang[PGV_SIMPLE_MAIL]#~<br /><br />I normala e-posthuvud för externa e-post, e-postadress likväl som namn används. Vissa e-postsystem acceptera inte detta. Satt till <b>Ja</b>, endast e-postadressen kommer att användas.<br /><br />Detta sätter variabeln \$PGV_SIMPLE_MAIL i filen <i>config.php</i>.";
...
$pgv_lang["META_AUTHOR_help"]		= "~#pgv_lang[META_AUTHOR]#~<br /><br />Värdet som ska användas i författar-metatagen i HTML sidans rubrik. Lämna detta fält tomt för att använda #pgv_lang[CONTACT_EMAIL]fulla namn för detta värde.<br /><br />Detta sätter \$META_AUTHOR variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["META_PUBLISHER_help"]	= "~#pgv_lang[META_PUBLISHER]#~<br /><br />Värdet som ska användas i förläggarmetatag i HTML sidans rubrik. Lämna detta fält tomt för att använda #pgv_lang[CONTACT_EMAIL]# fulla namn för detta värde.<br /><br />Detta sätter \$META_PUBLISHER variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["META_COPYRIGHT_help"]	= "~#pgv_lang[META_COPYRIGHT]#~<br /><br />Värdet som ska användas i upphövsrätts-metatagen i HTML sidans rubrik. Lämna detta fält tomt för att använda #pgv_lang[CONTACT_EMAIL]# fulla namn för detta värde.<br /><br />Detta sätter \$META_COPYRIGHT variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["META_DESCRIPTION_help"]	= "~#pgv_lang[META_DESCRIPTION]#~<br /><br />Värdet som ska användas i beskrivningsmetatagen i HTML sidans rubrik. Lämna detta fält tomt för att använda aktiva GEDCOM-titlen för detta värde.<br /><br />Detta sätter \$META_DESCRIPTION variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["META_PAGE_TOPIC_help"]	= "~#pgv_lang[META_PAGE_TOPIC]#~<br /><br />Värdet som ska användas i sidämnes-metatagen i HTML sidans rubrik. Lämna detta fält tomt för att använda den aktiva databasen title för detta värde.<br />Detta sätter \$META_PAGE_TOPIC variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["META_AUDIENCE_help"]		= "~#pgv_lang[META_AUDIENCE]#~<br /><br />Värdet som ska användas i publik-metatagen i HTML sidans rubrik.<br />Detta sätter \$META_AUDIENCE variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
$pgv_lang["META_PAGE_TYPE"]			= "Sidtyp META tag";
$pgv_lang["META_PAGE_TYPE_help"]	= "~#pgv_lang[META_PAGE_TYPE]#~<br /><br />Värdet som ska användas i sidtyp-metatagen i HTML sidans rubrik.<br /><br />Detta sätter \$META_PAGE_TYPE variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
$pgv_lang["META_ROBOTS"]			= "Robot META tag";
$pgv_lang["META_ROBOTS_help"]		= "~#pgv_lang[META_ROBOTS]#~<br /><br />Värdet som ska användas i Robots-metatagen i HTML sidans rubrik. Många robotar eller webkravlare bryr sig inte om detta värde.<br /><br />Detta sätter \$META_ROBOTS variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
$pgv_lang["META_REVISIT"]			= "Hur ofta ska robotscript återbesöka META tagen";
$pgv_lang["META_REVISIT_help"]		= "~#pgv_lang[META_REVISIT]#~<br /><br />Värdet som ska användas i återbesöks-metatagen i HTML sidans rubrik. Många webkravlare bryr sig inte om detta värde.<br /><br />Detta sätter \$META_AUDIENCE variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["META_TITLE_help"]			=	"~#pgv_lang[META_TITLE]#~<br /><br />Det som skrivs på denna rad kommer att läggas till titel-tagen i HTML sidhuvud efter den vanliga sidtiteln och före PhpGedView omnämnandet.<br /><br />Detta sätter \$META_TITLE variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["return_editconfig"]			= "Du kan återvända till denna konfiguration när du vill genom att skriva in sidadressen <i>editconfig.php</i> i nätbläddraren, eller genom att klicka på länken <b>Konfiguration</b> på <b>#pgv_lang[gedcom_adm_head]#</b>-sidan.";
$pgv_lang["return_editconfig_gedcom"]	= "Du kan återvända till denna konfiguration när du vill genom att klicka på länken: <b>Redigera</b> i <b>#pgv_lang[current_gedcoms]#</b>-tabellen, i <b>#pgv_lang[gedcom_adm_head]#</b> eller genom att skriva in sidan för filen <i>editconfig_gedcom.php</i>.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "~#pgv_lang[SHOW_LIVING_NAMES]#~<br /><br />Skall levande personers namn visas för allmänheten?";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Visa forskningsassistenten";
$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]		= "~#pgv_lang[SHOW_RESEARCH_ASSISTANT]#~<br /><br />Vilken typ av användare kan se forskningsassistentmodulen om den är installerad?";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "~#pgv_lang[USE_RELATIONSHIP_PRIVACY]#~<br /><br />Ett <b>Nej'</b>innebär att registrerade användare kan se detaljerna på alla levande personer.<br /><br />Ett <b>Ja</b> betyder att användare bara kan se den privata informationen för levande personer de är släkt med.";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "~#pgv_lang[MAX_RELATION_PATH_LENGTH]#~<br /><br />Om #pgv_lang[USE_RELATIONSHIP_PRIVACY]# är påsatt, inloggade användare kommer endast kunna se och redigera personer inom detta antal släktsteg.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "~#pgv_lang[CHECK_MARRIAGE_RELATIONS]#~<br /><br />Kontrollera släktförhållande genom vigselrelationer.";
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "~#pgv_lang[SHOW_DEAD_PEOPLE]#~<br /><br />Sätt integritetsaccessnivå för alla döda personer.";
...
$pgv_lang["week_start_help"]			= "~#pgv_lang[week_start]#~<br /><br />Veckodagen som veckan startar på i detta språk. I Sverige räknar vi vanligen måndag som första veckodagen.";
$pgv_lang["name_reverse"]				= "Efternamn först";
$pgv_lang["name_reverse_help"]			= "~#pgv_lang[name_reverse]#~<br /><br />På några språk skall efternamnet visas först istället för standardinställningen att visa det sist. Om du aktiverar detta val kommer efternamnet att visas först.";
...
$pgv_lang["alphabet_upper_help"]		= "~#pgv_lang[alphabet_upper]#~<br /><br />Stora bokstäver i detta språk. Detta alfabet används för sortering av namn med stora bokstäver i namnlistorna.";
$pgv_lang["alphabet_lower"]				= "Små bokstäver";
$pgv_lang["alphabet_lower_help"]		= "~#pgv_lang[alphabet_lower]#~<br /><br />Små bokstäver i detta språk. Detta alfabet används för sortering av små bokstäver i namnlistorna.";
...
$pgv_lang["add_new_language_desc"]	= "Denna funktion låter dig lägga till ett nytt, ej tidigare tillgängligt språk till PhpGedView.<br /><br />Du kan ställa in standardinställningarna för det nya språket. Dessa inkluderar språkigenkänningskoder, skrivriktining, veckodag veckan startar på i detta språk, tidsinställningar, alfabet, etc.<br /><br />Du kommer att få mer hjälp för inställningarna som stöds av PhpGedView efter att du valt språk och klickat på  <b>#pgv_lang[add_new_lang_button]#</b>-knappen.<br /><br />Mer hjälp finns tillgänglig på konfigurationssidan för språket.";
...
$pgv_lang["preview_faq_item_help"] = "~#pgv_lang[preview_faq_item]#~<br />Detta val låter en administratör attse FAQ-sidan utan alla edeteringsval och länkar.<br /><br />Förutom en <b>Redigera</b>-länk ovanför den första FAQ-posten, utseendet kommer att vara identiskt som en vanlig användare ser. Den speciella <b>Redigera</b>-länken kommer att återställa full redigeringsfunktionallitet till FAQ-sidan.";
$pgv_lang["restore_faq_edits"] = "Återställ FAQ redigeringsfunktionallitet";
$pgv_lang["restore_faq_edits_help"] = "~#pgv_lang[restore_faq_edits]#~<br />Detta val återställer FAQ-sidan till vad en administratör vanligen ser, så att individuella FAQ-poster kan redigeras.";
$pgv_lang["add_faq_item"] = "Lägg till FAQ-post";
$pgv_lang["add_faq_item_help"] = "~#pgv_lang[add_faq_item]#~<br />Detta val låter dig lägga till en post till FAQ-sidan.";
$pgv_lang["edit_faq_item"] = "Redigera FAQ-post";
$pgv_lang["edit_faq_item_help"] = "~#pgv_lang[edit_faq_item]#~<br />Detta val låter dig redigera en post på FAQ-sida.";
$pgv_lang["delete_faq_item"] = "Radera FAQ-post";
$pgv_lang["delete_faq_item_help"] = "~#pgv_lang[delete_faq_item]#~<br />Detta val låter dig radera en post från FAQ-sidan.";
...
$pgv_lang["add_faq_header_help"] = "~FAQ Rubrik~<br />Detta är rubriken eller ämnet för FAQ-posten.<br /><br />Det som skrivs in här kan formateras, HTML-taggar som <b> och <br /> är tillåtna tillsammans med &amp; och &nbsp;. Det finns ingen möjlighet att skriva in HTML-taggar så att de tolkas som text.";
$pgv_lang["add_faq_body_help"] = "~FAQ Text~<br />Texten för FAQ-texten skrivs in här.<br /><br />Texten kan formateras, HTML-taggar som <b> och <br /> är tillåtna, även HTML enheter som &amp; och &nbsp;. Det finns inget sätt att skriva HTML-taggar så att de tolkas som text.";
...
$pgv_lang["USE_QUICK_UPDATE_help"]		= "~#pgv_lang[USE_QUICK_UPDATE]#~<br /><br />Detta låter inloggade användare skriva in ändringar genom #pgv_lang[quick_update_title]#-formuläret. Detta sätter \$USE_QUICK_UPDATE variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
$pgv_lang["SEARCHLOG_CREATE"]			= "Arkivera sökningsloggfiler";
$pgv_lang["SEARCHLOG_CREATE_help"]		= "~#pgv_lang[SEARCHLOG_CREATE]#~<br /><br />Hur ofta ska programmet arkivera sökningloggfilerna.<br /><br />Detta sätter \$SEARCHLOG_CREATE variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
$pgv_lang["CHANGELOG_CREATE"]		= "Arkivera ändringslogfiler";
$pgv_lang["CHANGELOG_CREATE_help"]	= "~#pgv_lang[CHANGELOG_CREATE]#~<br /><br />Hur ofta ska programmet arkivera ändringslogfilerna.<br /><br />Detta sätter \$CHANGELOG_CREATE i <i><u>xxx</u>.GED_conf.php</i>.";
$pgv_lang["GEDCOM_DEFAULT_TAB"]			= "Standardflik att visa på ansedelsidan";
$pgv_lang["GEDCOM_DEFAULT_TAB_help"]	= "~#pgv_lang[GEDCOM_DEFAULT_TAB]#~<br /><br />Detta val tillåter dig att välja vilken flik på ansedelsidan som ska visas när en besökare för första gåmgen kommer till sidan. Detta sätter \$GEDCOM_DEFAULT_TAB variablen i filen config_gedcom.php";
$pgv_lang["SHOW_MARRIED_NAMES"]			= "Visa vigselnamn i personlistan";
$pgv_lang["SHOW_MARRIED_NAMES_help"]	= "~#pgv_lang[SHOW_MARRIED_NAMES]#~<br /><br />Detta val visar vigselnamn för kvinnor i personlistan. Detta val kräver att du beräknar vigselnamn när du importerar GEDCOM-filen. Detta sätter \$SHOW_MARRIED_NAMES variabeln i <i><u>xxx</u>.GED_conf.php</i>.";
...
$pgv_lang["SHOW_SOURCES_help"]			= "~#pgv_lang[SHOW_SOURCES]#~<br /><br />Sätt integritetsaccessnivå för alla källor. Om användaren inte har access till källor, käll-listorna kommer att tas bort ifrån listmenyn och källfliken kommer inte att visas på ansedelsidan.";
$pgv_lang["phpinfo_help"]				= "~#pgv_lang[phpinfo]#~<br /><br />Denna sida ger uttömande information om servern på vilken phpGedView körs. Många konfigurationsdetaljer om serverns mjukvara, som berör PHP och phpGedView kan kontrolleras.";
$pgv_lang["config_help_help"]			= "~#pgv_lang[config_help]#~<br /><br />Denna sida samlar ihop alla huvudämnena för konfigurationshjälp på samma ställe. Du kan se informationen på din skärm eller skriva ut den för att använda senare.";
...
$pgv_lang["THUMBNAIL_WIDTH_help"]		= "~#pgv_lang[THUMBNAIL_WIDTH]#~<br /><br />Detta är bredden (i pixlar) som programmet kommer att använda vid automatisk generering av miniatyrbilderna. Standardinställningen är 100.";

$pgv_lang["new_language_help"]			="#pgv_lang[new_language]#<br /><br />Här kan du välja det språk som du vill ha som källa för att jämföra mot ett annat språk.<br /><br />Alla ändringar görs normalt först i den <b>engelska</b> filen, så du ska normalt välja den engelska här.";
...
$pgv_lang["language_to_edit_help"]		="#pgv_lang[language_to_edit]#<br /><br />Från denna rullgardinsmeny kan du välja språket som du vill <b>Redigera</b> meddelandet för.";
...
$pgv_lang["language_to_export_help"]	="~#pgv_lang[language_to_export]#~<br /><br />Från denna rullgardinsmeny kan du välja det språk, från vilket du vill <b>exportera</b> meddelande. Rutinen exporterar bara innehållet i <i>configure_help_text.php</i> filen. Resultat är ett HTML-fil som du kan skriva ut från din webläsare.";

$pgv_lang["QUICK_REQUIRED_FAMFACTS"]			= "Fakta för familjer som alltid ska visas på snabbformuläret";
$pgv_lang["QUICK_REQUIRED_FAMFACTS_help"]		= "~#pgv_lang[QUICK_REQUIRED_FAMFACTS]#~<br /><br />Detta är ett kommaseparerad lista av GEDCOM-faktataggar som alltid visas på familjefliken på snabbformuläret oavsett om de redan finns eller inte i personposten. T.ex. om MARR är i listan kommer fältet för vigseldatum och vigselplats att alltid visas på formuläret.";
$pgv_lang["QUICK_ADD_FAMFACTS"]			= "Fakta om familjer att visa på snabbformuläret";
$pgv_lang["QUICK_ADD_FAMFACTS_help"]		= "~#pgv_lang[QUICK_ADD_FAMFACTS]#~<br /><br />Detta är en kommaseparerad lista av GEDCOM-faktataggar som kommer att visas på familjefliken på snabbformulär. Endast faktan i listan kommer att visas på formuläret eller göras tillgängliga i området där du lägger till nya fakta i formuläret.";
$pgv_lang["QUICK_REQUIRED_FACTS"]			= "Fakta som alltid visas på snabbformuläret";
$pgv_lang["QUICK_REQUIRED_FACTS_help"]		= "~#pgv_lang[QUICK_REQUIRED_FACTS]#~<br /><br />Detta är en kommaseparerad lista av GEDCOM-faktataggar som alltid visas på snabbformuläret oavsett om de redan finns i personens post eller inte. T.ex. om BIRT finns i listan kommer fälten för födelsedatum och födelseort kommer att visas på fomruläret.";
$pgv_lang["QUICK_ADD_FACTS"]			= "Fakta att visa på snabbformuläret";
$pgv_lang["QUICK_ADD_FACTS_help"]		= "~#pgv_lang[QUICK_ADD_FACTS]#~<br /><br />Detta är en kommaseparerad lista av GEDCOM-faktataggar som kommer att visas på snabbformuläret. Endast fakta i listan kommer att visas på formuläret eller göras tillgänglig i området där nya fakta läggs till.";
...
$pgv_lang["AUTO_GENERATE_THUMBS_help"]		= "~#pgv_lang[AUTO_GENERATE_THUMBS]#~<br /><br />Ska systemet generera miniatyrbilder automatiskt för bilder som inte har några. Din PHP-installation stöder kanske inte denna funktionalitet.";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Media-ID prefix";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "~#pgv_lang[MEDIA_ID_PREFIX]#~<br /><br />När en ny mediapost läggs till online i PhpGedView, kommer ett nytt id för det mediet att genereras automatiskt, Media-ID kommer att få detta prefix.";
...
$pgv_lang["LANG_SELECTION_help"]		= "~#pgv_lang[LANG_SELECTION]#~<br /><br />Du kan ändra listan av stödda språk i PhpGedViewsajten genom att lägga till eller tabort kryss efter önskemål. Detta ändrar språkvalen som är tillgängliga för användaren.<br /><br />Du kan åstadkomma samma sak genom  <b>#pgv_lang[enable_disable_lang]#</b>-länken på #pgv_lang[admin]# meny, där kan du också ändra saker som flagikonerna, datumformatet eller om efternamnet alltid ska skrivas först.";
$pgv_lang["DBPERSIST"]					= "Använd fast databaskoppling";
$pgv_lang["DBPERSIST_help"]				= "Bestämmer om PhpGedView ska använda fast databaskoppling när du arbetar med databasen.<br /><br />När du satt den till <b>Ja</b> kan PhpGedView återanvända databaskopplingen därigenom snabba upp kopplingen till databasen. Men, detta kan skapa fel om din server har ett för lågt antal maximala antal kopplingar satt. Om du är osäker på din servers support för fasta kopplingar ska du sätta detta värde till <b>Nej</b>.";
...
$pgv_lang["INDI_FACTS_QUICK_help"]	= "~#pgv_lang[INDI_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM personfakta som visas intill den fulla listan och som kan läggas till med ett klick.";
$pgv_lang["FAM_FACTS_ADD"] 			= "Familj lägg till fakta";
$pgv_lang["FAM_FACTS_ADD_help"]		= "~#pgv_lang[FAM_FACTS_ADD]#~<br /><br />Detta är en lista av GEDCOM fakta som dina användare kan lägga till för en familj. Du kan modifiera denna lista genom att tabort eller lägga till fakta namn, även egna, efter behov. Fakta namn som visas i denna lista får inte också finnas i <i>#pgv_lang[FAM_FACTS_UNIQUE]#</i>-listan.";
$pgv_lang["FAM_FACTS_UNIQUE"] 			= "Unika familjefakta";
$pgv_lang["FAM_FACTS_UNIQUE_help"]		= "~#pgv_lang[FAM_FACTS_UNIQUE]#~<br /><br />Detta är en lista av GEDCOM fakta som dina användare kan lägga till endast <u>en gång</u> till en familj. Du kan modifiera denna lista genom att tabort eller lägga till fakta namn, även egna, efter behov. Fakta namn som visas i denna lista får inte också finnas i <i>#pgv_lang[FAM_FACTS_ADD]#</i>-listan.";
$pgv_lang["FAM_FACTS_QUICK"] 			= "Snabb familjefakta";
$pgv_lang["FAM_FACTS_QUICK_help"]	= "~#pgv_lang[FAM_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM familjefakta som visas intill den fulla listan och som kan läggas till med ett klick.";
$pgv_lang["SOUR_FACTS_ADD"] 			= "Källa lägg till fakta";
$pgv_lang["SOUR_FACTS_ADD_help"]		= "~#pgv_lang[SOUR_FACTS_ADD]#~<br /><br />Detta är en lista av GEDCOM fakta som dina användare kan lägga till till en källa. Du kan modifiera denna lista genom att tabort eller lägga till fakta namn, även egna, efter behov. Fakta namn som visas i denna lista får inte också finnas i <i>#pgv_lang[SOUR_FACTS_UNIQUE]#</i>-listan.";
...
$pgv_lang["SOUR_FACTS_QUICK_help"]	= "~#pgv_lang[SOUR_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM källfakta som visas intill den fulla listan och som kan läggas till med ett klick.";
$pgv_lang["REPO_FACTS_ADD"] 			= "Arkiv lägg till fakta";
$pgv_lang["REPO_FACTS_ADD_help"]		= "~#pgv_lang[REPO_FACTS_ADD]#~<br /><br />Detta är en lista av GEDCOM fakta som dina användare kan lägga till till ett arkiv. Du kan modifiera denna lista genom att tabort eller lägga till fakta namn, även egna, efter behov. Fakta namn som visas i denna lista får inte också finnas i <i>#pgv_lang[REPO_FACTS_UNIQUE]#</i>-listan.";
...
$pgv_lang["REPO_FACTS_QUICK_help"]	= "~#pgv_lang[REPO_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM arkivfakta som visas intill den fulla listan och som kan läggas till med ett klick.";
...
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "~#pgv_lang[SHOW_NO_WATERMARK]#~<br /><br />Om mediabrandväggen är på kommer användarna att se vattenmärke om de inte har den rättighetsnivå som specificeras här.";
...
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />Läs på Wikin för en beskrivning på hur du ska använda mediabrandväggen. <a href=\"http://wiki.phpgedview.net/en/index.php/Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php/Media_Firewall</a>";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Mediabrandväggens rootmapp";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Mapp i vilken den skyddade mediamappen kan skapas. När detta fält är tomt, kommer <b>#GLOBALS[INDEX_DIRECTORY]#</b> mappen att användas.";
...
$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "~#pgv_lang[MEDIA_FIREWALL_THUMBS]#~<br /><br />När en bild är skyddad i mediamappen ska dess miniatyr också skyddas?";
$pgv_lang["SHOW_SPIDER_TAGLINE"]		= "Visa sökmotorns tagline";
$pgv_lang["SHOW_SPIDER_TAGLINE_help"]		= "~#pgv_lang[SHOW_SPIDER_TAGLINE]#~<br /><br />På sidor genererade för sökmotorer, visar som den sista sidan den sökmotor som sidan upptäckte. Om detta val är på, kan det ha en positiv inverkan på Google AdSense möt sökmotoroptimeringsverktyg.";
