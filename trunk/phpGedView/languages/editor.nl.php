...
$pgv_lang["add_unlinked_person"]		= "Ongekoppelde persoon toevoegen";
$pgv_lang["add_unlinked_source"]		= "Ongekoppelde bron toevoegen";
...
$pgv_lang["server_file_advice2"]		= "Hier kan een URL worden ingevoerd, beginnend met «http://».";
$pgv_lang["server_folder_advice"]		= "Voer maximaal #GLOBALS[MEDIA_DIRECTORY_LEVELS]# mapnamen in, welke komen na «#GLOBALS[MEDIA_DIRECTORY]#».<br />Voer niet het  «#GLOBALS[MEDIA_DIRECTORY]#» deel van de mapnaam in.";
...
$pgv_lang["use_browse_advice"]			= "Gebruik de knop «Bladeren» of «Browse» om op uw computer naar de gewenste file te zoeken.";
...
$pgv_lang["resn_disabled"]				= "Opmerking: U moet de «#pgv_lang[PRIVACY_BY_RESN]#» aanzetten, om deze instelling effectief te maken.";
...
$pgv_lang["thumb_create_ok0a"]			= "Miniatuurweergave <b>#GLOBALS[imageThumbnail]#</b> automatisch gemaakt.";
...
$pgv_lang["thumb_create_fail7"]			= "Er is niet genoeg vrij geheugen. Verklein de grootte van de invoerafbeelding of pas de geheugentoewijzing aan in de Siteconfiguratie, Stap 4, Geavanceerde instellingen.";
...
$pgv_lang["edit_raw"]					= "Bewerk onbewerkte GEDCOM-record";
...
$pgv_lang["accept_gedcom"]				= "Geef voor iedere wijziging aan of deze geaccepteerd moet worden of ongedaan gemaakt.<br /><br />Klik <b>#pgv_lang[accept_all]#</b> om alle in een handeling door te voeren. Klik <b>#pgv_lang[view_change_diff]#</b> om de oude en nieuwe situatie te zien, klik <b>#pgv_lang[view_gedcom]#</b> om de nieuwe situatie in GEDCOM-formaat te bekijken.";
...
$pgv_lang["change_family_instr"]		= "Op deze pagina kunt u gezinsleden wijzigen en verwijderen.<br /><br />Voor ieder gezinslid kunt u de koppeling <b>Wijzig</b> gebruiken om en ander persoon de desbetreffende rol binnen het gezin te geven. U kunt ook de koppeling <b>Verwijderen</b> gebruiken om de persoon uit het gezin te verwijderen.<br /><br />Als u klaar bent met aanpassen van de gezinsleden, kunt u de wijzigingen opslaan met de <b>Opslaan</b> knop.";
...
$pgv_lang["create_repository"]			= "Maak nieuwe archief";
$pgv_lang["repo_not_exist"]				= "Het archief %s bestaat niet";
$pgv_lang["shared_note_assisted"]		= "Gedeelde Notitie m.b.v. Assistent";
$pgv_lang["create_shared_note"]			= "Maak nieuwe Gedeelde Notitie";
$pgv_lang["note_not_exist"]				= "Het Gedeelde Notitie %s bestaat niet";
...
$pgv_lang["create_source"]				= "Maak een nieuwe bron";
$pgv_lang["sour_not_exist"]         	= "Het bron %s bestaat niet";
$pgv_lang["media_not_exist"]			= "Het media-item %s bestaat niet";
...
$pgv_lang["media_file"]					= "Mediabestand te uploaden";
...
$pgv_lang["thumbnail"]					= "Miniatuur te uploaden";
...
$pgv_lang["update_successful"]			= "De update is gelukt";
$pgv_lang["update_failed"]				= "De update is mislukt";
