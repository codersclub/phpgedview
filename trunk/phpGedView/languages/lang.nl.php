...
$pgv_lang["charts_block"]			= "Grafieken";
$pgv_lang["charts_block_descr"]			= "Het «Grafieken» blok laat u een grafiek op de Welkom of uw MyGedView portal pagina.  U kunt het blok instellen om een nakomelingen-, voorouder-, of zandloper grafiek te tonen. U kunt de startpersoon voor deze grafiek instellen.";
...
$pgv_lang["medialist_recursive"]	= "List bestanden in submappen";
...
$pgv_lang["search_prtnames"]		= "Toon namen van persoon:";
...
$pgv_lang["review_changes_descr"]	= "Het «Te beoordelen wijzigingen» blok toont een lijst met gegevens die op de website zijn aangebracht, maar nog niet zijn beoordeeld en goed- of afgekeurd. Als dit vak is geactiveerd, wordt eens per dag een e-mailbericht verzonden aan gebruikers die accepteer-rechten hebben, om ze te waarschuwen dat er wijzigingen wachten op beoordeling.";
...
$pgv_lang["top10_pageviews_descr"]	= "Het «Meest bekeken gegevens» blok toont de gegevens die het meest zijn bekeken. Het is noodzakelijk dat de bezoekteller is ingeschakeld. Zie hiervoor de GEDCOM-configuratie.";
...
$pgv_lang["empty_cart"]					= "Maak het bak leeg";
...
$pgv_lang["convertPath"]				= "Converteer media pad";
$pgv_lang["convertSlashes"]				= "Converteer media map separators";
...
$pgv_lang["soundex_search"]			= "Zoek zoals je denkt dat de naam is geschreven (Soundex)";
...
$pgv_lang["add_another"]			= "Nog een persoon aan de tijdlijn toevoegen";
...
$pgv_lang["utf8_to_ansi"]			= "Converteer van UTF-8 naar ANSI (ISO 8859-1)";
...
$pgv_lang["mail01_subject"]			= "Uw registratie op #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["mail02_line01"]			= "Hallo Beheerder ...";
$pgv_lang["mail02_line02"]			= "Een nieuwe gebruiker vroeg een gebruikersnaam aan op #PGV_SERVER_NAME##PGV_SCRIPT_PATH#.";
...
$pgv_lang["mail02_subject"]			= "Nieuwe inschrijving op #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["hashcode"]				= "Verificatiecode:";
$pgv_lang["thankyou"]				= "Hallo #user_fullname# ...<br />Dank voor uw registratie";
$pgv_lang["pls_note06"]				= "We sturen nu een bevestigingsmail naar het adres <b>#user_email#</b>. U moet uw accountverzoek verifiëren door de instructies in de bevestigingsmail te volgen. Als u uw accountaanvraag niet binnen zeven dagen bevestigt, wordt uw aanvraag automatisch afgewezen. U moet opnieuw een aanvraag indienen.<br /><br />Nadat u de instructies in de bevestigingsmail heeft gevolgd, moet de beheerder uw verzoek nog goedkeuren voordat uw account kan worden gebruikt.<br /><br />Aan log in op deze site, je hebt je gebruikersnaam en wachtwoord nodig.";
$pgv_lang["pls_note06a"] 			= "Er wordt nu een bevestiging verzonden naar het e-mailadres <b>#user_email#</b>. U dient uw aanvraag te bevestigen, volg hiervoor de instructies in het e-mailbericht. Als u uw aanvraag niet binnen zeven dagen bevestigt, komt uw aanvraag automatisch te vervallen. U moet dan opnieuw een aanvraag indienen.<br /><br />Nadat u uw aanvraag heeft bevestigd, kunt u zich aanmelden als gebruiker op de website. Gebruik hiervoor uw gebruikersnaam en wachtwoord.";
...
$pgv_lang["pls_note08"]				= "De gegevens van gebruiker <b>#user_email#</b> zijn gecontroleerd.";
...
$pgv_lang["mail03_subject"]			= "Nieuwe verificatie op #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["pls_note09"]				= "U bent herkend als geregistreerde gebruiker.";
$pgv_lang["pls_note10"]				= "De beheerder is geïnformeerd. Zodra hij toestemming heft verleend kunt u met uw gebruikersnaam en wachtwoord aanmelden.";
$pgv_lang["pls_note10a"]			= "U kunt zich nu aanmelden met uw gebruikersnaam en wachtwoord.";
$pgv_lang["data_incorrect"]				= "Gegevens niet correct, probeer opnieuw.";
$pgv_lang["user_not_found"]			= "Kan de ingevoerde informatie niet verifiëren. Probeer het opnieuw of neem contact op met de sitebeheerder voor meer informatie.";

$pgv_lang["lost_pw_reset"]			= "Verzoek om een nieuw wachtwoord";
$pgv_lang["pls_note11"]				= "Om uw wachtwoord opnieuw in te stellen, voert u uw gebruikersnaam in.<br /><br />We zullen reageren door u een e-mail te sturen naar het adres dat bij uw account is geregistreerd. De e-mail bevat een URL en een bevestigingscode voor uw account. Wanneer u deze URL bezoekt, kunt u uw wachtwoord wijzigen en inloggen op deze site. Om veiligheidsredenen mag u deze bevestigingscode aan niemand geven.<br /><br />Als u hulp nodig heeft van de sitebeheerder, gebruik dan de onderstaande contactlink.";
...
$pgv_lang["mail04_line05"]			= "Doe het volgende nadat u bent aangemeld: klik op «#pgv_lang[editowndata]#» in het menu «#pgv_lang[mygedview]#» en vul de gegevens bij wachtwoord in, om uw wachtwoord te wijzigen.";
$pgv_lang["mail04_subject"]			= "Nieuw wachtwoord op #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["pwreqinfo"]				= "Hallo....<br /><br />Een nieuw wachtwoord is per e-mail verzonden aan <b>#user[email]#</b>.<br /><br />Binnen enkele minuten zal deze in uw mailbox worden bezorgd.<br /><br />Aanbeveling:<br />Meldt u na ontvangst van de e-mail met uw gebruikersnaam en nieuwe wachtwoord aan en wijzig daarna uw wachtwoord.";
...
$pgv_lang["welcome_text_auth_mode_1"]	= "<span class='center'><b>Welkom op deze Genealogie Website</b></span><br />Toegang tot deze website is voorbehouden aan bezoekers die hiervoor zijn geautoriseerd.<br /><br />Als u al beschikt over een gebruikersnaam en wachtwoord, dan kunt u zich op deze pagina aanmelden.<br /><br />Als u nog geen gebruikersnaam en wachtwoord heeft, kunt u er met behulp van de onderstaande koppeling een aanvragen. Na verificatie van de door u verstrekte informatie zal de beheerder uw gebruikersnaam activeren. Zodra activering heeft plaatsgevonden, ontvangt u hierover een e-mailbericht.";
$pgv_lang["welcome_text_auth_mode_2"]	= "<span class='center'><b>Welkom op deze Genealogie Website</b></span><br />Toegang tot deze website is voorbehouden aan bezoekers die hiervoor zijn <u>geautoriseerd</u>.<br /><br />Als u al beschikt over een gebruikersnaam en wachtwoord, dan kunt u zich op deze pagina aanmelden.<br /><br />Als u nog geen gebruikersnaam en wachtwoord heeft, kunt u er met behulp van de onderstaande koppeling een aanvragen. Na verificatie van de door u verstrekte informatie kan de beheerder uw aanvraag toekennen of afwijzen. Zodra uw aanvraag wordt toegekend, ontvangt u hierover een e-mailbericht.";
$pgv_lang["welcome_text_auth_mode_3"]	= "<span class='center'><b>Welkom op deze Genealogie Website</b></span><br />Toegang tot deze website is voorbehouden aan <u>familieleden</u><br /><br />Als u al beschikt over een gebruikersnaam en wachtwoord, dan kunt u zich op deze pagina aanmelden.<br /><br />Als u nog geen gebruikersnaam en wachtwoord heeft, kunt u er met behulp van de onderstaande koppeling een aanvragen. Na verificatie van de door u verstrekte informatie kan de beheerder uw aanvraag toekennen of afwijzen. Zodra uw aanvraag wordt toegekend, ontvangt u hierover een e-mailbericht.";
$pgv_lang["welcome_text_cust_head"]		= "<span class='center'><b>Welkom op deze Genealogie Website</b></span><br />Toegang is voorbehouden aan gebruikers die beschikken over een gebruikersnaam en wachtwoord voor deze site.";
...
$pgv_lang["more_events_privacy"]	= "Andere gebeurtenissen voor de komende #pgv_lang[global_num1]# dagen zijn vanwege privacybeperkingen verborgen.";
$pgv_lang["more_events_privacy1"]	= "Andere gebeurtenissen voor morgen zijn vanwege privacybeperkingen verborgen.";
...
$pgv_lang["more_today_privacy"]		= "Andere gebeurtenissen voor vandaag zijn vanwege privacybeperkingen verborgen.";
...
$pgv_lang["no_favorites"]			= "U heeft geen favorieten geselecteerd. U kunt een persoon aan uw favorieten toevoegen door de details van de persoon op te zoeken en te klikken op <b>#pgv_lang[add_favorite]#</b>. U kunt ook het ID van de persoon, als u dit kent, in het vak hieronder intypen.";
...
$pgv_lang["enter_body"]					= "Voer een berichttekst in voordat u deze verzendt.";
...
$pgv_lang["gedcom_created_using"]		= "Dit genealogiebestand is vervaardigd met <b>#CREATED_SOFTWARE# #CREATED_VERSION#</b>.";
$pgv_lang["gedcom_created_on"]			= "Dit genealogiebestand is vervaardigd op <b>#CREATED_DATE#</b>.";
$pgv_lang["gedcom_created_on2"]			= "op <b>#CREATED_DATE#</b>";
...
$pgv_lang["logged_in_users_descr"]	= "Het «Aangemelde gebruikers» blok toont een lijst met gebruikers die op dat moment zijn aangemeld.";
$pgv_lang["user_messages_block"]	= "Mijn berichten";
$pgv_lang["user_messages_descr"]	= "Het «Mijn berichten» blok toont een lijst met berichten die aan de actieve gebruiker zijn gezonden.";
$pgv_lang["user_favorites_block"]	= "Mijn favorieten";
$pgv_lang["user_favorites_descr"]	= "Het «Mijn favorieten» blok toont de gebruiker een lijst van zijn of haar favoriete personen in de genealogie. Op die wijze kan de gebruiker snel de gegevens van deze personen inzien.";
$pgv_lang["welcome_block"]			= "Welkom";
$pgv_lang["welcome_descr"]			= "Het «Welkom» blok toont de gebruiker de datum en tijd, een directe koppeling naar de eigen gebruikersgegevens en de eigen kwartierstaat.<br />Ook kan de gebruiker de indeling van de eigen MyGedView-pagina wijzigen.";
$pgv_lang["random_media_block"]			= "Willekeurige afbeelding";
$pgv_lang["random_media_descr"]			= "In het «Willekeurige afbeelding» blok wordt een willekeurige foto of ander multimedia-object geselecteerd en aan de gebruiker getoond.";
...
$pgv_lang["gedcom_descr"]				= "In het «GEDCOM welkom» blok wordt de gebruiker welkom geheten en wordt de naam van de actieve genealogie getoond, evenals de datum en tijd.";
$pgv_lang["gedcom_favorites_block"]		= "GEDCOM-favorieten";
$pgv_lang["gedcom_favorites_descr"]		= "In het «GEDCOM-favorieten» blok kan de site-beheerder personen uit de genealogie plaatsen, zodat gebruikers deze makkelijk kunnen vinden.<br />Op die manier worden personen, die in de genealogie belangrijk zijn, gemakkelijk toegankelijk gemaakt.";
$pgv_lang["gedcom_stats_block"]			= "GEDCOM-statistieken";
$pgv_lang["gedcom_stats_descr"]			= "Het «GEDCOM-statistieken» blok toont enkele gegevens over het GEDCOM-bestand, zoals het aantal erin aanwezige personen en de datum waarop het is aangemaakt.";
$pgv_lang["gedcom_stats_show_surnames"]	= "Toon veel voorkomende achternamen?";
$pgv_lang["portal_config_instructions"]	= "~#pgv_lang[customize_page]#~<br />~#pgv_lang[customize_gedcom_page]#~<br /><br />U kunt de pagina aanpassen door de blokken op de pagina te plaatsen zoals u ze wilt.<br /><br />De pagina is onderverdeeld in <b>Hoofd</b> en <b>Rechts</b> secties. De blokken van het <b>Hoofd</b> gedeelte verschijnen groter en onder de paginatitel. De sectie <b>Rechts</b> begint rechts van de titel en gaat naar de rechterkant van de pagina.<br /><br />Elke sectie heeft zijn eigen lijst met blokken die op de pagina worden afgedrukt in de volgorde waarin ze worden vermeld. Je kunt de blokken toevoegen, verwijderen en opnieuw ordenen zoals je wilt.<br /><br />Als een van de blokkeringslijsten leeg is, zullen de resterende blokken de hele breedte van de pagina beslaan.";
$pgv_lang["login_block"]			= "Aanmelden";
$pgv_lang["login_descr"]			= "In het «Aanmelden» blok kunnen bezoekers zich aanmelden met hun gebruikersnaam en wachtwoord.";
$pgv_lang["theme_select_block"]		= "Selecteer een thema";
$pgv_lang["theme_select_descr"]		= "Het «Selecteer een thema» blok geeft een keuzelijst weer, zelfs wanneer dit staat uitgeschakeld in de instellingen.";
$pgv_lang["block_top10_title"]		= "Meest gebruikte achternamen";
$pgv_lang["block_top10"]			= "Meest gebruikte achternamen";
$pgv_lang["block_top10_descr"]		= "Het «Meest gebruikte achternamen» blok geeft een lijst met de meest gebruikte achternamen in de database. Het werkelijk aantal te tonen achternamen in dit blok is instelbaar";
$pgv_lang["block_cookiepolicy"]			= "Cookie beleid";
$pgv_lang["block_cookiepolicy_title"]	= "Cookie beleid";
$pgv_lang["block_cookiepolicy_descr"]	= "Het «Cookie beleid» blok toont de cookie beleid van deze website, zoals vereist word door de EU Cookie Law.";
...
$pgv_lang["block_givn_top10_title"]	= "Meest gebruikte voornamen";
$pgv_lang["block_givn_top10"]		= "Meest gebruikte voornamen";
$pgv_lang["block_givn_top10_descr"]	= "Het «Meest gebruikte voornamen» blok geeft een lijst met de meest gebruikte voornamen in de database.  Het werkelijk aantal te tonen voornamen in dit blok is instelbaar.";

$pgv_lang["gedcom_news_block"]			= "GEDCOM-prikbord";
$pgv_lang["gedcom_news_descr"]			= "Het «GEDCOM-prikbord» blok toont de nieuwsberichten van bezoekers of artikelen die zijn gepubliceerd door een admin-gebruiker.<br /><br />Dit is een goede plek om een belangrijke database-update, een gezinshereniging of de geboorte van een kind aan te kondigen.";
...
$pgv_lang["user_news_block"]		= "Minj notitieblok";
$pgv_lang["user_news_descr"]		= "Op het «Minj notitieblok» blok kan de gebruiker zelf online aantekeningen en notities maken en bewaren.";
...
$pgv_lang["enter_title"]				= "Voer een titel in.";
...
$pgv_lang["recent_changes_descr"]	= "In het «Recente wijzigingen» blok treft u een overzicht aan van alle wijzigingen die in de afgelopen maand zijn aangebracht. De wijzigingen worden getoond aan de hand van de informatie hierover in de persoons- en gezinsinformatie.";
...
//-- Ahnentafel report
$pgv_lang["ahnentafel_report"]		= "Voorouder Rapport";
...
//-- Descendancy report
$pgv_lang["descend_report"]				= "Nakomelingen rapport";
...
$pgv_lang["show_abbr_notes"] 		= "Toon verkorte notities?";
...
//-- RSS Feed
$pgv_lang["rss_descr"]				= "Nieuws en snelkoppelingen op de #GLOBALS[GEDCOM_TITLE]# website";
...
$pgv_lang["stat_301_mf"]			= "geslacht";
$pgv_lang["stat_302_cgp"]			= "perioden";
$pgv_lang["century"]				= "eeuw";
$pgv_lang["stat_age"]				= "Leeftijd";
$pgv_lang["no_date_fam"]			= "onbekend";
$pgv_lang["statar_xgp"]				= "grenswaarden voor perioden:";
$pgv_lang["statar_xgl"]				= "grenswaarden voor leeftijden:";
$pgv_lang["statar_xgm"]				= "grenswaarden voor maand:";
$pgv_lang["statar_xga"]				= "keuzewaarden voor aantallen:";
$pgv_lang["statar_zgp"]				= "grenswaarden voor perioden:";
...
$pgv_lang["TYPE__magazine"] 		= "Tijdschrift";
