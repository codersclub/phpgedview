...
$pgv_lang["birth_M"]				= "#name#in syntymäpäivä";		// For male persons
$pgv_lang["birth_F"]				= "#name#in syntymäpäivä";		// For female persons
$pgv_lang["born_in_M"]				= "Syntynyt #date# #place#";		// For male persons
$pgv_lang["born_in_F"]				= "Syntynyt #date# #place#";		// For female persons
$pgv_lang["born_on_M"]				= "Syntynyt #date#";		// For male persons
$pgv_lang["born_on_F"]				= "Syntynyt #date#";		// For female persons
$pgv_lang["death_M"]				= "#name#in kuoleman vuosipäivä";		// For male persons
$pgv_lang["death_F"]				= "#name#in kuoleman vuosipäivä";		// For female persons
$pgv_lang["died_in_M"]				= "Kuollut #date# #place#";		// For male persons
$pgv_lang["died_in_F"]				= "Kuollut #date# #place#";		// For female persons
$pgv_lang["died_on_M"]				= "Kuollut #date#";		// For male persons
$pgv_lang["died_on_F"]				= "Kuollut #date#";		// For female persons
$pgv_lang["anniversary_of"]			= "#husband# ja #wife# hääpäivä";
$pgv_lang["married_in"]				= "Puoliso #date# #place#";
$pgv_lang["married_on"]				= "Puoliso #date#";
$pgv_lang["clustrmaps_locations"]	= "Tämän sivun kävijöiden sijainnit";
...
$pgv_lang["mail01_line02"]		= "Olemme saaneet pyynnön kirjautua koneeseen (#PGV_SERVER_NAME##PGV_SCRIPT_PATH#) sähköpostiosoitteellasi (#user_email#).";
...
$pgv_lang["mail01_subject"]		= "Kirjoittautumisesi koneella #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["mail02_line01"]		= "Hei ylläpitäjä...";
$pgv_lang["mail02_line02"]		= "Uusi käyttäjä rekisteröityi (#PGV_SERVER_NAME##PGV_SCRIPT_PATH#) lle";
...
$pgv_lang["mail02_subject"]		= "Uusi kirjoittautuminen koneella #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail03_subject"]		= "Uusi vahvistus koneella #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail04_subject"]		= "Tietopyyntö koneelta #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["welcome_text_auth_mode_1"] = "<span class='center'><b>Tervetuloa tähän sukututkimuksen verkkopalveluun</b></span><br />Jokaisella käyttäjällä, jolla on käyttäjätili, on pääsy tänne.<br /><br />Mikäli sinulla on käyttäjätili, voit kirjautua tältä sivulta. Mikäli sinulla ei ole käyttäjätiliä, voit pyytää sellaisen klikkaamalla alla olevaa linkkiä.<br /><br />Todennettuaan pyyntösi ylläpitäjä aktivoi käyttäjätilisi. Saat sähköpostiviestin kun pyyntösi on hyväksytty. ";
$pgv_lang["welcome_text_auth_mode_2"] = "<span class='center'><b>Tervetuloa tähän sukututkimuksen verkkopalveluun.</b></span><br />Pääsy näille sivuille on sallittu vain niille käyttäjille, joille on annettu <b>käyttöoikeus</b>.<br /><br />Mikäli sinulla jo on käyttäjätili, voit kirjautua järjestelmään tällä sivulla. Mikäli sinulla ei ole käyttäjätiliä, voit pyytää sellaista klikkaamalla asianomaista linkkiä tällä sivulla.<br /><br />Varmistuttuaan antamistasi tiedoista ylläpitäjä joko hyväksyy tai hylkää pyyntösi. Tulet saamaan sähköpostiviestin kun pyyntösi on hyväksytty.";
$pgv_lang["welcome_text_auth_mode_3"] = "<span class='center'><b>Tervetuloa tähän sukututkimuksen verkkopalveluun</b></span><br />Pääsy tänne on sallittu ainoastaan <u>sukulaisille</u>.<br /><br />Mikäli sinulla on käyttäjätili voit kirjautua sivustolle. Mikäli sinulla ei vielä ole käyttäjätiliä, voit pyytää sellaista klikkaamalla asianomaista linkkiä tällä sivulla.<br /><br />Tarkistettuaan tietosi sivun ylläpitäjä joko hyväksyy tai hylkää pyyntösi. Saat sähköpostiviestin kun pyyntösi on hyväksytty.";
$pgv_lang["welcome_text_cust_head"]	= "<span class='center'><b>Tervetuloa tähän sukututkimuksen verkkopalveluun</b></span><br />Pääsy on sallittu käyttäjille, joilla on käyttäjätunnus ja salasana tähän verkkopalveluun.<br />";
