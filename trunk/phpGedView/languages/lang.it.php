<?php
/**
 * Italian Language file for PhpGedView.
 *
...
$pgv_lang["charts_block"]			= "Grafici";
$pgv_lang["charts_block_descr"]		= "Il blocco «Grafici» prospetti permette di mettere un Prospetto nella pagina di Benvenuto o nella pagina del portale del File di Famiglia. Puoi anche configurare il blocco per mostrare una vista antenati, discendenti o a clessidra. Puoi anche scegliere la persona default del prospetto";
...
$pgv_lang["duplicate_username"] 	= "Nome utente «#username#» esistente. Per favore, scegli un altro nome utente";
$pgv_lang["usercreate_fail"]		= "Non è possibile aggiungere l'utente «#username#» al sistema.";
...
$pgv_lang["random_media_start_slide"]	= "Avviare la presentazione al caricamento della pagina?";
$pgv_lang["random_media_ajax_controls"]	= "Mostrare i controlli della presentazione?";
...
$pgv_lang["medialist_unlinked"]		= "Mostra solo i media non collegati";
$pgv_lang["medialist_current_dir"]	= "Sottodirectory corrente";
...
$pgv_lang["other_repo_records"]		= "Record che contengono link a questo Archivio";
$pgv_lang["repo_info"]				= "Informazioni Archivio";
...
$pgv_lang["search_prtnames"]		= "Nomi degli individui da stampare";
$pgv_lang["other_searches"]			= "Altre Ricerche";
$pgv_lang["add_to_cart"]		= "Aggiungi al Carrello Ritagli";
$pgv_lang["view_gedcom"]	= "Visualizza il campo GEDCOM";
...
$pgv_lang["zip_files"]				= "Comprimi (zip) i file";
$pgv_lang["include_media"]			= "Includi media (comprimi automaticamente i file)";
$pgv_lang["roman_surn"]				= "Cognome romanizzato";
$pgv_lang["roman_givn"]				= "Nomi dati romanizzati";
...
$pgv_lang["wiki_main_page"]			= "Wiki - Pagina principale";
$pgv_lang["wiki_users_guide"]		= "Wiki - Guida dell'utente";
$pgv_lang["wiki_admin_guide"]		= "Wiki - Guida dell'amministratore";
...
$pgv_lang["label_search_engine_detected"]  = "Rilevato motore di ricerca";
...
$pgv_lang["stat_males"]				= "Numero di maschi";
$pgv_lang["stat_females"]			= "Numero di femmine";
$pgv_lang["stat_unknown"]			= "Numero di sesso ignoto";
...
$pgv_lang["relatives_report"]		= "Rapporto Parenti";
$pgv_lang["total_unknown"]			= "sconosciuto";
$pgv_lang["total_living"]			= "Numero di vivi";
$pgv_lang["total_dead"]				= "Numero di morti";
$pgv_lang["total_not_born"]			= "Numero di nato morto";
...
$pgv_lang["common_upload_errors"]	= "Questo errore significa probabilmente che il file che hai provato a spedire supera la dimensione massima imposta dal tuo host. Il limite di default di PHP è 2MB. Puoi contattare il tuo team di supporto per l'host per far aumentare il limite imposto in php.ini o puoi inviare il file mediante FTP. Usa la pagina <a href=\"uploadgedcom.php?action=add_form\"><b>#pgv_lang[add_gedcom]#</b></a> per inserire un file GEDCOM che hai inviato via FTP.";
$pgv_lang["max_upload_advice"]		= "Se hai bisogno di caricare file più grandi del massimo mostrato qui, l'opzione di configurazione <i>upload_max_filesize</i> nel file <i>php.ini</i> sul server deve essere regolata. Potrebbe essere necessario consultare il supporto del server.";
...
$pgv_lang["total_names"]			= "Numero di Nomi";
$pgv_lang["total_changes"]			= "Numero di variazioni";
$pgv_lang["total_links"]			= "Numero di collegamenti";
...
$pgv_lang["top10_pageviews_descr"]	= "Questo blocco mostra i record che sono stati visualizzati di più. Questo blocco richiede che il conteggio dei click sia abilitato nelle impostazioni di configurazione del file di famiglia.";
...
$pgv_lang["invalid_username"]  		= "Lo nome utente «#username#» contiene caratteri non validi";
...
$pgv_lang["admin"] 	= "Amministrazione";
...
$pgv_lang["rootid"] 				   = "Persona Radice dell'albero genealogico";
...
$pgv_lang["individual_list"]				= "Elenco delle Persone";
$pgv_lang["family_list"]					= "Elenco delle Famiglie";
$pgv_lang["branch_list"]			= "Rami";
$pgv_lang["source_list"]					= "Elenco delle Fonti";
...
$pgv_lang["media_list"]					= "Elenco degli Oggetti Multimediali";
$pgv_lang["repo_list"]					= "Elenco Archivi";
$pgv_lang["search"]						= "Cerca";
$pgv_lang["clippings_cart"]				= "Carrello Ritagli dell'Albero Genealogico";
$pgv_lang["print_preview"]				= "Semplifica pagina";
$pgv_lang["cancel_preview"] 			= "Vista normale";
$pgv_lang["change_lang"]				= "Cambia Lingua";
$pgv_lang["language"]					= "Lingua";
$pgv_lang["print"]						= "Stampa";
$pgv_lang["total_queries"]			= "Numero di Query al Database";
$pgv_lang["total_privacy_checks"]	= "Numero di controlli privacy:";
...
$pgv_lang["temple"]				= "Tempio della Chiesa SDG";
$pgv_lang["temple_code"]		= "Codice della Chiesa SDG:";
$pgv_lang["status"]				= "Stato";
$pgv_lang["source"]				= "Fonte:";
$pgv_lang["text"]					= "Testo:";
$pgv_lang["note"]					= "Nota";
$pgv_lang["NN"] 				= "(Cognome sconosciuto)";		// Family name
$pgv_lang["PN"] 				= "(Nome sconosciuto)";			// Given name
...
$pgv_lang["NNother"] 			= "(Cognome sconosciuto)";
$pgv_lang["PNother"] 			= "(Nome sconosciuto)";
...
$pgv_lang["given_name"]		= "Nomi dati";
$pgv_lang["surname"]			= "Cognome";
$pgv_lang["sex"]						= "Sesso";
$pgv_lang["personal_details"]		= "Dettagli personali";
...
$pgv_lang["lds_sealing"]				= "Suggellatura SDG:";
...
$pgv_lang["parents_timeline"]			= "Mostra i genitori sulla tabella temporale";
...
$pgv_lang["empty_cart"]				= "Svuota il carrello";
...
$pgv_lang["convertPath"]			= "Converti il percorso degli oggetti multimediali";
$pgv_lang["convertSlashes"]		= "Converti i separatori della cartella degli oggetti media";
$pgv_lang["forwardSlashes"]		= "Slash in avanti : /";
$pgv_lang["backSlashes"]			= "Slash all'indietro : \\";

//-- PLACELIST FILE MESSAGES
$pgv_lang["connections"]				= "Trovate connessioni a questi luoghi Visualizzare i risultati";
...
$pgv_lang["total_unic_places"]			= "Numero di luoghi unici";
...
$pgv_lang["soundex_search"]			= "Cerca il nome come pensi che si scriva (Soundex):";
...
$pgv_lang["search_russell"]			= "Semplice";
...
$pgv_lang["repos_found"]			= "Archivio trovato";
$pgv_lang["find_repository"]		= "Trova Archivio";
$pgv_lang["total_repositories"]		= "Numero di Archivi";
$pgv_lang["confirm_delete_repo"]	= "Sei sicuro di voler eliminare questo archivio?";

//-- SOURCE FILE MESSAGES
$pgv_lang["source_info"]			= "Informazioni sulla Fonte";
$pgv_lang["people"]					= "Persone";
$pgv_lang["families"]				= "Famiglie";
$pgv_lang["total_sources"]			= "Numero di Fonti";
...
$pgv_lang["total_shared_notes"]			= "Numero di note condivise";
...
$pgv_lang["total_fams"]				= "Numero di Famiglie";
$pgv_lang["total_indis"]			= "Numero di Persone";
$pgv_lang["notes"]					= "Note";
...
$pgv_lang["firstname_alpha_index"] 	= "Indice alfabetico nomi dati";
...
$pgv_lang["add_another"]			= "Aggiungere un'altra persona al diagramma";
...
$pgv_lang["serverTime"]				= "Ora del server";
$pgv_lang["localTime"]				= "Ora locale";
...
//-- Admin File Messages
$pgv_lang["email_invalid"]			= "Indirizzo email non valido.";
...
$pgv_lang["utf8_to_ansi"]			= "Convertire da UTF-8 a ANSI (ISO 8859-1)";
...
$pgv_lang["thumb_dir_1"]			= "Questa miniatura è situato su un server esterno";
$pgv_lang["thumb_dir_2"]			= "Questa miniatura è nella cartella standard dei media";
$pgv_lang["thumb_dir_3"]			= "Questa miniatura è nella cartella media protetta";
...
$pgv_lang["access_denied"]			= "<b>Accesso negato</b> Non hai accesso a questa risorsa";
...
$pgv_lang["year_yahrzeit"]			= "#yahrzeit_date#, #yahrzeit# yahrzeit di #event_date#";
$pgv_lang["today"]					= "Oggi";
$pgv_lang["day"]					= "Giorno";
$pgv_lang["month"]					= "Mese:";
...
$pgv_lang["siteadmin"]				= "Amministratore PhpGedView";
$pgv_lang["PGV_program"]			= "Programma PhpGedView";
...
$pgv_lang["mail01_line02"]			= "Il nostro sito #PGV_SERVER_NAME##PGV_SCRIPT_PATH# ha ricevuto una richiesta per la creazione di un account con il tuo indirizzo email «#user_email#».";
...
$pgv_lang["mail01_subject"] 		= "La tua registrazione a #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["mail02_line01"]			= "Ciao Amministratore ...";
$pgv_lang["mail02_line02"]			= "Un aspirante utente si e' registrato al sito #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["mail02_subject"] 		= "Nuova registrazione a #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["hashcode"]				= "Codice di verifica:";
$pgv_lang["thankyou"]				= "Ciao #user_fullname# ... Grazie per la tua registrazione";
$pgv_lang["pls_note06"] 			= "Manderemo ora una mail di conferma all'indirizzo <b>#user_email#</b>.<br /><br />Devi verificare l'account richiesto seguendo le istruzioni nel messaggio di conferma. Se non effettuerai questa verifica entro sette giorni, il tuo account sarà cancellato automaticamente, e dovrai registrarti di nuovo.<br /><br />Dopo che avrai seguito le istruzioni nella mail di conferma, l'amministratore dovrà approvare la tua richiesta prima che tu possa utilizzare il tuo account.<br /><br />Per collegarti al sito, devi ricordare l'username e la password.";
...
$pgv_lang["mail03_subject"] 		= "Nuovo utente a #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
...
$pgv_lang["data_incorrect"]			= "I dati non sono stati coretti! Per favore riprova!";
...
$pgv_lang["mail04_subject"] 		= "Nuova password a #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["pwreqinfo"]				= "Salve ...<br /><br />Una e-mail con la nuova password è stata inviata all'indirizzo registrato per <b>#user[email]#</b>.<br /><br />Per favore, controlla la posta, dovresti ricevere il nostro messaggio entro pochi secondi.<br /><br />Raccomandazione: Dovresti accedere al sito il prima possibile con la nuova password e cambiarla per mantenere la sicurezza dei dati.";
...
$pgv_lang["welcome_text_auth_mode_1"]	= "<span class='center'><b>Benvenuti in questo Sito Genealogico</b></span><br />L'accesso a questo sito è permesso a tutti i visitatori in possesso di un account utente.<br /><br />Se hai già un account utente, puoi autenticarti in questa pagina. Se non hai ancora un account utente, puoi chiederne uno facendo clic sull'apposito link qui sotto.<br /><br />Dopo aver verificato la tua registrazione, l'amministratore attiverà il tuo account. Riceverai una e-mail quando la tua richiesta sarà stata approvata.";
$pgv_lang["welcome_text_auth_mode_2"]	= "<span class='center'><b>Benvenuti in questo Sito Genealogico</b></span><br />L'accesso a questo sito è permesso ai soli <u>utenti autorizzati</u>.<br /><br />Se sei già registrato, puoi effettuare il login da questa pagina. Se non sei ancora registrato, puoi richiedere un account utente cliccando sul link qui sotto.<br /><br />Dopo aver verificato il tuo account, l'amministratore approverà o rifiuterà la tua richiesta. Riceverai una e-mail quando la tua richiesta di registrazione sarà stata approvata.";
$pgv_lang["welcome_text_auth_mode_3"]	= "<span class='center'><b>Benvenuti in questo Sito Genealogico</b></span><br />L'accesso a questo sito è permesso ai soli <u>membri della famiglia</u>.<br /><br />Se sei già registrato, puoi effettuare il login da questa pagina. Se non sei ancora registrato, puoi richiedere un account utente cliccando sul link qui sotto.<br /><br />Dopo aver verificato il tuo account, l'amministratore approverà o rifiuterà la tua richiesta. Riceverai una e-mail quando la tua richiesta di registrazione sarà stata approvata.";
$pgv_lang["welcome_text_cust_head"] 	= "<span class='center'><b>Benvenuti in questo Sito Genealogico</b></span><br />L'accesso a questo sito è permesso solo agli utenti in possesso di un account e di una password per questo sito.";
...
$pgv_lang["more_events_privacy"]	= "Ci sono ulteriori eventi per i prossimi #pgv_lang[global_num1]# giorni, ma restrizioni privacy ti impediscono di vederli.";
$pgv_lang["more_events_privacy1"]	= "Esistono ulteriori eventi, per domani, ma restrizoni privacy ti impediscono di vederli.";
...
$pgv_lang["more_today_privacy"]		= "Ulteriori eventi previsti per oggi, ma restrizioni privacy ti impediscono di vederli.";
$pgv_lang["chat"]					= "Chat";
...
$pgv_lang["message_from_name"]		= "Mittente:";
...
$pgv_lang["message_sent"]		= "Messaggio inviato a #TO_USER#";
$pgv_lang["message_failed"]		= "Impossibile inviare il messaggio";
$pgv_lang["message_error"]		= "Errore PHPMailer: ";
$pgv_lang["message_invalid_from"]	= "Indirizzo del mittente non valido: &laquo;#email#&raquo;";
$pgv_lang["message_invalid_to"]		= "Indirizzo del destinatario non valido: &laquo;#email#&raquo;";
$pgv_lang["message_illegal_chars"]	= "Caratteri illegali nell'indirizzo &laquo;#email#&raquo;";
$pgv_lang["message_bad_format"]		= "L'indirizzo &laquo;#email#&raquo; non è formattato correttamente";
$pgv_lang["message_no_MX"]			= "Il dominio dell'indirizzo &laquo;#email#&raquo non esiste o non dispone di un record MX";
...
$pgv_lang["no_favorites"]			= "Non hai selezionato nessun preferito. Per aggiungere una persona ai tuoi preferiti, cerca i dettagli della persona che vuoi aggiungere e clicca su <b>#pgv_lang[add_favorite]#</b>, oppure usa il metodo di ricerca per ID.";
...
$pgv_lang["preferred_lang"] 		= "La lingua preferita di questo utente è #USERLANG#.";
$pgv_lang["gedcom_created_using"]	= "Il file GEDCOM è stato creato usando <b>#CREATED_SOFTWARE# #CREATED_VERSION#</b>";
$pgv_lang["gedcom_created_on"]		= "Il file GEDCOM è stato creato il <b>#CREATED_DATE#</b>";
$pgv_lang["gedcom_created_on2"] 	= " il <b>#CREATED_DATE#</b>";
...
$pgv_lang["todays_events_descr"]	= "Il blocco «In questo giorno» mostra anniversari di eventi per oggi. Puoi configurare il numero di dettagli mostrati.";
$pgv_lang["todo_block"] = "Compiti da fare";
$pgv_lang["todo_descr"] = "Il blocco «Compiti da fare» elenca tutti i lavori da fare presenti nel database";
$pgv_lang["todo_show_other"] 	= "Mostra i compiti degli altri utenti";
$pgv_lang["todo_show_unassigned"]= "Visualizza i compiti non assegnati";
$pgv_lang["todo_show_future"]	= "Visualizza futuri compiti";
$pgv_lang["todo_nothing"]		= "Non ci sono compiti da fare.";
$pgv_lang["yahrzeit_block"]			= "Yahrzeiten";
$pgv_lang["yahrzeit_descr"]			= "Il blocco «Yahrzeiten» mostra gli anniversari dei morti che si verificheranno nel prossimo futuro. Puoi configurare il periodo mostrato e l'amministratore può configurare quanto lungo sarà questo periodo";
...
$pgv_lang["user_messages_block"]	= "I miei messaggi";
$pgv_lang["user_messages_descr"]	= "Il blocco «I miei messaggi» mostra una lista dei messaggi che sono stati inviati all'utente attivo";
$pgv_lang["user_favorites_block"]	= "I miei preferiti";
$pgv_lang["user_favorites_descr"]	= "Il blocco «I miei preferiti» mostra all'utente una lista delle sue persone favorite nel database, in modo da poter facilmente collegarsi ad essi";
$pgv_lang["welcome_block"]			= "Benvenuto";
$pgv_lang["welcome_descr"]			= "Il blocco «Benvenuto» mostra all'utente la data e l'ora corrente, collegamenti veloci per modificare il proprio profilo o per andare al suo Prospetto Pedigree e un collegamento per personalizzare la sua pagina di accesso";
...
$pgv_lang["gedcom_descr"]			= "Il blocco «Benvenuti GEDCOM» funziona alla stessa maniera del blocco Benvenuto Utente. Saluta il visitatore al sito e mostra il titolo del database attivo corrente, così come la data e l'ora correnti";
$pgv_lang["gedcom_favorites_block"] = "Favoriti GEDCOM";
...
$pgv_lang["block_top10_title"]		= "Cognomi più frequenti";
$pgv_lang["block_top10"]			= "Cognomi più frequenti";
$pgv_lang["block_top10_descr"]		= "Il blocco «Cognomi più frequenti» mostra una tabella di cognomi più frequenti nel database. Il numero effettivo di cognomi mostrato in questo blocco è configurabile. È possibile configurare il GEDCOM per rimuovere i nomi di questo elenco.";
$pgv_lang["block_cookiepolicy"]			= "Politica sui Cookie";
$pgv_lang["block_cookiepolicy_title"]	= "Politica sui Cookie";
$pgv_lang["block_cookiepolicy_descr"]	= "Il blocco «Politica sui Cookie» mostra la politica sui cookie adottata da questo sito, come richiesto dalla normativa europea sui cookie (Cookie Law).";
$pgv_lang["block_cookiepolicy_body"]	= "<span class='warning'>Questo avviso è richiesto dalla normativa europea sui cookie (Cookie Law).</span><br /><br />Questo sito fa del suo meglio per non usare cookie, e lo fa solo quando tecnicamente necessario. Nessuna informazione personale, nemmeno l'userid o la password, viene mai salvata in cookie creati da questo sito.<br /><br />Per ragioni tecniche al di là del controllo di questo sito, questi cookie non sono cancellati quando si termina la sessione su questo sito. Comunque, essi vengono eliminati immediatamente quando si chiude il browser.";
...
$pgv_lang["block_givn_top10_title"]		= "Nomi propri più frequenti";
$pgv_lang["block_givn_top10"]			= "Nomi propri più frequenti";
$pgv_lang["block_givn_top10_descr"]		= "Il blocco «Nomi propri più frequenti» mostra una tabella dei nomi propri più frequenti. L'effettivo numero dei nomi propri mostrato in questo blocco è configurabile.";

$pgv_lang["gedcom_news_block"]		= "Notizie GEDCOM";
$pgv_lang["gedcom_news_descr"]		= "Il blocco «Notizie GEDCOM» mostra al visitatore le notizie o gli articoli inseriti da un utente amministratore.<br /><br />Il blocco News è un buon posto per annunciare aggiornamenti significativi, riunioni familiari, nascita di bambini ecc.";
...
$pgv_lang["gedcom_news_published"]	= "Pubblicato : ";
$pgv_lang["gedcom_news_archive"] 	= "Vedi archivio";
$pgv_lang["user_news_block"]		= "Il mio diario";
$pgv_lang["user_news_descr"]		= "Il blocco «Il mio diario» permette agli utenti di tenere note o un diario on line";
$pgv_lang["my_journal"] 			= "Il mio diario";
$pgv_lang["no_journal"] 			= "Non hai creato alcuna voce diario";
$pgv_lang["confirm_journal_delete"] = "Sei sicuro di voler eliminare questa voce di diario?";
$pgv_lang["add_journal"]			= "Aggiungi una nuova voce di diario";
...
$pgv_lang["default_news_text"]		= "Le informazioni sulla genealogia su questo sito web sono fornite da <a href=\"http://www.phpgedview.net/\" target=\"_blank\">PhpGedView</a>. Questa pagina fornisce un'introduzione e una panoramica a questa genealogia.<br /><br />Per iniziare a lavorare con i dati, scegli uno dei grafici dal menu Grafici, vai all'elenco Individuale o cerca un nome o un luogo.<br /><br />In caso di problemi nell'utilizzo del sito, è possibile fare clic sull'icona della Guida per fornire informazioni su come utilizzare la pagina attualmente visualizzata.<br /><br />Grazie per visitando questo sito.";
$pgv_lang["reset_default_blocks"]	= "Reset ai blocchi standard";
$pgv_lang["recent_changes"] 		= "Modifiche recenti";
$pgv_lang["recent_changes_block"]	= "Modifiche recenti";
$pgv_lang["recent_changes_descr"]	= "Il blocco «Modifiche recenti» elencherà tutte le modifiche che sono state fatte alla base dati nell'ultimo mese. Questo blocco può aiutare a rimanere aggiornati dei cambiamenti che sono stati fatti. Le modifiche vengono rilevate automaticamente utilizzando il tag CHAN definito nel linguaggio GEDCOM standard";
...
//-- report engine
$pgv_lang["choose_report"]			= "Seleziona un rapporto da generare";
$pgv_lang["enter_report_values"]	= "Inserisci i valori del rapporto";
$pgv_lang["selected_report"]		= "Rapporto Selezionato";
$pgv_lang["select_report"]			= "Seleziona Rapporto";
$pgv_lang["download_report"]		= "Scarica Rapporto";
$pgv_lang["reports"]				= "Rapporti";
$pgv_lang["pdf_reports"]			= "Rapporti in PDF";
$pgv_lang["html_reports"]			= "Rapporti HTML";

//-- Ahnentafel report
$pgv_lang["ahnentafel_report"]		= "Rapporto Ahnentafel";
...
$pgv_lang["ahnentafel_cremated_m"]	= "è stato cremato";		// male
$pgv_lang["ahnentafel_cremated_f"]	= "è stata cremata";		// female
...
$pgv_lang["changes_pending_tot"]	= "Numero di modifiche in attesa:";
$pgv_lang["changes_accepted_tot"]	= "Numero di modifiche accettate:";
...
$pgv_lang["family_group_report"]	= "Rapporto Famiglia";
...
$pgv_lang["individual_report"]		= "Rapporto persona";
...
$pgv_lang["birth_report"]			= "Rapporto Data e Luogo di nascita";
...
//-- RSS Feed
$pgv_lang["rss_descr"]				= "Notizie e collegamenti dal sito #GLOBALS[GEDCOM_TITLE]#";
...
$pgv_lang["statnnames"]			= "Numero di persone";
$pgv_lang["statnfam"]			= "Numero di famiglie";
$pgv_lang["statnmale"]			= "Numero di maschi";
$pgv_lang["statnfemale"]		= "Numero di femmine";
...
$pgv_lang["stat_17_arb"]		= "Anno di nascita";
$pgv_lang["stat_18_ard"]		= "Età alla morte";
$pgv_lang["stat_18_aard"]		= "Età media alla morte";
$pgv_lang["stat_19_arm"]		= "Età al matrimonio";
$pgv_lang["stat_19_aarm"]		= "Età media al matrimonio";
$pgv_lang["stat_20_arm1"]		= "Età al primo matrimonio";
...
$pgv_lang["statnliving"]		= "Numero di vivi";
$pgv_lang["statndead"]			= "Numero di morti";
$pgv_lang["stat_births"] = "Numero di nascite";
$pgv_lang["stat_marriages"] = "Numero di matrimoni";
$pgv_lang["stat_divorces"] = "Numero di ivorzi";
$pgv_lang["stat_deaths"] = "Numero di morti";
...
$pgv_lang["statnsurnames"] = "Numero di cognomi";
$pgv_lang["statngivennames"] = "Numero di nomi";
