...
$pgv_lang["AUTO_GENERATE_THUMBS_help"]	= "|~#pgv_lang[AUTO_GENERATE_THUMBS]#~<br /><br />Systém by mal automaticky generovať náhľady pre obrázky, ktoré ich nemajú. Vaša PHP inštalácia nepodporuje túto funkčnosť.";
$pgv_lang["phpinfo_help"]		= "~#pgv_lang[phpinfo]#~<br /><br />Táto stránka poskytuje rozšírené informácie o servere na ktorom je hostovaný  PhpGedView. Veľa konfiguračných detailov o softvare na servere, ktorý je relevantný pre PHP a PhpGedView, môže byť zobrazených.";
$pgv_lang["config_help_help"]		= "~#pgv_lang[config_help]#~<br /><br />Táto stránka odsahuje hlavné položky nápovedy Konfigurácie. Môžete si infiormácie zobraziť, alebo vytlačiť pre neskoršie použitie.";
...
$pgv_lang["THUMBNAIL_WIDTH_help"]	= "~#pgv_lang[THUMBNAIL_WIDTH]#~<br /><br />Toto je šírka (v pixeloch) ktorú program použije keď automaticky generuje náhľady. Implicitné nastavenie je 100.";
...
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] 	= "~#pgv_lang[SHOW_RELATIVES_EVENTS]#~<br /><br />Narodenia, sobáše a úmrtia príbuzných sú dôležité udalosti v živote. Táto voľba riadi či sú alebo nie sú zobrazené tieto udalosti na záložke  <i>Osobné údaje a detaily</i> na stránke osoby.<br /><br />Udalosti ovplyvnené touto voľbou sú:<ul><li>Úmrtie partnera</li><li>Narodenie a úmrtie detí</li><li>Úmrtie rodičov</li><li>Narodenie a úmrtie súrodencov</li><li>Úmrtie starých rodičov</li><li>Narodenie a úmrtie súrodencov rodičov</li></ul>";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]    	= "Automaticky ukázať zoznam udalostí";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] 	= "~#pgv_lang[EXPAND_RELATIVES_EVENTS]#~<br /><br />Táto voľba určuje či bude alebo nebude automaticky zobrazený obsah zoznamu <i>Udalosti blízkych príbuzných</i>.";
$pgv_lang["EXPAND_SOURCES"]      		= "Automaticky zobraziť zdroje";
$pgv_lang["EXPAND_SOURCES_help"] 		= "~#pgv_lang[EXPAND_SOURCES]#~<br /><br />Táto voľba určuje či bude alebo nebude automaticky zobrazený obsah záznamov  <i>Zdroje</i> na stránke osoby.";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]	= "~#pgv_lang[EDIT_AUTOCLOSE]#~<br /><br />Táto voľba riadi či bude, alebo nebude automaticky zatvorené editačné okno po úspešnom uložení zmien.";
...
$pgv_lang["POSTAL_CODE_help"] 		= "~#pgv_lang[POSTAL_CODE]#~<br /><br />Rôzne krajiny používajú rôzne spôsoby zápisu adries. Táto voľba vám umožňuje nastaviť umiestnenie PSČ buď pred, alebo za meno mesta.";
$pgv_lang["SUBLIST_TRIGGER_I"]		= "Maximálny počet priezvísk";
$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "~#pgv_lang[SUBLIST_TRIGGER_I]#~<br /><br />Dlhý zoznam osôb s rovnakým priezviskom môže byť rozdelený na menšie podľa prvého písmena v mene osôb.<br /><br />Táto voľba určuje kedy sa zobrazí rozdelený zoznam. Nastavte hodnotu na nulu, ak chcete rozdelenie úplne vypnúť.";
$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maximálny počet priezvísk rodin";
$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "~#pgv_lang[SUBLIST_TRIGGER_F]#~<br /><br />Dlhý zoznam rodín s rovnakým priezviskom môže byť rozdelený na menšie podľa prvého písmena v mene osôb.<br /><br />Táto voľba určuje kedy sa zobrazí rozdelený zoznam. Nastavte hodnotu na nulu, ak chcete rozdelenie úplne vypnúť.";
...
$pgv_lang["SHOW_LAST_CHANGE_help"]	= "~#pgv_lang[SHOW_LAST_CHANGE]#~<br /><br />Táto voľba riadi či sa má, alebo nemá zobraziť zoznam GEDCOM záznamov s posledným dátumom zmeny.";
...
$pgv_lang["SHOW_MEDIA_FILENAME_help"]	= "~#pgv_lang[SHOW_MEDIA_FILENAME]#~<br /><br />Media Viewer môže zobraziť mená súborov Médií, keď sú zobrazené. Táto voľba určuje či uživatelia uvidia mená súborov alebo nie.<br /><br />Môžete ukryť mená súborov z dôvodu ochrany.";
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Zobraziť linky v  Media Viewer";
$pgv_lang["SHOW_MEDIA_DOWNLOAD_help"]	= "~#pgv_lang[SHOW_MEDIA_DOWNLOAD]#~<br /><br />Media Viewer môže zobraziť linky, kliknutím na ne môžete načítať súbory médií na lokálne PC.<br /><br />Môžete ukryť linky z dôvodu ochrany.";
...
$pgv_lang["SHOW_FACT_ICONS_help"]	= "~#pgv_lang[SHOW_FACT_ICONS]#~<br /><br />Nastavte na <b>#pgv_lang[yes]#</b> pre zobrazenie ikon vedľa mena údaja na stránke #pgv_lang[personal_facts]#. Ikony údajov budú zobrazené iba vtedy, ak existujú v adresári <i>images/facts</i> pre aktuálny motív.";
...
$pgv_lang["return_editconfig"]			= "Ku konfigurovaniu sa môžete kedykoľvek vrátiť, keď otvoríte v prehliadači súbor <i>edit_config.php</i> alebo kliknete na odkaz <b>Konfigurácia</b> na stránke <b>#pgv_lang[gedcom_adm_head]#</b>";
$pgv_lang["return_editconfig_gedcom"]		= "Ku konfigurovaní sa môžete kedykoľvek vrátiť kliknutím na odkaz: <b>Upraviť</b> v tabuľke <b>#pgv_lang[current_gedcoms]#</b> alebo na stránke <b>#pgv_lang[gedcom_adm_head]#</b> alebo otvorením súboru </i>editconfig_gedcom.php</i> vo svojom prehliadači.";
...
$pgv_lang["language_to_edit_help"]	= "~#pgv_lang[language_to_edit]#~<br /><br />V tomto zozname vyberte jazyk, kterého texty chcete editovať.";
...
$pgv_lang["language_to_export_help"]	= "~#pgv_lang[language_to_export]#~<br /><br />Z tohoto zoznamu si môžete vybrať jazyk, ktorého texty chcete exportovať.<br /><br />Program exportuje iba obsah súboru <i>configure_help_text.php</i>. Výstupom je HTML súbor, ktorý si môžete vytlačť z vašeho prehliadača.";
...
$pgv_lang["new_language_help"]		= "~#pgv_lang[new_language]#~<br /><br />Tu môžete zvoliť jazyk, ktorého správy chcete porovnať so správami iného jazyka.<br/><br/>Všetky zmeny a doplnky sa robia najskôr v <b>anglických</b> jazykových súboroch.";
...
$pgv_lang["restore_faq_edits_help"] 	= "~#pgv_lang[restore_faq_edits]#~<br />Táto voľba obnoví stránku FAQ do režimu ako ju vidí obvykle administrátor, tak že jednotlivé položky FAQ môžu byť editované.";
$pgv_lang["add_faq_item"] 		= "Pridať položku FAQ";
$pgv_lang["add_faq_item_help"] 		= "~#pgv_lang[add_faq_item]#~<br />Táto voľba vám umožňuje pridať položku na stránku FAQ.";
$pgv_lang["edit_faq_item"] 		= "Upraviť položku FAQ";
$pgv_lang["edit_faq_item_help"] 	= "~#pgv_lang[edit_faq_item]#~<br />Táto voľba vám umožňuje upraviť položku na stránke FAQ.";
$pgv_lang["delete_faq_item"] 		= "Zmazať položku FAQ";
$pgv_lang["delete_faq_item_help"] 	= "~#pgv_lang[delete_faq_item]#~<br />Táto voľba vám umožňuje zmazať položku na stránke FAQ";
...
$pgv_lang["add_faq_header_help"] 	= "~FAQ Hlavička~<br />Tu je titulok, alebo predmet položky FAQ.<br /><br />Text môže byť formátovaný; HTML tagy ako <b> a <br> sú povolené, rovnako HTML entity ako  & a &nbsp;. Nie je tu žiadna možnosť zadať tagy tak, aby boli interpretované ako text.";
$pgv_lang["add_faq_body_help"] 		= "~FAQ telo~<br />Tu je vložený text položky FAQ.<br /><br />Text môže byť formátovaný; HTML tagy ako  <b> a <br> sú povolené, rovnako HTML entity ako  &amp; a &nbsp;. Nie je tu žiadna možnosť zadať HTML tagy tak aby boli interpretované ako text.";
...
$pgv_lang["add_faq_visibility_help"] = "~#pgv_lang[add_faq_visibility]#~<br />Môžete určiť či FAQ bude zobrazené nbez ohľadu na GEDCOMe, alebo či bude zobrazné iba z aktuálnym GEDCOMom.<br /><ul><li><b>#pgv_lang[all]#</b>&nbsp;&nbsp;&nbsp;FAQ bude zobrazené na zozname všetkých FAQ, bez ohľadu na GEDCOM.</li><li><b>#GLOBALS[GEDCOM]#</b>&nbsp;&nbsp;&nbsp;FAQ bude zobrazené iba na zozname FAQ aktuálneho aktívneho GEDCOMu.</li></ul>";
...
$pgv_lang["LANG_SELECTION_help"]	= "~#pgv_lang[LANG_SELECTION]#~<br /><br />Môžete zmeniť zoznam jazykov podporovaných vašimi PhpGedView stránkami označením alebo odznačením príslušného jazyka. Vaši uživatelia si potom môžu vyberať jazyk.<br /><br />To isté môžete urobiť pomocou linku <b>#pgv_lang[enable_disable_lang]#</b> v menu #pgv_lang[admin]#, kde tiež môžete meniť nastavenia ako je ikona zástavy jazyka, formát datumu alebo či má byť zobrazované priezvisko ako prvé.";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Média&nbsp;ID prefix";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "~#pgv_lang[MEDIA_ID_PREFIX]#~<br /><br />Keď je pridaný online nový mediálny záznam do PhpGedView je automaticky generované ID. Toto ID bude mať zadaný prefix.";
...
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />Prečítajte si vo Wiki popis ako použiť Media Firewall. <a href=\"http://wiki.phpgedview.net/en/index.php/Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php/Media_Firewall</a>";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Koreňový adresár Media Firewallu";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Adresár v ktorom môže byť založený zabezpečený adresár Médií. Ak je toto pole prázdne, tak bude použitý adresár <b>#GLOBALS[INDEX_DIRECTORY]#</b>.";
...
$pgv_lang["COMMIT_COMMAND_help"] 	= "~#pgv_lang[COMMIT_COMMAND]#~<br /><br />Ak si želáte použiť riadenie verzií ako napríklad CVS na archiváciu zmien vo vašom GEDCOMe, konfigurácie alebo nastavenia utajenia, zadajte príkaz sem. Ponechajte box prázdny ak nechcete použiť systém riadenia verzií. Platné voľby sú <b>cvs</b> and <b>svn</b>.";
