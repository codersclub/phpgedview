...
$pgv_lang["enter_banexpiry"]					= "Wprowadź datę i godzinę zniesienia odmowy dostępu, np.:<br />2012.12.31@23:59";
...
##$pgv_lang["USE_PIWIK_ANALYTICS"]				= "Activate Matomo Analytics?";
##$pgv_lang["PGV_PIWIK_URL"]						= "Matomo Analytics server URL";
##$pgv_lang["PGV_PIWIK_SITE"]						= "Matomo Analytics site number";
...
$pgv_lang["mod_admin_intro"]		= "Poniżej znajduje się lista wszystkich modułów zainstalowanych w tej wersji PhpGedView. Moduły są instalowane poprzez zapisanie ich w katalogu <b>modules</b>. Tutaj można ustawić poziom dostępu do każdego modułu w zaleznosci od pliku GEDCOM. Jeśli moduł zawiera zakładki do strony informacji o osobie lub obiekty menu, można również ustawić poziom dostępu, jak równiez ich kolejność.";
...
$pgv_lang["ret_module_admin"]		= "Wróć do strony administracyjnej modułu";
...
$pgv_lang["cannot_change_timelimit_instr"] = "Możesz nie byc w stanie uruchomić wszystkich funkcji na dużych plikach GEDCOM z dużą ilością osób.";
...
$pgv_lang["cannot_use_dom"]			= "Brak biblioteki DOM XML. Nie będzie można eksportować do XML-a.";
...
$pgv_lang["warning_instr"]			= "Jeżeli występują jakieś ograniczenia, nadal możesz uruchomić PhpGedView na tym serwerze, ale niektóre funkcje mogą byc wyłączone lub jakość ich działania może być niezadowalająca.";

$pgv_lang["associated_files"]					= "Powiązane pliki:";
$pgv_lang["remove_all_files"]					= "Usuń wszystkie niepotrzebne pliki";
$pgv_lang["warn_file_delete"]					= "Ten plik zawiera ważne informacje takie jak ustawienia języka lub jeszcze niezatwierdzone zmiany danych. Czy jesteś pewien, by go usunąć?";
$pgv_lang["deleted_files"]						= "Usunięte pliki:";
$pgv_lang["index_dir_cleanup_inst"]				= "Aby usunąć plik lub podkatalog z katalogu Index przesuń go do kosza, lub zaznacz. Kliknij przycisk: Usuń, aby trwale usunąć wybrane pliki.<br /><br />Pliki zaznaczone <img src=\"./images/RESN_confidential.gif\" alt=\"\" /> są wymaganymi do prawidłowego działania i nie mogą byc usunięte.<br />Pliki zaznaczone <img src=\"./images/RESN_locked.gif\" alt=\"\" /> zawierają ważne ustawienia oraz zmiany niezatwierdzone jeszcze przez administratora. Bez absolutnej pewności nie usuwaj ich.<br /><br />";
...
$pgv_lang["sanity_warn5"]						= "Brak biblioteki DOM XML. PhpGedView będzie nadal działać, ale niektóre możliwosci, takie jak Eksport Gramps w Wycinkach, pobieranie plików i usługi webowe nie będą dostępne. Wiecej informacji: <a href='http://www.php.net/manual/en/ref.domxml.php'>http://www.php.net/manual/en/ref.domxml.php</a>.";
$pgv_lang["sanity_warn6"]						= "Brak biblioteki Calendar. PhpGedView będzie nadal działac, jednak niektóre możliwości, takie jak konwersja dat do innych kalendarzy (np. hebrajskiego lub francuskiego), nie będą dostępne. Ta biblioteka nie jest kluczowa do uruchomienia PhpGedView. Wiecej informacji: <a href='http://www.php.net/manual/en/ref.calendar.php'>http://www.php.net/manual/en/ref.calendar.php</a>.";
...
$pgv_lang["full_name"]				= "Imię i nazwisko"; //this is correct for persons but it seems that it is used also for institutions (e.g. repo)
...
$pgv_lang["link_exists"]			= "To powiązanie już istnieje";
...
$pgv_lang["head"]					= "Głowa";
$pgv_lang["id_empty"]				= "Podczas dodawania powiązania, pole identyfikatora nie może byc puste.";
...
$pgv_lang["no_thumb_dir"]			= "Katalog miniaturek nie istnieje, nie powiodło się utworzenie go.";
$pgv_lang["folder_created"]			= "Utworzono katalog";
$pgv_lang["folder_no_create"]		= "Nie powiodło się tworzenie katalogu";
...
$pgv_lang["admin_geds"]				= "Zarządzanie danymi i plikami GEDCOM";
...
$pgv_lang["ansi_to_utf8"]			= "Czy przekodować plik GEDCOM z ANSI do UTF-8?";
...
$pgv_lang["unsync_warning"]			= "Ten plik GEDCOM <em>nie</em> jest zsynchronizowany z bazą danych. Może nie zawierać ostatnich zmian. Powinieneś wgrac jeszcze raz.";
...
$pgv_lang["error_remote_duplicate"]				= "Baza danych istnieje już na liście jako <i>#GLOBALS[whichFile]#</i>";
...
$pgv_lang["gedcom_downloadable"]	= "Tego pliku GEDCOM nie można pobrać przez internet!<br />Zobacz sekcję BEZPIECZENSTWO w pliku <a href=\"readme.txt\"><b>readme.txt</b></a> aby naprawić ten problem";
$pgv_lang["gedcom_file"]			= "Plik GEDCOM:";
$pgv_lang["gedcom_not_imported"]	= "Plik GEDCOM nie został jeszcze zaimportowany.";
...
$pgv_lang["import_time_exceeded"]	= "Przekroczono limit czasu wykonania. Kliknij przycisk Dalej, aby wznowić import pliku GEDCOM.";
...
$pgv_lang["BOM_detected"] 			= "Wykryto znak BOM (Byte Order Mark) na początku pliku. Podczas porządkowania ten znak specjalny zostanie usunięty.";
...
$pgv_lang["label_banned_servers"]				= "Zabroń dostępu do stron po IP";
...
$pgv_lang["logfile_content"]		= "Zawartość pliku loga";
...
$pgv_lang["messaging2"]				= "Wewnętrzna komunikacja i przez email";
...
$pgv_lang["show_phpinfo"]			= "Pokaz stronę informacyjną PHP";
...
$pgv_lang["admin_OK_subject"]		= "Zatwierdzenie konta na #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["admin_OK_message"]		= "Administrator strony #PGV_SERVER_NAME##PGV_SCRIPT_PATH# zatwierdził twoje zgłoszenie.\r\n\r\nMożesz się teraz zalogować używając odnośnika: #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["batch_update"]			= "Uaktualnij/edytuj informacje w plikach GEDCOM";

// Text for the Gedcom Checker
$pgv_lang["gedcheck"]				= "Tester GEDCOM";
$pgv_lang["gedcheck_text"]			= "Ten moduł sprawdza poprawność formatu pliku GEDCOM według <a href=\"http://phpgedview.sourceforge.net/ged551-5.pdf\">Specyfikacji 5.5.1 GEDCOM</a>. Wykrywa także wiele rodzajów częstych błędów w danych. Pamietaj, że istnieje wiele wersji, rozszerzeń i odmian specyfikacji, więc nie musisz się przejmować żadnymi błędami poza tymi oznaczonymi jako krytyczne. Objaśnienia do wszystkich błędów możesz znaleźć w specyfikacji, więc zajrzyj do niej, zanim poprosisz o pomoc.";
$pgv_lang["gedcheck_sync"]			= "Modyfikacje wprowadzone do bazy danych nie są zsynchronizowane z plikiem #GLOBALS[ged]#. Zawartość pliku może być nieaktualna. Możesz zsynchronizować go z bazą danych, przeprowadzajac operacje <b><a \"#GLOBALS[ged_link]#\">eksportu</a></b>.";
...
$pgv_lang["SURNAME_TRADITION"]		= "Tradycja przyjmowania nazwiska";
