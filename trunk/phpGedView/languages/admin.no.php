...
$pgv_lang["config_not_saved"] = "*Instillingene vil ikke bli lagret før i steg 6";
...
$pgv_lang["checking_config.php"]		= "Sjekker <i>config.php</i>:";
$pgv_lang["config.php_missing"]		= "<i>config.php</i> ble ikke funnet.";
$pgv_lang["config.php_missing_instr"]		= "Denne installasjonsveiledningen vil ikke kunne skrive dine instillinger til <i>config.php</i> filen.  Du kan ta en kopi av <i>config.dist</i> filen og endre navnet til <i>config.php</i>.  Alternativt, etter at du har fullført denne installasjonsveiledningen kan du bruke valget Last ned <i>config.php</i> til å laste ned dine innstillinger og laste opp instillingene i <i>config.php</i> til din server.";
$pgv_lang["config.php_not_writable"]		= "<i>config.php</i> er skrivebeskyttet.";
$pgv_lang["config.php_not_writable_instr"]		= "Denne installasjonsveiledningen vil ikke kunne skrive dine instillinger til <i>config.php</i> filen.  Du kan sette skrivetilgang på fila, eller når du har fullført denne installasjonsveiledningen kan du bruke valget Last ned <i>config.php</i> til å laste ned dine innstillinger og laste opp instillingene i <i>config.php</i> til din server.";
$pgv_lang["passed"]		= "Passed";
$pgv_lang["config.php_writable"]		= "<i>config.php</i> finnes og er skrivbar.";
...
$pgv_lang["cannot_change_timelimit_instr"]		= "Det kan hende at du ikke kan kjøre alle funksjoner på store databaser med mange personer.";
...
$pgv_lang["cannot_change_memlimit_instr"]		= "Det kan hende at du ikke kan kjøre alle funksjoner på store databaser med mange personer.";
...
$pgv_lang["cannot_use_gd"]		= "Du har ikke GD-bildebiblioteket. Du vil ikke kunne lage miniatyrbilder automatisk.";
$pgv_lang["check_sax"]		= "Sjekker etter SAX XML-bibliotek:";
$pgv_lang["cannot_use_sax"]		= "Du har ikke SAX XML-biblioteket. Du vil ikke kunne kjøre rapporter eller andre hjelpefunksjoner";
$pgv_lang["check_dom"]		= "Ser etter DOM XML-bibliotek:";
$pgv_lang["cannot_use_dom"]		= "Du har ikke DOM XML-biblioteket. Du vil ikke kunne eksportere XML.";
$pgv_lang["check_calendar"]		= "Ser etter avansert kalenderbibliotek:";
$pgv_lang["cannot_use_calendar"]		= "Du har ikke avansert kalenderstøtte. Du vil ikke kunne kjøre noen avanserte kalenderfunksjoner.";
$pgv_lang["warnings_passed"]		= "Alle forhåndskontroller utført OK.";
$pgv_lang["warning_instr"]		= "Hvis noen av advarslene ikke går, kan du fortsatt kjøre PhpGedView på denne serveren, men noen funksjoner kan være deaktivert, eller du kan oppleve dårlig ytelse.";
...
$pgv_lang["gedcom_deleted"]		= "Slektsfilen <b>#GED#</b> er nå slettet.";
$pgv_lang["gedadmin"]				= "Administrator av slektsfilen";
$pgv_lang["full_name"]				= "Fullt navn";
$pgv_lang["error_header"] 		= "Slektsfilen <b>#GEDCOM#</b>, finnes ikke på det angitte stedet.";
...
$pgv_lang["add_gedcom"]			= "Legg til GEDCOM-filer";
...
$pgv_lang["ALLOW_USER_THEMES"] 			= "Tillat brukere å velge deres egen stil";
...
$pgv_lang["config_still_writable"]		= "Filen <i>config.php</i> er fremdeles skrivbar. Dersom du er ferdig med å konfigurere siden din, bør du av hensyn til sikkerheten, sette rettighetene til denne filen tilbake til <i>kun</i> lesbar!";
...
$pgv_lang["unsync_warning"] 					= "Denne GEDCOM-filen er <i>ikke</i> synkronisert med databasen.  Det kan hende den ikke inneholder siste versjon av dine data.  For å reimportere fra databasen istedenfor filen, må du først eksportere og så laste opp.";
...
$pgv_lang["download_note"]			= "MERKNAD: Store databaser kan ta lang tid å behandle før de lastes ned. Hvis PHP tar slutt før nedlastingen er ferdig, kan det hende at den nedlastede filen ikke er fullført.<br /><br />For å sikre at filen ble lastet ned riktig, sjekk at den siste linjen i en fil i GEDCOM-format er <b>0&nbsp;TRLR</b> eller at den siste linjen i en fil i XML-format er <b>&lt;/database&gt;</b>. Disse filene er tekst; du kan bruke hvilken som helst passende tekstredigerer, men husk å <u>ikke</u> lagre den nedlastede filen etter at du har inspisert den.<br /><br />Generelt kan det ta så lang tid å laste ned som det tok å importere den originale GEDCOM-filen.";
...
$pgv_lang["error_header_write"]	= "Slektsfilen <b>#GEDCOM#</b>, er ikke skrivbar. Sjekk attributter og tilgangsrettigheter.";
...
$pgv_lang["gedcom_downloadable"]	= "Denne GEDCOM-filen kan lastes ned over internett!<br />Se SIKKERHET-delen i <a href=\"readme.txt\"><b>readme.txt</b></a> filen for å fikse dette problem";
...
$pgv_lang["import_time_exceeded"]	= "Maks utføringstid for en handling er nådd !<br />- Klikk på knappen <b>Fortsett</b> for å gjenoppta importen av slektsfilen (som ny handling).";
...
$pgv_lang["PGV_SMTP_DEBUG"]						= "PHPMailer feil";
$pgv_lang["PGV_SMTP_DEBUG_OPTION0"]				= "Ingen feilmeldinger";
$pgv_lang["PGV_SMTP_DEBUG_OPTION1"]				= "Klientprogrammeldinger";
$pgv_lang["PGV_SMTP_DEBUG_OPTION2"]				= "Klientprogram og servermeldinger";
$pgv_lang["PGV_SMTP_DEBUG_OPTION3"]				= "Klientprogram og servermeldinger pluss tilkoblingsstatus";
$pgv_lang["PGV_SMTP_DEBUG_OPTION4"]				= "Rikelig datautgang på lavt nivå, sjelden nødvendig";
...
$pgv_lang["PGV_STORE_MESSAGES"]			= "Tillat at beskjeder blir lagret online";
...
$pgv_lang["upload_gedcom"]			= "Last opp GEDCOM-filer";
...
$pgv_lang["user_default_tab"]		= "Arkfanen som skal vises som standard på siden «Personlige opplysninger»";
...
$pgv_lang["verified"]			= "Bruker bekreftet seg selv";
...
$pgv_lang["admin_OK_subject"]					= "Godkjenning av konto hos #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["admin_OK_message"]					= "Administratoren ved PhpGedView-nettstedet  #PGV_SERVER_NAME##PGV_SCRIPT_PATH# har godkjent din søknad om en konto.\r\n\r\nDu kan nå logge inn ved å gå til følgende lenke: #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";

$pgv_lang["batch_update"]="Utfør batch-oppdateringer/endringer i din GEDCOM";

// Text for the Gedcom Checker
$pgv_lang["gedcheck"]     = "Gedcomsjekk";          // Module title
$pgv_lang["gedcheck_text"]= "Denne modulen kontrollerer formatet på en GEDCOM-fil mot <a href=\"http://phpgedview.sourceforge.net/ged551-5.pdf\">5.5.1 GEDCOM spesifikasjon</a>.  Den sjekker også en rekke vanlige feil i dine data.<br /><br />Merk at det er mange versjoner, utvidelser og variasjoner av spesifikasjonen så du skal ikke være bekymret for andre feil enn de som er flagget som \"Kritiske\".  Forklaring for alle linje-for-linje-feil finnes i spesifikasjonen, så vennligst sjekk der før du ber om hjelp.";
