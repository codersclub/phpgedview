...
$pgv_lang["SHOW_MARRIED_NAMES_help"]= "~#pgv_lang[SHOW_MARRIED_NAMES]#~<br /><br />Tämä valinta näyttää naisten avionimet henkilöluettelossa. Tämä valinta vaatii, että avionimet lasketaan, kun GEDCOM-tiedosto tuodaan.";
...
$pgv_lang["SEARCHLOG_CREATE_help"]	= "~#pgv_lang[SEARCHLOG_CREATE]#~<br /><br />Kuinka usein ohjelma arkistoi HakuLoki-tiedostot.";
...
$pgv_lang["language_to_edit_help"]		= "~#pgv_lang[language_to_edit]#~<br /><br />Tästä pudotusvalikosta voit valita minkä kielisiä viestejä haluat muokata.";
...
$pgv_lang["active_help"]			= "~#pgv_lang[active]#~<br /><br />Sallii käyttäjän valita kielen jos <b>#pgv_lang[ENABLE_MULTI_LANGUAGE]#</b> -valinta on päällä.";
...
$pgv_lang["alphabet_upper_help"]		= "~#pgv_lang[alphabet_upper]#~<br /><br />Tämän kielen isot kirjaimet. Näitä kirjaimia käytetään kun lajitellaan nimilistoja.";
$pgv_lang["alphabet_lower"]			= "Aakkoset pienin kirjaimin";
$pgv_lang["alphabet_lower_help"]		= "~#pgv_lang[alphabet_lower]#~<br /><br />Tämän kielen pienet kirjaimet. Näitä kirjaimia käytetään kun lajitellaan nimilistoja.";
...
$pgv_lang["hide_translated_help"]		= "~#pgv_lang[hide_translated]#~<br /><br />Mikäli vastaat kyllä, näkyvät vain ne valitsemasi kielen viestit joita ei ole käännetty eli joita ei vielä ole valitsemassasi kielitiedostossa.<br />Kun viesti on kielitiedostossa (vaikka vielä kääntämättä) tätä ei enää näytetä luettelossa.";
...
$pgv_lang["edit_faq_item_help"] 	= "~#pgv_lang[edit_faq_item]#~<br />Tämä valinta sallii sinun muokata kysymystä tai sen vastausta.";
$pgv_lang["restore_faq_edits"] 	= "Palauta kysymysten muokkaustoiminta";
$pgv_lang["restore_faq_edits_help"] 	= "~#pgv_lang[restore_faq_edits]#~<br />Tämä valinta palauttaa UKK-sivun ylläpidon näkemään tilaan, jotta yksittäistä kysymystä voi muokata.";
$pgv_lang["add_faq_item"] 		= "Lisää kysymys";
$pgv_lang["add_faq_item_help"] 	= "~#pgv_lang[add_faq_item]#~<br />Tämä valinta sallii sinun lisätä kysymyksen UKK-sivulle.";
$pgv_lang["delete_faq_item"] 		= "Poista kysymys";
$pgv_lang["delete_faq_item_help"] 	= "~#pgv_lang[delete_faq_item]#~<br />Tämä valinta sallii sinun poistaa kysymyksen UKK-sivulta.";
...
$pgv_lang["WATERMARK_THUMB_help"]		= "~#pgv_lang[WATERMARK_THUMB]#~<br /><br />Jos Media Firewall on päällä, tuleeko pikkukuviin lisätä vesileima? Medialistasi latautuvat nopeammin jos et vesileimaa pikkukuvia.";
...
$pgv_lang["INDI_FACTS_QUICK_help"]	= "~#pgv_lang[INDI_FACTS_QUICK]#~<br /><br />Tämä lista GEDCOM tietoja näkyy täydellisen listan vieressä ja niistä voi lisätä tietoja yhdellä klikkauksella.";
...
$pgv_lang["FAM_FACTS_QUICK_help"]	= "~#pgv_lang[FAM_FACTS_QUICK]#~<br /><br />Tämä lista perhetietoja näkyy täyden listan vieressä ja siitä voi lisätä tiedon yhdellä klikkauksella.";
$pgv_lang["editlang_help"]		= "~#pgv_lang[editlang]#~<br /><br />Muokkaa viestiä kielitiedostosta.";
$pgv_lang["savelang_help"]		= "~#pgv_lang[savelang]#~<br /><br />Tallenna muokattu viesti kielitiedostoon.";
