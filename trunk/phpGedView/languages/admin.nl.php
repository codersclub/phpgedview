...
$pgv_lang["config_not_saved"] 		= "*Uw instellingen worden pas opgeslagen bij stap 6";
...
$pgv_lang["checking_config.php"]	= "Controleer <i>config.php</i>:";
$pgv_lang["config.php_missing"]					= "<i>config.php</i> bestand is niet gevonden.";
$pgv_lang["config.php_missing_instr"]			= "Deze Installatie Hulp kan uw instellingen niet schrijven naar het <i>config.php</i> bestand.  U kunt een kopie maken vanhet <i>config.dist</i> bestand en dan hernoemen als <i>config.php</i>.  Vervolgens, na afsluiting van deze Installatie Hulp, heeft u de optie om uw instellingen te downloaden en dan weer het resulterende <i>config.php</i> bestand te uploaden.";
$pgv_lang["config.php_not_writable"]			= "<i>config.php</i> is niet beschrijfbaar.";
$pgv_lang["config.php_not_writable_instr"]		= "Deze Installatie Hulp kan uw instellingen niet schrijven naar het <i>config.php</i> bestand.  U kunt de Schrijf Permissies voor dit bestand zetten, of na afsluiting van deze Installatie Hulp, heeft u de optie om uw instellingen te downloaden en dan weer het resulterende <i>config.php</i> bestand te uploaden.";
$pgv_lang["passed"]					= "Met succes afgerond";
$pgv_lang["config.php_writable"]	= "<i>config.php</i> is aanwezig en beschrijfbaar.";
...
$pgv_lang["index_dir_cleanup_inst"]	= "Om een bestand, of map, te verwijderen uit de Index directory: sleep het naar de prullenbak of vink de checkbox aan.  Klik op de \"Verwijder\" knop om de aangegeven bestanden permanent te verwijderen.<br /><ul><li>Bestanden, gemerkt met <img src=\"./images/RESN_confidential.gif\" alt=\"\" /> zijn vereist voor de goede werking van het programma en kunnen niet worden verwijderd.</li><li>Bestanden, gemerkt met <img src=\"./images/RESN_locked.gif\" alt=\"\" /> bevatten belangrijke instellingen of gegevens over uitstaande wijzigingen. Verwijder deze alleen als u zeker weet wat de gevolgen zijn.</li></ul>";
...
$pgv_lang["sanity_warn3"]			= "GD afbeeldingen bibliotheek bestaat niet. PhpGedView zal wel functioneren, maar sommige functies, zoals het genereren van thumbnails of de taart diagram, zullen niet werken zonder de GD afbeeldingen bibliotheek.  Kijk a.u.b. op <a href='https://www.php.net/manual/en/ref.image.php' target='_blank'>https://www.php.net/manual/en/ref.image.php</a> voor meer informatie.";
$pgv_lang["sanity_warn4"]			= "De XML Parser bibliotheek bestaat niet. PhpGedView zal wel functioneren, maar sommige functies, zoals rapporten genereren en web services, zullen niet werken zonder de XML Parser bibliotheek.  Kijk a.u.b. op <a href='https://www.php.net/manual/en/ref.xml.php' target='_blank'>https://www.php.net/manual/en/ref.xml.php</a> voor meer informatie.";
$pgv_lang["sanity_warn5"]			= "De DOM XML bibliotheek bestaat niet. PhpGedView zal wel functioneren, maar sommige functies, zoals Gramps Export functies in de knipselbak,, download, en web services, zullen niet werken. Kijk a.u.b. op <a href='https://www.php.net/manual/en/refs.xml.php' target='_blank'>https://www.php.net/manual/en/refs.xml.php</a> voor meer informatie.";
$pgv_lang["sanity_warn6"]			= "De Kalender bibliotheek bestaat niet. PhpGedView zal wel functioneren, maar sommige functies, zoals conversie maar andere kalenders, zoals Hebreeuws of Frans, zullen niet werken.  Dit is echter niet essentieel om PhpGedView te draaien. Kijk a.u.b. op <a href='https://www.php.net/manual/en/ref.calendar.php' target='_blank'>https://www.php.net/manual/en/ref.calendar.php</a> voor meer informatie.";
...
$pgv_lang["gedcom_deleted"]				= "GEDCOM <b>#GED#</b> verwijderd.";
...
$pgv_lang["config_still_writable"]	= "Uw <i>config.php</i> bestand heeft schrijftoegang. Als u klaar bent met het configureren van uw site, dient u de rechten om beveiligingsredenen te wijzigen in \"alleen lezen\".";
...
$pgv_lang["unsync_warning"] 		= "Dit GEDCOM bestand is <i>niet</i> gesynchroniseerd met de database.  Het bevat mogelijk niet de laatste versie van uw gegevens.  Om opnieuw te importeren van de database i.p.v. vanuit het bestand, moet u het downloaden en dan opnieuw uploaden.";
...
$pgv_lang["download_note"]			= "OPMERKING: Het kan lang duren voordat grote databases zijn verwerkt voordat ze worden gedownload. Als PHP een time-out optreedt voordat het downloaden is voltooid, is het gedownloade bestand mogelijk niet compleet.<br /><br />Om er zeker van te zijn dat het bestand correct is gedownload, controleert u of de laatste regel van een bestand in GEDCOM-indeling <b>0&nbsp;TRLR</b> of dat de laatste regel van een bestand in XML-indeling <b>&lt;/database&gt;</b> is. Deze bestanden zijn tekst; je kunt elke geschikte teksteditor gebruiken, maar zorg ervoor dat je het gedownloade bestand <u>niet</u> opslaat nadat je het hebt geïnspecteerd.<br /><br />In het algemeen kan het downloaden even lang duren als het kostte om uw originele GEDCOM-bestand te importeren.";
...
$pgv_lang["error_header_write"]		= "Schrijfrechten benodigd op het GEDCOM-bestand <b>#GEDCOM#</b>, controleer attributen en toegangsrechten.";
...
$pgv_lang["import_time_exceeded"]	= "De maximale uitvoeringstijd is bereikt. Druk op de knop <b>Doorgaan</b> om de import van het GEDCOM-bestand voort te zetten.";
...
$pgv_lang["PGV_SMTP_DEBUG"]						= "PHPMailer-fouten";
$pgv_lang["PGV_SMTP_DEBUG_OPTION0"]				= "Geen foutmeldingen";
$pgv_lang["PGV_SMTP_DEBUG_OPTION1"]				= "Meldingen van clientprogramma's";
$pgv_lang["PGV_SMTP_DEBUG_OPTION2"]				= "Clientprogramma en servermeldingen";
$pgv_lang["PGV_SMTP_DEBUG_OPTION3"]				= "Clientprogramma en servermeldingen plus verbindingsstatus";
$pgv_lang["PGV_SMTP_DEBUG_OPTION4"]				= "Uitgebreide gegevensuitvoer op laag niveau, zelden nodig";
...
$pgv_lang["please_be_patient"]		= "Wees alstublieft geduldig";
...
$pgv_lang["user_default_tab"]		= "Standaard tabblad voor «Persoonlijke details» pagina";
...
$pgv_lang["welcome_new"] 			= "Welkom bij uw nieuwe PhpGedView website.";
$pgv_lang["yearly"]					= "Jaarlijks";
$pgv_lang["admin_OK_subject"]		= "Goedkeuring van een account op #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
$pgv_lang["admin_OK_message"]		= "De beheerder van de PhpGedView site #PGV_SERVER_NAME##PGV_SCRIPT_PATH# heeft uw aanvraag voor een account goedgekeurd.\r\n\r\nU kunt nu inloggen als u op de volgende link klikt: #PGV_SERVER_NAME##PGV_SCRIPT_PATH#";
