...
$pgv_lang["USE_MEDIA_VIEWER_help"]		= "~#pgv_lang[USE_MEDIA_VIEWER]#~<br /><br />Når dette valget er <b>#pgv_lang[yes]#</b>, vil siden Mediaviser åpnes.  Denne siden viser detaljer om bildet.  Hvis du har tilstrekkelige rettigheter, kan du også redigere disse detaljene.<br /><br />Når dette valget er <b>#pgv_lang[no]#</b>, vil bildet vises i et nytt fullskjermsvindu når du klikker på bildet.";
$pgv_lang["USE_MEDIA_FIREWALL"]			= "Bruk Mediabrannmur";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />Se Wikien for en beskrivelse av hvordan du kan bruke Mediabrannmuren. <a href=\"#PGV_PHPGEDVIEW_WIKI#/en/index.php?title=Media_Firewall\" target=\"_blank\">#PGV_PHPGEDVIEW_WIKI#</a>";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Rotkatalog for Mediabrannmur";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Katalog som mappen for de beskyttede mediene kan opprettes i.  #pgv_lang[MEDIA_FIREWALL_ROOTDIR_note]#";
...
$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "~#pgv_lang[MEDIA_FIREWALL_THUMBS]#~<br /><br />Når et bilde er i den beskyttede mediakatalogen, skal det tilhørende miniatyrbildet beskyttes også?";
$pgv_lang["SHOW_SPIDER_TAGLINE"]		= "Vis spider-tagline";
$pgv_lang["SHOW_SPIDER_TAGLINE_help"]		= "~#pgv_lang[SHOW_SPIDER_TAGLINE]#~<br /><br />På sider som genereres for søkemotorer, kan denne setningen vises som den siste linjen på siden denne søkemotorene oppdager.  Hvis dette alternativet er slått på, kan det påvirke Google&reg; AdSense i retning av søkemotorens optimatiseringsverktøy.";
...
$pgv_lang["INDI_FACTS_QUICK_help"]	= "~#pgv_lang[INDI_FACTS_QUICK]#~<br /><br />Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen  og som kan legges til med et enkelt klikk.";
$pgv_lang["FAM_FACTS_ADD"] 			= "Fakta å legge til for familier";
$pgv_lang["FAM_FACTS_ADD_help"]		= "~#pgv_lang[FAM_FACTS_ADD]#~<br /><br />Dette er rekken av GEDCOM-fakta som dine brukere kan legge til familier.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn som er på denne listen kan ikke være på listen <i>#pgv_lang[FAM_FACTS_UNIQUE]#</i>.";
$pgv_lang["FAM_FACTS_UNIQUE"] 			= "Unike fakta for familier";
$pgv_lang["FAM_FACTS_UNIQUE_help"]		= "~#pgv_lang[FAM_FACTS_UNIQUE]#~<br /><br />Dette er rekken med GEDCOM fakta som dine brukere kan legge til <u>en gang</u> for en familie.  For eksempel, hvis MARR er på denne listen, vil brukerne ikke kunne legge til mer enn en MARR-hendelse til en familie.  Faktanavn som er på denne listen kan ikke samtidig være på <i>#pgv_lang[FAM_FACTS_ADD]#</i>-listen.";
$pgv_lang["FAM_FACTS_QUICK"] 			= "Hurtiglinker for familiefakta";
$pgv_lang["FAM_FACTS_QUICK_help"]	= "~#pgv_lang[FAM_FACTS_QUICK]#~<br /><br />Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen og som kan legges til med et enkelt klikk.";
$pgv_lang["SOUR_FACTS_ADD"] 			= "Fakta å legge til for kilder";
$pgv_lang["SOUR_FACTS_ADD_help"]		= "~#pgv_lang[SOUR_FACTS_ADD]#~<br /><br />Dette er rekken av GEDCOM-fakta som dine brukere kan legge til kilder.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn som er på denne listen kan ikke samtidig være på <i>#pgv_lang[SOUR_FACTS_UNIQUE]#</i>-listen.";
...
$pgv_lang["SOUR_FACTS_QUICK_help"]	= "~#pgv_lang[SOUR_FACTS_QUICK]#~<br /><br />Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen og som kan legges til med et enkelt klikk.";
$pgv_lang["REPO_FACTS_ADD"] 			= "Fakta å legge til for oppbevaringssteder";
$pgv_lang["REPO_FACTS_ADD_help"]		= "~#pgv_lang[REPO_FACTS_ADD]#~<br /><br />Dette er rekken av GEDCOM-fakta som dine brukere kan legge til oppbevaringssteder.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn på denne listen kan ikke samtidig være   på <i>#pgv_lang[REPO_FACTS_UNIQUE]#</i>-listen.";
...
$pgv_lang["REPO_FACTS_QUICK_help"]	= "~#pgv_lang[REPO_FACTS_QUICK]#~<br /><br />Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen og som kan legges til med et enkelt klikk.";
...
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "~#pgv_lang[MEDIA_ID_PREFIX]#~<br /><br />Når et mediaobjekt legges til online i PhpGedView, vil en ID for det mediaobjektet bli generert automatsk. Media ID-en vil få dette prefikset.";
...
$pgv_lang["CHANGELOG_CREATE_help"]	= "~#pgv_lang[CHANGELOG_CREATE]#~<br /><br />Hvor ofte skal programmet arkivere filene for endringslogg?.";
...
$pgv_lang["FULL_SOURCES_help"]		= "~#pgv_lang[FULL_SOURCES]#~<br /><br />Kildehenvisninger kan inkludere felter for å lagre informasjon om kvaliteten på dataene (primærkilde, sekundærkilde, osv.) og datoen hendelsen ble inntatt i kilden.  Hvis du ikke bruker disse feltene kan du deaktivere dem når du oppretter ny kilder.";
$pgv_lang["PREFER_LEVEL2_SOURCES"]		= "Foretrekk kilder til fakta";
$pgv_lang["PREFER_LEVEL2_SOURCES_help"]		= "~#pgv_lang[PREFER_LEVEL2_SOURCES]#~<br /><br />Når du legger til nye fakta for nære slektninger, kan du legge til kildehenvisninger til postene (dvs INDI, FAM) eller faktaene (BIRT, MARR, DEAT).  Dette alternativet kontrollerer hvilke avkrysningsbokser som skal kukes av som default.";
...
$pgv_lang["DBPORT_help"]		= "~#pgv_lang[DBPORT]#~<br /><br />TCP-porten som skal benyttes ved tilkobling til databasetjeneren.  La den være blank for å benytte defaultverdien for din databasetype.  Valget har ingen betydning dersom du bruker en SQLite database.";
...
$pgv_lang["SHOW_AGE_DIFF_help"]		= "~#pgv_lang[SHOW_AGE_DIFF]#~<br /><br />Dette valget bestemmer hvorvidt fanen Nære slektninger skal vise forskjellen mellom fødselsdatoer for ektefeller, mellom vielsesdato og fødselsdato for første barn og mellom barnas fødselsdatoer.";
...
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] = "~#pgv_lang[EXPAND_RELATIVES_EVENTS]#~<br /><br />Dette valget bestemmer om du ønsker automatisk visning av <i>Hendelser til nære slektninger</i>.";
$pgv_lang["EXPAND_SOURCES"]      = "Vis utvidede kilder automatisk";
$pgv_lang["EXPAND_SOURCES_help"] = "~#pgv_lang[EXPAND_SOURCES]#~<br /><br />Dette valget kontrollerer om du ønsker å automatisk vise innholdet i <i>Kilder</i> på siden for personer.";
$pgv_lang["EXPAND_NOTES"]      = "Vis utvidede merknader automatisk";
$pgv_lang["EXPAND_NOTES_help"] = "~#pgv_lang[EXPAND_NOTES]#~<br /><br />Dette valget kontrollerer om du ønsker å automatisk vise innholdet i <i>Noter</i> på siden for personer.";
...
$pgv_lang["SURNAME_LIST_STYLE_help"]	= "~#pgv_lang[SURNAME_LIST_STYLE]#~<br /><br />Lister med etternavn, slik som de fremkommer i #pgv_lang[block_top10]# blokken, #pgv_lang[individual_list]#, og #pgv_lang[family_list]#, kan vises i ulike stiler.<ul><li><b>#pgv_lang[style2]#</b>&nbsp;&nbsp;&nbsp;I denne stilen vil etternavn vises i en tabell som kan sorteres enten etter etternavn eller antall.</li><li><b>#pgv_lang[style3]#</b>&nbsp;&nbsp;&nbsp;I denne stilen vil etternavn vises i en liste og størrelsen på skrifttypen for hvert navn er avhengig av frekvensen av dette etternavnet i databasen. Denne listen kan du ikke sortere.</li></ul>";
...
$pgv_lang["SHOW_LAST_CHANGE_help"]	= "~#pgv_lang[SHOW_LAST_CHANGE]#~<br /><br />Dette valget kontroller om du skal vise GEDCOM-postens siste endringsdato eller ikke på lister.";
$pgv_lang["SHOW_EST_LIST_DATES"]		= "Vis beregnet dato for fødsler og dødsfall";
$pgv_lang["SHOW_EST_LIST_DATES_help"]	= "~#pgv_lang[SHOW_EST_LIST_DATES]#~<br /><br />Dette valget kontrollerer om du skal vise beregnede datoer for fødsel og død istedenfor blank i personlister og diagrammer fpr personer der disse datoene ikke er kjent.";
...
$pgv_lang["SHOW_MEDIA_FILENAME_help"]	= "~#pgv_lang[SHOW_MEDIA_FILENAME]#~<br /><br />Mediaviseren kan vise navn på mediafilen som blir vist.  Dette valget bestemmer om du skal vise filnavnet eller ikke.<br /><br />Du vil kanskje skjule filnavnet av sikkerhetshensyn.";
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Vis lenke for nedlasting i mediaviseren";
$pgv_lang["SHOW_MEDIA_DOWNLOAD_help"]	= "~#pgv_lang[SHOW_MEDIA_DOWNLOAD]#~<br /><br />Mediaviseren kan vise en lenke, som hvis man klikker på den vil laste mediafilen ned til lokal PC.<br /><br />Du vil kanskje skjule nedlastningslinken av sikkerhetshensyn.";
...
$pgv_lang["SHOW_FACT_ICONS_help"]	= "~#pgv_lang[SHOW_FACT_ICONS]#~<br /><br />Sett til <b>#pgv_lang[yes]#</b> for å vise ikoner ved siden av faktanavn på #pgv_lang[personal_facts]# siden.  Faktaikoner vil kun vises hvi de eksisterer i <i>images/facts</i>-katalogen som tilhører stilen som er i bruk.";
...
$pgv_lang["PGV_SMTP_ACTIVE_help"] = "~#pgv_lang[PGV_SMTP_ACTIVE]#~<br /><br />Bruk SMTP for å sende epost fra PhpGedView.<br /><br />Dette valget krever tilgang til en SMTP eposttjener.  Når den er satt til <b>#pgv_lang[no]#</b> vil PhpGedView bruke epostsystemet som er innebygget i PHP på denne tjeneren.";
$pgv_lang["PGV_SMTP_HOST_help"] = "~#pgv_lang[PGV_SMTP_HOST]#~<br /><br />Dette er navnet på SMTP eposttjeneren.  Eksempel: <b>smtp.online.no</b>.";
$pgv_lang["PGV_SMTP_HELO_help"] = "~#pgv_lang[PGV_SMTP_HELO]#~<br /><br />Dette er domenedelen av en gyldig epostadresse på SMTP-tjeneren.<br /><br />For eksempel, hvis du har en epostkonto som <b>yourname@abc.xyz.com</b>, skal du skrive inn <b>abc.xyz.com</b> her.";
$pgv_lang["PGV_SMTP_PORT_help"] = "~#pgv_lang[PGV_SMTP_PORT]#~<br /><br />Portnummeret som skal benyttes for oppkoblinger til SMTP-tjeneren.  Normalt er dette port <b>25</b>.";
$pgv_lang["PGV_SMTP_AUTH_help"] = "~#pgv_lang[PGV_SMTP_AUTH]#~<br /><br />Bruk navn og passord for å autentisere oppkobling til SMTP-tjener.<br /><br />De fleste SMTP-tjenere  krever at alle oppkoblinger blir autentisert før de vil godta utgående eposter.";
$pgv_lang["PGV_SMTP_AUTH_USER_help"] = "~#pgv_lang[PGV_SMTP_AUTH_USER]#~<br /><br />Brukernavnet som kreves for autentisering på SMTP-tjeneren.";
$pgv_lang["PGV_SMTP_AUTH_PASS_help"] = "~#pgv_lang[PGV_SMTP_AUTH_PASS]#~<br /><br />Passordet for autentisering på SMTP-tjeneren.";
...
$pgv_lang["PGV_MEMORY_LIMIT_help"]		= "Det maksimale minneforbruket som kan bli benyttet av PhpGedView skript.  Standard er 64 M.  Mange verter slår dette valget av i sine PHP konfigurasjoner, så å endre denne verdien behøver nødvendigvis ikke bety noe for den maksiale minne-oppsettet.";
...
$pgv_lang["restore_faq_edits_help"] = "~#pgv_lang[restore_faq_edits]#~<br />Dette valget tilbakestiller FAQ-siden til det en adminbruker normalt ser, slik at indivituelle FAQ-elementer kan redigeres.";
$pgv_lang["add_faq_item"] = "Legg til FAQ-elementer";
$pgv_lang["add_faq_item_help"] = "~#pgv_lang[add_faq_item]#~<br />Dette valget lar deg legge til et element på FAQ-siden.";
$pgv_lang["edit_faq_item"] = "Rediger FAQ-element";
$pgv_lang["edit_faq_item_help"] = "~#pgv_lang[edit_faq_item]#~<br />Dette valget lar deg redigere et element på FAQ-siden.";
$pgv_lang["delete_faq_item"] = "Slett FAQ-element";
$pgv_lang["delete_faq_item_help"] = "~#pgv_lang[delete_faq_item]#~<br />Dette valget lar deg slette et element fra FAQ-siden";
...
$pgv_lang["add_faq_body_help"] = "~#pgv_lang[add_faq_body]#~<br />Teksten i FAQ-elementet skrives inn her.<br /><br />Teksten kan formateres. HTML-tagger som &lt;b&gt; og &lt;br /&gt; er tillatt, det er også HTML-entiteter som &amp;amp; og &amp;nbsp;.<br /><br />#pgv_lang[add_faq_HTML]#<br /><br />#pgv_lang[add_faq_pgvLangRefs]#";
