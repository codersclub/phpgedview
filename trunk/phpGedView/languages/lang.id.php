...
$pgv_lang["birth_M"]				= "Ulang tahun #name#";		// For male persons
$pgv_lang["birth_F"]				= "Ulang tahun #name#";		// For female persons
$pgv_lang["born_in_M"]				= "Lahir pada tanggal #date# di #place#";		// For male persons
$pgv_lang["born_in_F"]				= "Lahir pada tanggal #date# di #place#";		// For female persons
$pgv_lang["born_on_M"]				= "Lahir pada tanggal #date#";		// For male persons
$pgv_lang["born_on_F"]				= "Lahir pada tanggal #date#";		// For female persons
$pgv_lang["death_M"]				= "Peringatan kematian #name#";		// For male persons
$pgv_lang["death_F"]				= "Peringatan kematian #name#";		// For female persons
$pgv_lang["died_in_M"]				= "Meninggal pada tahun #date# di #place#";		// For male persons
$pgv_lang["died_in_F"]				= "Meninggal pada tahun #date# di #place#";		// For female persons
$pgv_lang["died_on_M"]				= "Meninggal pada tahun #date#";		// For male persons
$pgv_lang["died_on_F"]				= "Meninggal pada tahun #date#";		// For female persons
$pgv_lang["anniversary_of"]			= "Ulang tahun pernikahan #husband# dan #wife#";
$pgv_lang["married_in"]				= "Menikah pada tanggal #date# di #place#";
$pgv_lang["married_on"]				= "Menikah pada tanggal #date#";
$pgv_lang["clustrmaps_locations"]	= "Lokasi pengunjung ke halaman ini";
...
$pgv_lang["NNthai"] 			= "(anonim)";
$pgv_lang["PNthai"] 			= "(anonim)";
...
$pgv_lang["welcome_text_auth_mode_1"]		= "<span class='center'><b>Selamat datang di Situsweb genealogi ini</b></span><br />Akses ke situs ini diizinkan bagi setiap pengunjung yang mempunyai akun pengguna.<br /><br />Jika Anda memiliki akun pengguna, Anda dapat masuk log pada halaman ini. Jika Anda tidak mempunyai akun pengguna, Anda dapat mengajukan satu dengan mengklik pranala yang bersesuaian di bawah.<br /><br />Setelah memverifikasi pengajuan Anda, administrator situs akan mengaktifkan akun Anda. Anda akan menerima email saat pengajuan Anda diterima.";
$pgv_lang["welcome_text_auth_mode_2"]		= "<span class='center'><b>Selamat datang di Situsweb genealogi ini</b></span><br />Akses ke situs ini hanya diizinkan bagi <u>pengguna terotorisasi</u> saja.<br /><br />Jika Anda memiliki akun pengguna, Anda dapat masuk log pada halaman ini. Jika Anda tidak mempunyai akun pengguna, Anda dapat mengajukan satu dengan mengklik pranala yang bersesuaian di bawah.<br /><br />Setelah memverifikasi informasi Anda, administrator akan menerima atau menolak pengajuan akun Anda. Anda akan menerima pesan email saat pengajuan Anda diterima.";
$pgv_lang["welcome_text_auth_mode_3"]		= "<span class='center'><b>Selamat datang di Situsweb genealogi ini</b></span><br />Akses ke situs ini hanya diizinkan bagi <u>anggota keluarga</u> saja.<br /><br />Jika Anda memiliki akun pengguna, Anda dapat masuk log pada halaman ini. Jika Anda tidak mempunyai akun pengguna, Anda dapat mengajukan satu dengan mengklik pranala yang bersesuaian di bawah.<br /><br />Setelah memverifikasi informasi yang Anda sediakan, administrator akan menerima atau menolak permintaan akun Anda. Anda akan menerima email saat permintaan Anda diterima.";
$pgv_lang["welcome_text_cust_head"] 		= "<span class='center'><b>Selamat datang di Situsweb genealogi ini</b></span><br />Akses diizinkan bagi pengguna yang mempunyai akun dan sandi untuk situsweb ini.<br />";
...
$pgv_lang["message_invalid_from"]	= "Alamat pengirim tidak valid: &lt;#email#&gt;";
$pgv_lang["message_invalid_to"]		= "Alamat penerima tidak valid: &lt;#email#&gt;";
...
$pgv_lang["portal_config_instructions"]		= "~#pgv_lang[customize_page]#~<br />~#pgv_lang[customize_gedcom_page]#~<br /><br />Anda dapat mengatur halaman dengan meletakkan blok pada halaman sebagaimana Anda inginkan.<br /><br />Halaman terbagi atas bagian <b>Utama</b> dan <b>Kanan</b>. Blok bagian <b>Utama</b> tampak lebih besar dan di bawah judul halaman. Bagian <b>Kanan</b> bermula dari kanan judul ke sisi bawah kanan halaman.<br /><br />Setiap bagian mempunyai daftar bloknya masing-masing yang akan dicetak pada halaman dengan urutan sebagaimana dalam daftar. Anda dapat menambah, membuang, dan menyusun blok semau Anda.<br /><br />Saat salah satu daftar blok kosong, blok yang tersisa akan mengambil lebar halaman yang tersisa.<br /><br />";
