...
$REPO_FACTS_QUICK = "NAME,ADDR";
$INDI_FACTS_UNIQUE = "";
$INDI_FACTS_ADD = "AFN,BIRT,CHR,DEAT,BURI,CREM,ADOP,BAPM,BARM,BASM,BLES,CHRA,CONF,EMAIL,FAX,FCOM,ORDN,NATU,EMIG,IMMI,CENS,PROB,WILL,GRAD,RETI,CAST,DSCR,EDUC,IDNO,NATI,NCHI,NMR,OCCU,PROP,RELI,RESI,SSN,TITL,BAPL,CONL,ENDL,SLGC,_MILI,ASSO";
$INDI_FACTS_QUICK = "BIRT,RESI,OCCU,DEAT";
